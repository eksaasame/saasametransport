...
public:
    ...
    repeat_job(std::wstring id, std::string image_name, std::string parent );
    virtual ~repeat_job(){}
    typedef boost::signals2::signal<bool(const std::string), macho::_or<bool>> is_image_uploaded;
...
protected:
    ...
    virtual saasame::ironman::imagex::irm_imagex_op::vtr                  _get_target_ops();
    void                                                                  _update( );
