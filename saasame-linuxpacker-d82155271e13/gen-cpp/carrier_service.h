...
class carrier_serviceIfSingletonFactory : virtual public carrier_serviceIfFactory {
 public:
  carrier_serviceIfSingletonFactory(const boost::shared_ptr<carrier_serviceIf>& iface) : iface_(iface) {}
 ...
 protected:
  boost::shared_ptr<carrier_serviceIf> iface_;
};
...
class carrier_serviceClient : virtual public carrier_serviceIf, public common_connection_serviceClient {
 public:
  carrier_serviceClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) :
    common_connection_serviceClient(prot, prot) {}
  carrier_serviceClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, boost::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) :    common_connection_serviceClient(iprot, oprot) {}
...
class carrier_serviceProcessor : public common_connection_serviceProcessor {
 ...
 public:
  carrier_serviceProcessor(boost::shared_ptr<carrier_serviceIf> iface) :
...
class carrier_serviceProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  carrier_serviceProcessorFactory(const ::boost::shared_ptr< carrier_serviceIfFactory >& handlerFactory) :
      handlerFactory_(handlerFactory) {}

  ::boost::shared_ptr< ::apache::thrift::TProcessor > getProcessor(const ::apache::thrift::TConnectionInfo& connInfo);

 protected:
  ::boost::shared_ptr< carrier_serviceIfFactory > handlerFactory_;
};

class carrier_serviceMultiface : virtual public carrier_serviceIf, public common_connection_serviceMultiface {
 public:
  carrier_serviceMultiface(std::vector<boost::shared_ptr<carrier_serviceIf> >& ifaces) : ifaces_(ifaces) {
    std::vector<boost::shared_ptr<carrier_serviceIf> >::iterator iter;
 ...
 protected:
  std::vector<boost::shared_ptr<carrier_serviceIf> > ifaces_;
  carrier_serviceMultiface() {}
  void add(boost::shared_ptr<carrier_serviceIf> iface) {
...
class carrier_serviceConcurrentClient : virtual public carrier_serviceIf, public common_connection_serviceConcurrentClient {
 public:
  carrier_serviceConcurrentClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) :
    common_connection_serviceConcurrentClient(prot, prot) {}
  carrier_serviceConcurrentClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, boost::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) :    common_connection_serviceConcurrentClient(iprot, oprot) {}
  boost::shared_ptr< ::apache::thrift::protocol::TProtocol> getInputProtocol() {
    return piprot_;
  }
  boost::shared_ptr< ::apache::thrift::protocol::TProtocol> getOutputProtocol() {
...
class carrier_serviceCobClIf : virtual public common_connection_serviceCobClIf {
 public:
  ...
  virtual void create(tcxx::function<void(carrier_serviceCobClient* client)> cob, const std::string& session_id, const create_image_info& image) = 0;
  virtual void create_ex(tcxx::function<void(carrier_serviceCobClient* client)> cob, const std::string& session_id, const std::set<std::string> & connection_ids, const std::string& base_name, const std::string& name, const int64_t size, const int32_t block_size, const std::string& parent, const bool checksum_verify) = 0;
  virtual void open(tcxx::function<void(carrier_serviceCobClient* client)> cob, const std::string& session_id, const std::set<std::string> & connection_ids, const std::string& base_name, const std::string& name) = 0;
  virtual void read(tcxx::function<void(carrier_serviceCobClient* client)> cob, const std::string& session_id, const std::string& image_id, const int64_t start, const int32_t number_of_bytes_to_read) = 0;
  virtual void write(tcxx::function<void(carrier_serviceCobClient* client)> cob, const std::string& session_id, const std::string& image_id, const int64_t start, const std::string& buffer, const int32_t number_of_bytes_to_write) = 0;
  virtual void write_ex(tcxx::function<void(carrier_serviceCobClient* client)> cob, const std::string& session_id, const std::string& image_id, const int64_t start, const std::string& buffer, const int32_t number_of_bytes_to_write, const bool is_compressed) = 0;
  virtual void close(tcxx::function<void(carrier_serviceCobClient* client)> cob, const std::string& session_id, const std::string& image_id, const bool is_cancel) = 0;
  virtual void remove_base_image(tcxx::function<void(carrier_serviceCobClient* client)> cob, const std::string& session_id, const std::set<std::string> & base_images) = 0;
  virtual void remove_snapshot_image(tcxx::function<void(carrier_serviceCobClient* client)> cob, const std::string& session_id, const std::map<std::string, image_map_info> & images) = 0;
  virtual void verify_management(tcxx::function<void(carrier_serviceCobClient* client)> cob, const std::string& management, const int32_t port, const bool is_ssl) = 0;
  virtual void set_buffer_size(tcxx::function<void(carrier_serviceCobClient* client)> cob, const std::string& session_id, const int32_t size) = 0;
  virtual void is_buffer_free(tcxx::function<void(carrier_serviceCobClient* client)> cob, const std::string& session_id, const std::string& image_id) = 0;
  virtual void is_image_replicated(tcxx::function<void(carrier_serviceCobClient* client)> cob, const std::string& session_id, const std::set<std::string> & connection_ids, const std::string& image_name) = 0;
};

class carrier_serviceCobSvIf : virtual public common_connection_serviceCobSvIf {
 public:
  virtual ~carrier_serviceCobSvIf() {}
  virtual void create(tcxx::function<void(std::string const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const create_image_info& image) = 0;
  virtual void create_ex(tcxx::function<void(std::string const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::set<std::string> & connection_ids, const std::string& base_name, const std::string& name, const int64_t size, const int32_t block_size, const std::string& parent, const bool checksum_verify) = 0;
  virtual void open(tcxx::function<void(std::string const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::set<std::string> & connection_ids, const std::string& base_name, const std::string& name) = 0;
  virtual void read(tcxx::function<void(std::string const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& image_id, const int64_t start, const int32_t number_of_bytes_to_read) = 0;
  virtual void write(tcxx::function<void(int32_t const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& image_id, const int64_t start, const std::string& buffer, const int32_t number_of_bytes_to_write) = 0;
  virtual void write_ex(tcxx::function<void(int32_t const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& image_id, const int64_t start, const std::string& buffer, const int32_t number_of_bytes_to_write, const bool is_compressed) = 0;
  virtual void close(tcxx::function<void(bool const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& image_id, const bool is_cancel) = 0;
  virtual void remove_base_image(tcxx::function<void(bool const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::set<std::string> & base_images) = 0;
  ...
  virtual void set_buffer_size(tcxx::function<void(bool const& _return)> cob, const std::string& session_id, const int32_t size) = 0;
  virtual void is_buffer_free(tcxx::function<void(bool const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& image_id) = 0;
  virtual void is_image_replicated(tcxx::function<void(bool const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::set<std::string> & connection_ids, const std::string& image_name) = 0;
};
...
class carrier_serviceCobSvIfSingletonFactory : virtual public carrier_serviceCobSvIfFactory {
 public:
  carrier_serviceCobSvIfSingletonFactory(const boost::shared_ptr<carrier_serviceCobSvIf>& iface) : iface_(iface) {}
 ...
 protected:
  boost::shared_ptr<carrier_serviceCobSvIf> iface_;
};
...
class carrier_serviceCobClient : virtual public carrier_serviceCobClIf, public common_connection_serviceCobClient {
 public:
  carrier_serviceCobClient(boost::shared_ptr< ::apache::thrift::async::TAsyncChannel> channel, ::apache::thrift::protocol::TProtocolFactory* protocolFactory) :
  ...
  void create(tcxx::function<void(carrier_serviceCobClient* client)> cob, const std::string& session_id, const create_image_info& image);
  void send_create(const std::string& session_id, const create_image_info& image);
  void recv_create(std::string& _return);
  void create_ex(tcxx::function<void(carrier_serviceCobClient* client)> cob, const std::string& session_id, const std::set<std::string> & connection_ids, const std::string& base_name, const std::string& name, const int64_t size, const int32_t block_size, const std::string& parent, const bool checksum_verify);
  void send_create_ex(const std::string& session_id, const std::set<std::string> & connection_ids, const std::string& base_name, const std::string& name, const int64_t size, const int32_t block_size, const std::string& parent, const bool checksum_verify);
  void recv_create_ex(std::string& _return);
  void open(tcxx::function<void(carrier_serviceCobClient* client)> cob, const std::string& session_id, const std::set<std::string> & connection_ids, const std::string& base_name, const std::string& name);
  void send_open(const std::string& session_id, const std::set<std::string> & connection_ids, const std::string& base_name, const std::string& name);
  void recv_open(std::string& _return);
  void read(tcxx::function<void(carrier_serviceCobClient* client)> cob, const std::string& session_id, const std::string& image_id, const int64_t start, const int32_t number_of_bytes_to_read);
  void send_read(const std::string& session_id, const std::string& image_id, const int64_t start, const int32_t number_of_bytes_to_read);
  void recv_read(std::string& _return);
  void write(tcxx::function<void(carrier_serviceCobClient* client)> cob, const std::string& session_id, const std::string& image_id, const int64_t start, const std::string& buffer, const int32_t number_of_bytes_to_write);
  void send_write(const std::string& session_id, const std::string& image_id, const int64_t start, const std::string& buffer, const int32_t number_of_bytes_to_write);
  int32_t recv_write();
  void write_ex(tcxx::function<void(carrier_serviceCobClient* client)> cob, const std::string& session_id, const std::string& image_id, const int64_t start, const std::string& buffer, const int32_t number_of_bytes_to_write, const bool is_compressed);
  void send_write_ex(const std::string& session_id, const std::string& image_id, const int64_t start, const std::string& buffer, const int32_t number_of_bytes_to_write, const bool is_compressed);
  int32_t recv_write_ex();
  void close(tcxx::function<void(carrier_serviceCobClient* client)> cob, const std::string& session_id, const std::string& image_id, const bool is_cancel);
  void send_close(const std::string& session_id, const std::string& image_id, const bool is_cancel);
  bool recv_close();
  void remove_base_image(tcxx::function<void(carrier_serviceCobClient* client)> cob, const std::string& session_id, const std::set<std::string> & base_images);
  void send_remove_base_image(const std::string& session_id, const std::set<std::string> & base_images);
  bool recv_remove_base_image();
  void remove_snapshot_image(tcxx::function<void(carrier_serviceCobClient* client)> cob, const std::string& session_id, const std::map<std::string, image_map_info> & images);
  void send_remove_snapshot_image(const std::string& session_id, const std::map<std::string, image_map_info> & images);
  bool recv_remove_snapshot_image();
  void verify_management(tcxx::function<void(carrier_serviceCobClient* client)> cob, const std::string& management, const int32_t port, const bool is_ssl);
  void send_verify_management(const std::string& management, const int32_t port, const bool is_ssl);
  bool recv_verify_management();
  void set_buffer_size(tcxx::function<void(carrier_serviceCobClient* client)> cob, const std::string& session_id, const int32_t size);
  void send_set_buffer_size(const std::string& session_id, const int32_t size);
  bool recv_set_buffer_size();
  void is_buffer_free(tcxx::function<void(carrier_serviceCobClient* client)> cob, const std::string& session_id, const std::string& image_id);
  void send_is_buffer_free(const std::string& session_id, const std::string& image_id);
  bool recv_is_buffer_free();
  void is_image_replicated(tcxx::function<void(carrier_serviceCobClient* client)> cob, const std::string& session_id, const std::set<std::string> & connection_ids, const std::string& image_name);
  void send_is_image_replicated(const std::string& session_id, const std::set<std::string> & connection_ids, const std::string& image_name);
  bool recv_is_image_replicated();
};
...
class carrier_serviceAsyncProcessor : public common_connection_serviceAsyncProcessor {
 ...
 private:
  typedef  void (carrier_serviceAsyncProcessor::*ProcessFunction)(tcxx::function<void(bool ok)>, int32_t, ::apache::thrift::protocol::TProtocol*, ::apache::thrift::protocol::TProtocol*);
  typedef std::map<std::string, ProcessFunction> ProcessMap;
  ProcessMap processMap_;
  void process_create(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_create(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::string& _return);
  void throw_create(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_create_ex(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_create_ex(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::string& _return);
  void throw_create_ex(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_open(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_open(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::string& _return);
  void throw_open(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_read(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_read(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::string& _return);
  void throw_read(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_write(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_write(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const int32_t& _return);
  void throw_write(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_write_ex(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_write_ex(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const int32_t& _return);
  void throw_write_ex(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_close(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_close(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return);
  void throw_close(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_remove_base_image(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_remove_base_image(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return);
  void throw_remove_base_image(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  ...
  void process_set_buffer_size(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_set_buffer_size(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return);
  void throw_set_buffer_size(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_is_buffer_free(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_is_buffer_free(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return);
  void throw_is_buffer_free(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_is_image_replicated(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_is_image_replicated(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return);
  void throw_is_image_replicated(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
 public:
  carrier_serviceAsyncProcessor(boost::shared_ptr<carrier_serviceCobSvIf> iface) :
...
class carrier_serviceAsyncProcessorFactory : public ::apache::thrift::async::TAsyncProcessorFactory {
 public:
  carrier_serviceAsyncProcessorFactory(const ::boost::shared_ptr< carrier_serviceCobSvIfFactory >& handlerFactory) :
      handlerFactory_(handlerFactory) {}

  ::boost::shared_ptr< ::apache::thrift::async::TAsyncProcessor > getProcessor(const ::apache::thrift::TConnectionInfo& connInfo);

 protected:
  ::boost::shared_ptr< carrier_serviceCobSvIfFactory > handlerFactory_;
};
