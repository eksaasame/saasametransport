...
class common_connection_serviceIfSingletonFactory : virtual public common_connection_serviceIfFactory {
 public:
  common_connection_serviceIfSingletonFactory(const boost::shared_ptr<common_connection_serviceIf>& iface) : iface_(iface) {}
 ...
 protected:
  boost::shared_ptr<common_connection_serviceIf> iface_;
};
...
class common_connection_serviceClient : virtual public common_connection_serviceIf, public common_serviceClient {
 public:
  common_connection_serviceClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) :
    common_serviceClient(prot, prot) {}
  common_connection_serviceClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, boost::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) :    common_serviceClient(iprot, oprot) {}
...
class common_connection_serviceProcessor : public common_serviceProcessor {
 ...
 public:
  common_connection_serviceProcessor(boost::shared_ptr<common_connection_serviceIf> iface) :
...
class common_connection_serviceProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  common_connection_serviceProcessorFactory(const ::boost::shared_ptr< common_connection_serviceIfFactory >& handlerFactory) :
      handlerFactory_(handlerFactory) {}

  ::boost::shared_ptr< ::apache::thrift::TProcessor > getProcessor(const ::apache::thrift::TConnectionInfo& connInfo);

 protected:
  ::boost::shared_ptr< common_connection_serviceIfFactory > handlerFactory_;
};

class common_connection_serviceMultiface : virtual public common_connection_serviceIf, public common_serviceMultiface {
 public:
  common_connection_serviceMultiface(std::vector<boost::shared_ptr<common_connection_serviceIf> >& ifaces) : ifaces_(ifaces) {
    std::vector<boost::shared_ptr<common_connection_serviceIf> >::iterator iter;
 ...
 protected:
  std::vector<boost::shared_ptr<common_connection_serviceIf> > ifaces_;
  common_connection_serviceMultiface() {}
  void add(boost::shared_ptr<common_connection_serviceIf> iface) {
...
class common_connection_serviceConcurrentClient : virtual public common_connection_serviceIf, public common_serviceConcurrentClient {
 public:
  common_connection_serviceConcurrentClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) :
    common_serviceConcurrentClient(prot, prot) {}
  common_connection_serviceConcurrentClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, boost::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) :    common_serviceConcurrentClient(iprot, oprot) {}
  boost::shared_ptr< ::apache::thrift::protocol::TProtocol> getInputProtocol() {
    return piprot_;
  }
  boost::shared_ptr< ::apache::thrift::protocol::TProtocol> getOutputProtocol() {
...
class common_connection_serviceCobClIf : virtual public common_serviceCobClIf {
 public:
  ...
  virtual void test_connection(tcxx::function<void(common_connection_serviceCobClient* client)> cob, const std::string& session_id, const connection& conn) = 0;
  virtual void add_connection(tcxx::function<void(common_connection_serviceCobClient* client)> cob, const std::string& session_id, const connection& conn) = 0;
  virtual void remove_connection(tcxx::function<void(common_connection_serviceCobClient* client)> cob, const std::string& session_id, const std::string& connection_id) = 0;
  virtual void modify_connection(tcxx::function<void(common_connection_serviceCobClient* client)> cob, const std::string& session_id, const connection& conn) = 0;
  virtual void enumerate_connections(tcxx::function<void(common_connection_serviceCobClient* client)> cob, const std::string& session_id) = 0;
  virtual void get_connection(tcxx::function<void(common_connection_serviceCobClient* client)> cob, const std::string& session_id, const std::string& connection_id) = 0;
  virtual void get_available_bytes(tcxx::function<void(common_connection_serviceCobClient* client)> cob, const std::string& session_id, const std::string& connection_id) = 0;
};

class common_connection_serviceCobSvIf : virtual public common_serviceCobSvIf {
 public:
  virtual ~common_connection_serviceCobSvIf() {}
  virtual void test_connection(tcxx::function<void(bool const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const connection& conn) = 0;
  virtual void add_connection(tcxx::function<void(bool const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const connection& conn) = 0;
  virtual void remove_connection(tcxx::function<void(bool const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& connection_id) = 0;
  virtual void modify_connection(tcxx::function<void(bool const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const connection& conn) = 0;
  virtual void enumerate_connections(tcxx::function<void(std::vector<connection>  const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id) = 0;
  virtual void get_connection(tcxx::function<void(connection const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& connection_id) = 0;
  virtual void get_available_bytes(tcxx::function<void(int64_t const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& connection_id) = 0;
};
...
class common_connection_serviceCobSvIfSingletonFactory : virtual public common_connection_serviceCobSvIfFactory {
 public:
  common_connection_serviceCobSvIfSingletonFactory(const boost::shared_ptr<common_connection_serviceCobSvIf>& iface) : iface_(iface) {}
 ...
 protected:
  boost::shared_ptr<common_connection_serviceCobSvIf> iface_;
};
...
class common_connection_serviceCobClient : virtual public common_connection_serviceCobClIf, public common_serviceCobClient {
 public:
  common_connection_serviceCobClient(boost::shared_ptr< ::apache::thrift::async::TAsyncChannel> channel, ::apache::thrift::protocol::TProtocolFactory* protocolFactory) :
    common_serviceCobClient(channel, protocolFactory) {}
  boost::shared_ptr< ::apache::thrift::async::TAsyncChannel> getChannel() {
    return channel_;
  }
  virtual void completed__(bool /* success */) {}
  void test_connection(tcxx::function<void(common_connection_serviceCobClient* client)> cob, const std::string& session_id, const connection& conn);
  void send_test_connection(const std::string& session_id, const connection& conn);
  bool recv_test_connection();
  void add_connection(tcxx::function<void(common_connection_serviceCobClient* client)> cob, const std::string& session_id, const connection& conn);
  void send_add_connection(const std::string& session_id, const connection& conn);
  bool recv_add_connection();
  void remove_connection(tcxx::function<void(common_connection_serviceCobClient* client)> cob, const std::string& session_id, const std::string& connection_id);
  void send_remove_connection(const std::string& session_id, const std::string& connection_id);
  bool recv_remove_connection();
  void modify_connection(tcxx::function<void(common_connection_serviceCobClient* client)> cob, const std::string& session_id, const connection& conn);
  void send_modify_connection(const std::string& session_id, const connection& conn);
  bool recv_modify_connection();
  void enumerate_connections(tcxx::function<void(common_connection_serviceCobClient* client)> cob, const std::string& session_id);
  void send_enumerate_connections(const std::string& session_id);
  void recv_enumerate_connections(std::vector<connection> & _return);
  void get_connection(tcxx::function<void(common_connection_serviceCobClient* client)> cob, const std::string& session_id, const std::string& connection_id);
  void send_get_connection(const std::string& session_id, const std::string& connection_id);
  void recv_get_connection(connection& _return);
  void get_available_bytes(tcxx::function<void(common_connection_serviceCobClient* client)> cob, const std::string& session_id, const std::string& connection_id);
  void send_get_available_bytes(const std::string& session_id, const std::string& connection_id);
  int64_t recv_get_available_bytes();
};
...
class common_connection_serviceAsyncProcessor : public common_serviceAsyncProcessor {
 ...
 private:
  typedef  void (common_connection_serviceAsyncProcessor::*ProcessFunction)(tcxx::function<void(bool ok)>, int32_t, ::apache::thrift::protocol::TProtocol*, ::apache::thrift::protocol::TProtocol*);
  typedef std::map<std::string, ProcessFunction> ProcessMap;
  ProcessMap processMap_;
  void process_test_connection(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_test_connection(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return);
  void throw_test_connection(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_add_connection(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_add_connection(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return);
  void throw_add_connection(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_remove_connection(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_remove_connection(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return);
  void throw_remove_connection(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_modify_connection(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_modify_connection(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return);
  void throw_modify_connection(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_enumerate_connections(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_enumerate_connections(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::vector<connection> & _return);
  void throw_enumerate_connections(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_get_connection(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_get_connection(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const connection& _return);
  void throw_get_connection(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_get_available_bytes(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_get_available_bytes(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const int64_t& _return);
  void throw_get_available_bytes(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
 public:
  common_connection_serviceAsyncProcessor(boost::shared_ptr<common_connection_serviceCobSvIf> iface) :
...
class common_connection_serviceAsyncProcessorFactory : public ::apache::thrift::async::TAsyncProcessorFactory {
 public:
  common_connection_serviceAsyncProcessorFactory(const ::boost::shared_ptr< common_connection_serviceCobSvIfFactory >& handlerFactory) :
      handlerFactory_(handlerFactory) {}

  ::boost::shared_ptr< ::apache::thrift::async::TAsyncProcessor > getProcessor(const ::apache::thrift::TConnectionInfo& connInfo);

 protected:
  ::boost::shared_ptr< common_connection_serviceCobSvIfFactory > handlerFactory_;
};
