...
class transport_serviceIfSingletonFactory : virtual public transport_serviceIfFactory {
 public:
  transport_serviceIfSingletonFactory(const boost::shared_ptr<transport_serviceIf>& iface) : iface_(iface) {}
 ...
 protected:
  boost::shared_ptr<transport_serviceIf> iface_;
};
...
class transport_serviceClient : virtual public transport_serviceIf, public physical_packer_service_proxyClient {
 public:
  transport_serviceClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) :
    physical_packer_service_proxyClient(prot, prot) {}
  transport_serviceClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, boost::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) :    physical_packer_service_proxyClient(iprot, oprot) {}
...
class transport_serviceProcessor : public physical_packer_service_proxyProcessor {
 ...
 public:
  transport_serviceProcessor(boost::shared_ptr<transport_serviceIf> iface) :
...
class transport_serviceProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  transport_serviceProcessorFactory(const ::boost::shared_ptr< transport_serviceIfFactory >& handlerFactory) :
      handlerFactory_(handlerFactory) {}

  ::boost::shared_ptr< ::apache::thrift::TProcessor > getProcessor(const ::apache::thrift::TConnectionInfo& connInfo);

 protected:
  ::boost::shared_ptr< transport_serviceIfFactory > handlerFactory_;
};

class transport_serviceMultiface : virtual public transport_serviceIf, public physical_packer_service_proxyMultiface {
 public:
  transport_serviceMultiface(std::vector<boost::shared_ptr<transport_serviceIf> >& ifaces) : ifaces_(ifaces) {
    std::vector<boost::shared_ptr<transport_serviceIf> >::iterator iter;
 ...
 protected:
  std::vector<boost::shared_ptr<transport_serviceIf> > ifaces_;
  transport_serviceMultiface() {}
  void add(boost::shared_ptr<transport_serviceIf> iface) {
...
class transport_serviceConcurrentClient : virtual public transport_serviceIf, public physical_packer_service_proxyConcurrentClient {
 public:
  transport_serviceConcurrentClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) :
    physical_packer_service_proxyConcurrentClient(prot, prot) {}
  transport_serviceConcurrentClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, boost::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) :    physical_packer_service_proxyConcurrentClient(iprot, oprot) {}
  boost::shared_ptr< ::apache::thrift::protocol::TProtocol> getInputProtocol() {
    return piprot_;
  }
  boost::shared_ptr< ::apache::thrift::protocol::TProtocol> getOutputProtocol() {
...
class transport_serviceCobClIf : virtual public physical_packer_service_proxyCobClIf {
 public:
  ...
  virtual void generate_session(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr) = 0;
  virtual void get_package_info(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& email, const std::string& name, const std::string& key) = 0;
  virtual void active_license(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& email, const std::string& name, const std::string& key) = 0;
  virtual void add_license(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& license) = 0;
  virtual void add_license_with_key(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& key, const std::string& license) = 0;
  virtual void get_licenses(tcxx::function<void(transport_serviceCobClient* client)> cob) = 0;
  virtual void check_license_expiration(tcxx::function<void(transport_serviceCobClient* client)> cob, const int8_t days) = 0;
  virtual void is_license_valid(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& job_id) = 0;
  virtual void is_license_valid_ex(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& job_id, const bool is_recovery) = 0;
  virtual void remove_license(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& key) = 0;
  virtual void query_package_info(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& key) = 0;
  virtual void create_task(tcxx::function<void(transport_serviceCobClient* client)> cob, const running_task& task) = 0;
  virtual void remove_task(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& task_id) = 0;
  virtual void ping_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr) = 0;
  virtual void get_host_detail_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr, const machine_detail_filter::type filter) = 0;
  virtual void get_service_list_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr) = 0;
  virtual void enumerate_disks_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr, const enumerate_disk_filter_style::type filter) = 0;
  virtual void verify_carrier_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr, const std::string& carrier, const bool is_ssl) = 0;
  virtual void take_xray_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr) = 0;
  virtual void take_xrays_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr) = 0;
  virtual void create_mutex_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr, const std::string& session, const int16_t timeout) = 0;
  virtual void delete_mutex_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr, const std::string& session) = 0;
  virtual void create_job_ex_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr, const std::string& job_id, const create_job_detail& create_job, const std::string& service_type) = 0;
  virtual void get_job_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr, const std::string& job_id, const std::string& service_type) = 0;
  virtual void interrupt_job_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr, const std::string& job_id, const std::string& service_type) = 0;
  virtual void resume_job_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr, const std::string& job_id, const std::string& service_type) = 0;
  virtual void remove_job_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr, const std::string& job_id, const std::string& service_type) = 0;
  virtual void running_job_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr, const std::string& job_id, const std::string& service_type) = 0;
  virtual void update_job_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr, const std::string& job_id, const create_job_detail& create_job, const std::string& service_type) = 0;
  virtual void remove_snapshot_image_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr, const std::map<std::string, image_map_info> & images, const std::string& service_type) = 0;
  virtual void test_connection_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr, const connection& conn, const std::string& service_type) = 0;
  virtual void add_connection_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr, const connection& conn, const std::string& service_type) = 0;
  virtual void remove_connection_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr, const std::string& connection_id, const std::string& service_type) = 0;
  virtual void modify_connection_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr, const connection& conn, const std::string& service_type) = 0;
  virtual void enumerate_connections_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr, const std::string& service_type) = 0;
  virtual void get_connection_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr, const std::string& connection_id, const std::string& service_type) = 0;
  virtual void get_virtual_host_info_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr, const std::string& host, const std::string& username, const std::string& password) = 0;
  virtual void get_virtual_machine_detail_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id) = 0;
  virtual void get_physical_machine_detail_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr, const std::string& host, const machine_detail_filter::type filter) = 0;
  virtual void take_packer_xray_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr, const std::string& host) = 0;
  virtual void get_packer_service_info_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr, const std::string& host) = 0;
  virtual void verify_management_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr, const std::string& management, const int32_t port, const bool is_ssl) = 0;
  virtual void verify_packer_to_carrier_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr, const std::string& packer, const std::string& carrier, const int32_t port, const bool is_ssl) = 0;
  virtual void get_replica_job_create_detail(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id) = 0;
  virtual void get_loader_job_create_detail(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id) = 0;
  virtual void get_launcher_job_create_detail(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id) = 0;
  virtual void terminate(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& session_id) = 0;
  virtual void set_customized_id_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr, const std::string& disk_addr, const std::string& disk_id) = 0;
  virtual void unregister_packer_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr) = 0;
  virtual void unregister_server_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr) = 0;
  virtual void create_vhd_disk_from_snapshot(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& connection_string, const std::string& container, const std::string& original_disk_name, const std::string& target_disk_name, const std::string& snapshot) = 0;
  virtual void is_snapshot_vhd_disk_ready(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& task_id) = 0;
  virtual void delete_vhd_disk(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& connection_string, const std::string& container, const std::string& disk_name) = 0;
  virtual void delete_vhd_disk_snapshot(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& connection_string, const std::string& container, const std::string& disk_name, const std::string& snapshot) = 0;
  virtual void get_vhd_disk_snapshots(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& connection_string, const std::string& container, const std::string& disk_name) = 0;
  virtual void verify_connection_string(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& connection_string) = 0;
};
...
class transport_serviceCobSvIf : virtual public physical_packer_service_proxyCobSvIf {
 public:
  ...
  virtual void get_package_info(tcxx::function<void(std::string const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& email, const std::string& name, const std::string& key) = 0;
  virtual void active_license(tcxx::function<void(bool const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& email, const std::string& name, const std::string& key) = 0;
  virtual void add_license(tcxx::function<void(bool const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& license) = 0;
  virtual void add_license_with_key(tcxx::function<void(bool const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& key, const std::string& license) = 0;
  virtual void get_licenses(tcxx::function<void(license_infos const& _return)> cob) = 0;
  virtual void check_license_expiration(tcxx::function<void(bool const& _return)> cob, const int8_t days) = 0;
  virtual void is_license_valid(tcxx::function<void(bool const& _return)> cob, const std::string& job_id) = 0;
  virtual void is_license_valid_ex(tcxx::function<void(bool const& _return)> cob, const std::string& job_id, const bool is_recovery) = 0;
  virtual void remove_license(tcxx::function<void(bool const& _return)> cob, const std::string& key) = 0;
  virtual void query_package_info(tcxx::function<void(std::string const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& key) = 0;
  virtual void create_task(tcxx::function<void(bool const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const running_task& task) = 0;
  virtual void remove_task(tcxx::function<void(bool const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& task_id) = 0;
  virtual void ping_p(tcxx::function<void(service_info const& _return)> cob, const std::string& addr) = 0;
  virtual void get_host_detail_p(tcxx::function<void(physical_machine_info const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& addr, const machine_detail_filter::type filter) = 0;
  virtual void get_service_list_p(tcxx::function<void(std::set<service_info>  const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& addr) = 0;
  virtual void enumerate_disks_p(tcxx::function<void(std::set<disk_info>  const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& addr, const enumerate_disk_filter_style::type filter) = 0;
  virtual void verify_carrier_p(tcxx::function<void(bool const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& addr, const std::string& carrier, const bool is_ssl) = 0;
  virtual void take_xray_p(tcxx::function<void(std::string const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& addr) = 0;
  virtual void take_xrays_p(tcxx::function<void(std::string const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& addr) = 0;
  virtual void create_mutex_p(tcxx::function<void(bool const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& addr, const std::string& session, const int16_t timeout) = 0;
  virtual void delete_mutex_p(tcxx::function<void(bool const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& addr, const std::string& session) = 0;
  virtual void create_job_ex_p(tcxx::function<void(job_detail const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& addr, const std::string& job_id, const create_job_detail& create_job, const std::string& service_type) = 0;
  virtual void get_job_p(tcxx::function<void(job_detail const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& addr, const std::string& job_id, const std::string& service_type) = 0;
  virtual void interrupt_job_p(tcxx::function<void(bool const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& addr, const std::string& job_id, const std::string& service_type) = 0;
  virtual void resume_job_p(tcxx::function<void(bool const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& addr, const std::string& job_id, const std::string& service_type) = 0;
  virtual void remove_job_p(tcxx::function<void(bool const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& addr, const std::string& job_id, const std::string& service_type) = 0;
  virtual void running_job_p(tcxx::function<void(bool const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& addr, const std::string& job_id, const std::string& service_type) = 0;
  virtual void update_job_p(tcxx::function<void(bool const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& addr, const std::string& job_id, const create_job_detail& create_job, const std::string& service_type) = 0;
  virtual void remove_snapshot_image_p(tcxx::function<void(bool const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& addr, const std::map<std::string, image_map_info> & images, const std::string& service_type) = 0;
  virtual void test_connection_p(tcxx::function<void(bool const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& addr, const connection& conn, const std::string& service_type) = 0;
  virtual void add_connection_p(tcxx::function<void(bool const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& addr, const connection& conn, const std::string& service_type) = 0;
  virtual void remove_connection_p(tcxx::function<void(bool const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& addr, const std::string& connection_id, const std::string& service_type) = 0;
  virtual void modify_connection_p(tcxx::function<void(bool const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& addr, const connection& conn, const std::string& service_type) = 0;
  virtual void enumerate_connections_p(tcxx::function<void(std::vector<connection>  const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& addr, const std::string& service_type) = 0;
  virtual void get_connection_p(tcxx::function<void(connection const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& addr, const std::string& connection_id, const std::string& service_type) = 0;
  virtual void get_virtual_host_info_p(tcxx::function<void(virtual_host const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& addr, const std::string& host, const std::string& username, const std::string& password) = 0;
  virtual void get_virtual_machine_detail_p(tcxx::function<void(virtual_machine const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& addr, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id) = 0;
  virtual void get_physical_machine_detail_p(tcxx::function<void(physical_machine_info const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& addr, const std::string& host, const machine_detail_filter::type filter) = 0;
  virtual void take_packer_xray_p(tcxx::function<void(std::string const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& addr, const std::string& host) = 0;
  virtual void get_packer_service_info_p(tcxx::function<void(service_info const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& addr, const std::string& host) = 0;
  virtual void verify_management_p(tcxx::function<void(bool const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& addr, const std::string& management, const int32_t port, const bool is_ssl) = 0;
  virtual void verify_packer_to_carrier_p(tcxx::function<void(bool const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& addr, const std::string& packer, const std::string& carrier, const int32_t port, const bool is_ssl) = 0;
  ...
  virtual void set_customized_id_p(tcxx::function<void(bool const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& addr, const std::string& disk_addr, const std::string& disk_id) = 0;
  virtual void unregister_packer_p(tcxx::function<void(bool const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& addr) = 0;
  virtual void unregister_server_p(tcxx::function<void(bool const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& addr) = 0;
  virtual void create_vhd_disk_from_snapshot(tcxx::function<void(std::string const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& connection_string, const std::string& container, const std::string& original_disk_name, const std::string& target_disk_name, const std::string& snapshot) = 0;
  virtual void is_snapshot_vhd_disk_ready(tcxx::function<void(bool const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& task_id) = 0;
  virtual void delete_vhd_disk(tcxx::function<void(bool const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& connection_string, const std::string& container, const std::string& disk_name) = 0;
  virtual void delete_vhd_disk_snapshot(tcxx::function<void(bool const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& connection_string, const std::string& container, const std::string& disk_name, const std::string& snapshot) = 0;
  virtual void get_vhd_disk_snapshots(tcxx::function<void(std::vector<vhd_snapshot>  const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& connection_string, const std::string& container, const std::string& disk_name) = 0;
  virtual void verify_connection_string(tcxx::function<void(bool const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& connection_string) = 0;
};
...
class transport_serviceCobSvIfSingletonFactory : virtual public transport_serviceCobSvIfFactory {
 public:
  transport_serviceCobSvIfSingletonFactory(const boost::shared_ptr<transport_serviceCobSvIf>& iface) : iface_(iface) {}
 ...
 protected:
  boost::shared_ptr<transport_serviceCobSvIf> iface_;
};
...
class transport_serviceCobClient : virtual public transport_serviceCobClIf, public physical_packer_service_proxyCobClient {
 public:
  transport_serviceCobClient(boost::shared_ptr< ::apache::thrift::async::TAsyncChannel> channel, ::apache::thrift::protocol::TProtocolFactory* protocolFactory) :
  ...
  void generate_session(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr);
  void send_generate_session(const std::string& addr);
  void recv_generate_session(std::string& _return);
  void get_package_info(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& email, const std::string& name, const std::string& key);
  void send_get_package_info(const std::string& email, const std::string& name, const std::string& key);
  void recv_get_package_info(std::string& _return);
  void active_license(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& email, const std::string& name, const std::string& key);
  void send_active_license(const std::string& email, const std::string& name, const std::string& key);
  bool recv_active_license();
  void add_license(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& license);
  void send_add_license(const std::string& license);
  bool recv_add_license();
  void add_license_with_key(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& key, const std::string& license);
  void send_add_license_with_key(const std::string& key, const std::string& license);
  bool recv_add_license_with_key();
  void get_licenses(tcxx::function<void(transport_serviceCobClient* client)> cob);
  void send_get_licenses();
  void recv_get_licenses(license_infos& _return);
  void check_license_expiration(tcxx::function<void(transport_serviceCobClient* client)> cob, const int8_t days);
  void send_check_license_expiration(const int8_t days);
  bool recv_check_license_expiration();
  void is_license_valid(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& job_id);
  void send_is_license_valid(const std::string& job_id);
  bool recv_is_license_valid();
  void is_license_valid_ex(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& job_id, const bool is_recovery);
  void send_is_license_valid_ex(const std::string& job_id, const bool is_recovery);
  bool recv_is_license_valid_ex();
  void remove_license(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& key);
  void send_remove_license(const std::string& key);
  bool recv_remove_license();
  void query_package_info(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& key);
  void send_query_package_info(const std::string& key);
  void recv_query_package_info(std::string& _return);
  void create_task(tcxx::function<void(transport_serviceCobClient* client)> cob, const running_task& task);
  void send_create_task(const running_task& task);
  bool recv_create_task();
  void remove_task(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& task_id);
  void send_remove_task(const std::string& task_id);
  bool recv_remove_task();
  void ping_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr);
  void send_ping_p(const std::string& addr);
  void recv_ping_p(service_info& _return);
  void get_host_detail_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr, const machine_detail_filter::type filter);
  void send_get_host_detail_p(const std::string& addr, const machine_detail_filter::type filter);
  void recv_get_host_detail_p(physical_machine_info& _return);
  void get_service_list_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr);
  void send_get_service_list_p(const std::string& addr);
  void recv_get_service_list_p(std::set<service_info> & _return);
  void enumerate_disks_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr, const enumerate_disk_filter_style::type filter);
  void send_enumerate_disks_p(const std::string& addr, const enumerate_disk_filter_style::type filter);
  void recv_enumerate_disks_p(std::set<disk_info> & _return);
  void verify_carrier_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr, const std::string& carrier, const bool is_ssl);
  void send_verify_carrier_p(const std::string& addr, const std::string& carrier, const bool is_ssl);
  bool recv_verify_carrier_p();
  void take_xray_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr);
  void send_take_xray_p(const std::string& addr);
  void recv_take_xray_p(std::string& _return);
  void take_xrays_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr);
  void send_take_xrays_p(const std::string& addr);
  void recv_take_xrays_p(std::string& _return);
  void create_mutex_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr, const std::string& session, const int16_t timeout);
  void send_create_mutex_p(const std::string& addr, const std::string& session, const int16_t timeout);
  bool recv_create_mutex_p();
  void delete_mutex_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr, const std::string& session);
  void send_delete_mutex_p(const std::string& addr, const std::string& session);
  bool recv_delete_mutex_p();
  void create_job_ex_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr, const std::string& job_id, const create_job_detail& create_job, const std::string& service_type);
  void send_create_job_ex_p(const std::string& addr, const std::string& job_id, const create_job_detail& create_job, const std::string& service_type);
  void recv_create_job_ex_p(job_detail& _return);
  void get_job_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr, const std::string& job_id, const std::string& service_type);
  void send_get_job_p(const std::string& addr, const std::string& job_id, const std::string& service_type);
  void recv_get_job_p(job_detail& _return);
  void interrupt_job_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr, const std::string& job_id, const std::string& service_type);
  void send_interrupt_job_p(const std::string& addr, const std::string& job_id, const std::string& service_type);
  bool recv_interrupt_job_p();
  void resume_job_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr, const std::string& job_id, const std::string& service_type);
  void send_resume_job_p(const std::string& addr, const std::string& job_id, const std::string& service_type);
  bool recv_resume_job_p();
  void remove_job_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr, const std::string& job_id, const std::string& service_type);
  void send_remove_job_p(const std::string& addr, const std::string& job_id, const std::string& service_type);
  bool recv_remove_job_p();
  void running_job_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr, const std::string& job_id, const std::string& service_type);
  void send_running_job_p(const std::string& addr, const std::string& job_id, const std::string& service_type);
  bool recv_running_job_p();
  void update_job_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr, const std::string& job_id, const create_job_detail& create_job, const std::string& service_type);
  void send_update_job_p(const std::string& addr, const std::string& job_id, const create_job_detail& create_job, const std::string& service_type);
  bool recv_update_job_p();
  void remove_snapshot_image_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr, const std::map<std::string, image_map_info> & images, const std::string& service_type);
  void send_remove_snapshot_image_p(const std::string& addr, const std::map<std::string, image_map_info> & images, const std::string& service_type);
  bool recv_remove_snapshot_image_p();
  void test_connection_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr, const connection& conn, const std::string& service_type);
  void send_test_connection_p(const std::string& addr, const connection& conn, const std::string& service_type);
  bool recv_test_connection_p();
  void add_connection_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr, const connection& conn, const std::string& service_type);
  void send_add_connection_p(const std::string& addr, const connection& conn, const std::string& service_type);
  bool recv_add_connection_p();
  void remove_connection_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr, const std::string& connection_id, const std::string& service_type);
  void send_remove_connection_p(const std::string& addr, const std::string& connection_id, const std::string& service_type);
  bool recv_remove_connection_p();
  void modify_connection_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr, const connection& conn, const std::string& service_type);
  void send_modify_connection_p(const std::string& addr, const connection& conn, const std::string& service_type);
  bool recv_modify_connection_p();
  void enumerate_connections_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr, const std::string& service_type);
  void send_enumerate_connections_p(const std::string& addr, const std::string& service_type);
  void recv_enumerate_connections_p(std::vector<connection> & _return);
  void get_connection_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr, const std::string& connection_id, const std::string& service_type);
  void send_get_connection_p(const std::string& addr, const std::string& connection_id, const std::string& service_type);
  void recv_get_connection_p(connection& _return);
  void get_virtual_host_info_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr, const std::string& host, const std::string& username, const std::string& password);
  void send_get_virtual_host_info_p(const std::string& addr, const std::string& host, const std::string& username, const std::string& password);
  void recv_get_virtual_host_info_p(virtual_host& _return);
  void get_virtual_machine_detail_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id);
  void send_get_virtual_machine_detail_p(const std::string& addr, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id);
  void recv_get_virtual_machine_detail_p(virtual_machine& _return);
  void get_physical_machine_detail_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr, const std::string& host, const machine_detail_filter::type filter);
  void send_get_physical_machine_detail_p(const std::string& addr, const std::string& host, const machine_detail_filter::type filter);
  void recv_get_physical_machine_detail_p(physical_machine_info& _return);
  void take_packer_xray_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr, const std::string& host);
  void send_take_packer_xray_p(const std::string& addr, const std::string& host);
  void recv_take_packer_xray_p(std::string& _return);
  void get_packer_service_info_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr, const std::string& host);
  void send_get_packer_service_info_p(const std::string& addr, const std::string& host);
  void recv_get_packer_service_info_p(service_info& _return);
  void verify_management_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr, const std::string& management, const int32_t port, const bool is_ssl);
  void send_verify_management_p(const std::string& addr, const std::string& management, const int32_t port, const bool is_ssl);
  bool recv_verify_management_p();
  void verify_packer_to_carrier_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr, const std::string& packer, const std::string& carrier, const int32_t port, const bool is_ssl);
  void send_verify_packer_to_carrier_p(const std::string& addr, const std::string& packer, const std::string& carrier, const int32_t port, const bool is_ssl);
  bool recv_verify_packer_to_carrier_p();
  void get_replica_job_create_detail(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id);
  void send_get_replica_job_create_detail(const std::string& session_id, const std::string& job_id);
  void recv_get_replica_job_create_detail(replica_job_create_detail& _return);
  void get_loader_job_create_detail(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id);
  void send_get_loader_job_create_detail(const std::string& session_id, const std::string& job_id);
  void recv_get_loader_job_create_detail(loader_job_create_detail& _return);
  void get_launcher_job_create_detail(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id);
  void send_get_launcher_job_create_detail(const std::string& session_id, const std::string& job_id);
  void recv_get_launcher_job_create_detail(launcher_job_create_detail& _return);
  void terminate(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& session_id);
  void send_terminate(const std::string& session_id);
  void recv_terminate();
  void set_customized_id_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr, const std::string& disk_addr, const std::string& disk_id);
  void send_set_customized_id_p(const std::string& addr, const std::string& disk_addr, const std::string& disk_id);
  bool recv_set_customized_id_p();
  void unregister_packer_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr);
  void send_unregister_packer_p(const std::string& addr);
  bool recv_unregister_packer_p();
  void unregister_server_p(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& addr);
  void send_unregister_server_p(const std::string& addr);
  bool recv_unregister_server_p();
  void create_vhd_disk_from_snapshot(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& connection_string, const std::string& container, const std::string& original_disk_name, const std::string& target_disk_name, const std::string& snapshot);
  void send_create_vhd_disk_from_snapshot(const std::string& connection_string, const std::string& container, const std::string& original_disk_name, const std::string& target_disk_name, const std::string& snapshot);
  void recv_create_vhd_disk_from_snapshot(std::string& _return);
  void is_snapshot_vhd_disk_ready(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& task_id);
  void send_is_snapshot_vhd_disk_ready(const std::string& task_id);
  bool recv_is_snapshot_vhd_disk_ready();
  void delete_vhd_disk(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& connection_string, const std::string& container, const std::string& disk_name);
  void send_delete_vhd_disk(const std::string& connection_string, const std::string& container, const std::string& disk_name);
  bool recv_delete_vhd_disk();
  void delete_vhd_disk_snapshot(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& connection_string, const std::string& container, const std::string& disk_name, const std::string& snapshot);
  void send_delete_vhd_disk_snapshot(const std::string& connection_string, const std::string& container, const std::string& disk_name, const std::string& snapshot);
  bool recv_delete_vhd_disk_snapshot();
  void get_vhd_disk_snapshots(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& connection_string, const std::string& container, const std::string& disk_name);
  void send_get_vhd_disk_snapshots(const std::string& connection_string, const std::string& container, const std::string& disk_name);
  void recv_get_vhd_disk_snapshots(std::vector<vhd_snapshot> & _return);
  void verify_connection_string(tcxx::function<void(transport_serviceCobClient* client)> cob, const std::string& connection_string);
  void send_verify_connection_string(const std::string& connection_string);
  bool recv_verify_connection_string();
};
...
class transport_serviceAsyncProcessor : public physical_packer_service_proxyAsyncProcessor {
 ...
 private:
  typedef  void (transport_serviceAsyncProcessor::*ProcessFunction)(tcxx::function<void(bool ok)>, int32_t, ::apache::thrift::protocol::TProtocol*, ::apache::thrift::protocol::TProtocol*);
  typedef std::map<std::string, ProcessFunction> ProcessMap;
  ProcessMap processMap_;
  ...
  void process_get_package_info(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_get_package_info(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::string& _return);
  void throw_get_package_info(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_active_license(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_active_license(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return);
  void throw_active_license(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_add_license(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_add_license(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return);
  void throw_add_license(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_add_license_with_key(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_add_license_with_key(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return);
  void throw_add_license_with_key(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_get_licenses(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_get_licenses(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const license_infos& _return);
  void throw_get_licenses(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_check_license_expiration(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_check_license_expiration(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return);
  void throw_check_license_expiration(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_is_license_valid(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_is_license_valid(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return);
  void throw_is_license_valid(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_is_license_valid_ex(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_is_license_valid_ex(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return);
  void throw_is_license_valid_ex(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_remove_license(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_remove_license(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return);
  void throw_remove_license(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_query_package_info(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_query_package_info(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::string& _return);
  void throw_query_package_info(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_create_task(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_create_task(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return);
  void throw_create_task(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_remove_task(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_remove_task(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return);
  void throw_remove_task(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_ping_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_ping_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const service_info& _return);
  void throw_ping_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_get_host_detail_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_get_host_detail_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const physical_machine_info& _return);
  void throw_get_host_detail_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_get_service_list_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_get_service_list_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::set<service_info> & _return);
  void throw_get_service_list_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_enumerate_disks_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_enumerate_disks_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::set<disk_info> & _return);
  void throw_enumerate_disks_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_verify_carrier_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_verify_carrier_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return);
  void throw_verify_carrier_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_take_xray_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_take_xray_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::string& _return);
  void throw_take_xray_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_take_xrays_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_take_xrays_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::string& _return);
  void throw_take_xrays_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_create_mutex_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_create_mutex_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return);
  void throw_create_mutex_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_delete_mutex_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_delete_mutex_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return);
  void throw_delete_mutex_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  ...
  void process_verify_management_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_verify_management_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return);
  void throw_verify_management_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  ...
  void process_unregister_packer_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_unregister_packer_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return);
  void throw_unregister_packer_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_unregister_server_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_unregister_server_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return);
  void throw_unregister_server_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_create_vhd_disk_from_snapshot(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_create_vhd_disk_from_snapshot(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::string& _return);
  void throw_create_vhd_disk_from_snapshot(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_is_snapshot_vhd_disk_ready(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_is_snapshot_vhd_disk_ready(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return);
  void throw_is_snapshot_vhd_disk_ready(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_delete_vhd_disk(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_delete_vhd_disk(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return);
  void throw_delete_vhd_disk(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_delete_vhd_disk_snapshot(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_delete_vhd_disk_snapshot(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return);
  void throw_delete_vhd_disk_snapshot(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_get_vhd_disk_snapshots(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_get_vhd_disk_snapshots(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::vector<vhd_snapshot> & _return);
  void throw_get_vhd_disk_snapshots(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_verify_connection_string(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_verify_connection_string(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return);
  void throw_verify_connection_string(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
 public:
  transport_serviceAsyncProcessor(boost::shared_ptr<transport_serviceCobSvIf> iface) :
...
class transport_serviceAsyncProcessorFactory : public ::apache::thrift::async::TAsyncProcessorFactory {
 public:
  transport_serviceAsyncProcessorFactory(const ::boost::shared_ptr< transport_serviceCobSvIfFactory >& handlerFactory) :
      handlerFactory_(handlerFactory) {}

  ::boost::shared_ptr< ::apache::thrift::async::TAsyncProcessor > getProcessor(const ::apache::thrift::TConnectionInfo& connInfo);

 protected:
  ::boost::shared_ptr< transport_serviceCobSvIfFactory > handlerFactory_;
};
