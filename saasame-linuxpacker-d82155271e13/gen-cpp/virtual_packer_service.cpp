...
uint32_t virtual_packer_service_list_jobs_result::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.success) {
    xfer += oprot->writeFieldBegin("success", ::apache::thrift::protocol::T_LIST, 0);
    {
      ...
      std::vector<packer_job_detail> ::const_iterator _iter1198;
...
uint32_t virtual_packer_service_list_jobs_presult::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  {
    xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>((*(this->success)).size()));
    std::vector<packer_job_detail> ::const_iterator _iter1204;
    for (_iter1204 = (*(this->success)).begin(); _iter1204 != (*(this->success)).end(); ++_iter1204)
    {
      xfer += (*_iter1204).write(oprot);
    }
    xfer += oprot->writeListEnd();
  }
  xfer += oprot->writeFieldEnd();
...
::boost::shared_ptr< ::apache::thrift::TProcessor > virtual_packer_serviceProcessorFactory::getProcessor(const ::apache::thrift::TConnectionInfo& connInfo) {
  ::apache::thrift::ReleaseHandler< virtual_packer_serviceIfFactory > cleanup(handlerFactory_);
  ::boost::shared_ptr< virtual_packer_serviceIf > handler(handlerFactory_->getHandler(connInfo), cleanup);
  ::boost::shared_ptr< ::apache::thrift::TProcessor > processor(new virtual_packer_serviceProcessor(handler));
  return processor;
}
...
void virtual_packer_serviceCobClient::get_virtual_host_info(tcxx::function<void(virtual_packer_serviceCobClient* client)> cob, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password)
{
  send_get_virtual_host_info(session_id, host, username, password);
...
void virtual_packer_serviceCobClient::get_virtual_machine_detail(tcxx::function<void(virtual_packer_serviceCobClient* client)> cob, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id)
{
  send_get_virtual_machine_detail(session_id, host, username, password, machine_id);
  channel_->sendAndRecvMessage(tcxx::bind(cob, this), otrans_.get(), itrans_.get());
}
...
void virtual_packer_serviceCobClient::create_job_ex(tcxx::function<void(virtual_packer_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id, const create_packer_job_detail& create_job)
{
  send_create_job_ex(session_id, job_id, create_job);
  channel_->sendAndRecvMessage(tcxx::bind(cob, this), otrans_.get(), itrans_.get());
}
...
void virtual_packer_serviceCobClient::create_job(tcxx::function<void(virtual_packer_serviceCobClient* client)> cob, const std::string& session_id, const create_packer_job_detail& create_job)
{
  send_create_job(session_id, create_job);
  channel_->sendAndRecvMessage(tcxx::bind(cob, this), otrans_.get(), itrans_.get());
}
...
void virtual_packer_serviceCobClient::get_job(tcxx::function<void(virtual_packer_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id, const std::string& previous_updated_time)
{
  send_get_job(session_id, job_id, previous_updated_time);
  channel_->sendAndRecvMessage(tcxx::bind(cob, this), otrans_.get(), itrans_.get());
}
...
void virtual_packer_serviceCobClient::interrupt_job(tcxx::function<void(virtual_packer_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id)
{
  send_interrupt_job(session_id, job_id);
  channel_->sendAndRecvMessage(tcxx::bind(cob, this), otrans_.get(), itrans_.get());
}
...
void virtual_packer_serviceCobClient::resume_job(tcxx::function<void(virtual_packer_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id)
{
  send_resume_job(session_id, job_id);
  channel_->sendAndRecvMessage(tcxx::bind(cob, this), otrans_.get(), itrans_.get());
}
...
void virtual_packer_serviceCobClient::remove_job(tcxx::function<void(virtual_packer_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id)
{
  send_remove_job(session_id, job_id);
  channel_->sendAndRecvMessage(tcxx::bind(cob, this), otrans_.get(), itrans_.get());
}
...
void virtual_packer_serviceCobClient::list_jobs(tcxx::function<void(virtual_packer_serviceCobClient* client)> cob, const std::string& session_id)
{
  send_list_jobs(session_id);
  channel_->sendAndRecvMessage(tcxx::bind(cob, this), otrans_.get(), itrans_.get());
}
...
void virtual_packer_serviceCobClient::terminate(tcxx::function<void(virtual_packer_serviceCobClient* client)> cob, const std::string& session_id)
{
  send_terminate(session_id);
  channel_->sendAndRecvMessage(tcxx::bind(cob, this), otrans_.get(), itrans_.get());
}
...
void virtual_packer_serviceCobClient::running_job(tcxx::function<void(virtual_packer_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id)
{
  send_running_job(session_id, job_id);
  channel_->sendAndRecvMessage(tcxx::bind(cob, this), otrans_.get(), itrans_.get());
}
...
void virtual_packer_serviceAsyncProcessor::dispatchCall(tcxx::function<void(bool ok)> cob, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, const std::string& fname, int32_t seqid) {
  ProcessMap::iterator pfn;
  pfn = processMap_.find(fname);
  if (pfn == processMap_.end()) {
...
void virtual_packer_serviceAsyncProcessor::process_get_virtual_host_info(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  virtual_packer_service_get_virtual_host_info_args args;
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
  ...
  freer.unregister();
  void (virtual_packer_serviceAsyncProcessor::*return_fn)(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const virtual_host& _return) =
    &virtual_packer_serviceAsyncProcessor::return_get_virtual_host_info;
  void (virtual_packer_serviceAsyncProcessor::*throw_fn)(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw) =
...
void virtual_packer_serviceAsyncProcessor::return_get_virtual_host_info(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const virtual_host& _return)
{
  virtual_packer_service_get_virtual_host_info_presult result;
...
void virtual_packer_serviceAsyncProcessor::throw_get_virtual_host_info(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw)
{
...
void virtual_packer_serviceAsyncProcessor::process_get_virtual_machine_detail(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  virtual_packer_service_get_virtual_machine_detail_args args;
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
  ...
  freer.unregister();
  void (virtual_packer_serviceAsyncProcessor::*return_fn)(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const virtual_machine& _return) =
...
void virtual_packer_serviceAsyncProcessor::return_get_virtual_machine_detail(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const virtual_machine& _return)
{
  virtual_packer_service_get_virtual_machine_detail_presult result;
...
void virtual_packer_serviceAsyncProcessor::throw_get_virtual_machine_detail(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw)
{
...
void virtual_packer_serviceAsyncProcessor::process_create_job_ex(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  virtual_packer_service_create_job_ex_args args;
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
  ...
  freer.unregister();
  void (virtual_packer_serviceAsyncProcessor::*return_fn)(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const packer_job_detail& _return) =
...
void virtual_packer_serviceAsyncProcessor::return_create_job_ex(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const packer_job_detail& _return)
{
  virtual_packer_service_create_job_ex_presult result;
...
void virtual_packer_serviceAsyncProcessor::throw_create_job_ex(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw)
{
...
void virtual_packer_serviceAsyncProcessor::process_create_job(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  virtual_packer_service_create_job_args args;
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
...
void virtual_packer_serviceAsyncProcessor::return_create_job(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const packer_job_detail& _return)
{
  virtual_packer_service_create_job_presult result;
  result.success = const_cast<packer_job_detail*>(&_return);
  result.__isset.success = true;
...
void virtual_packer_serviceAsyncProcessor::throw_create_job(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw)
{
...
void virtual_packer_serviceAsyncProcessor::process_get_job(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  virtual_packer_service_get_job_args args;
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
...
void virtual_packer_serviceAsyncProcessor::return_get_job(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const packer_job_detail& _return)
{
  virtual_packer_service_get_job_presult result;
  result.success = const_cast<packer_job_detail*>(&_return);
  result.__isset.success = true;
...
void virtual_packer_serviceAsyncProcessor::throw_get_job(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw)
{
...
void virtual_packer_serviceAsyncProcessor::process_interrupt_job(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  virtual_packer_service_interrupt_job_args args;
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
  ...
  freer.unregister();
  void (virtual_packer_serviceAsyncProcessor::*return_fn)(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return) =
...
void virtual_packer_serviceAsyncProcessor::return_interrupt_job(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return)
{
  virtual_packer_service_interrupt_job_presult result;
...
void virtual_packer_serviceAsyncProcessor::throw_interrupt_job(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw)
{
...
void virtual_packer_serviceAsyncProcessor::process_resume_job(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  virtual_packer_service_resume_job_args args;
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
...
void virtual_packer_serviceAsyncProcessor::return_resume_job(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return)
{
  virtual_packer_service_resume_job_presult result;
  result.success = const_cast<bool*>(&_return);
  result.__isset.success = true;
...
void virtual_packer_serviceAsyncProcessor::throw_resume_job(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw)
{
...
void virtual_packer_serviceAsyncProcessor::process_remove_job(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  virtual_packer_service_remove_job_args args;
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
...
void virtual_packer_serviceAsyncProcessor::return_remove_job(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return)
{
  virtual_packer_service_remove_job_presult result;
  result.success = const_cast<bool*>(&_return);
  result.__isset.success = true;
...
void virtual_packer_serviceAsyncProcessor::throw_remove_job(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw)
{
...
void virtual_packer_serviceAsyncProcessor::process_list_jobs(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  virtual_packer_service_list_jobs_args args;
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
  ...
  freer.unregister();
  void (virtual_packer_serviceAsyncProcessor::*return_fn)(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::vector<packer_job_detail> & _return) =
...
void virtual_packer_serviceAsyncProcessor::return_list_jobs(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::vector<packer_job_detail> & _return)
{
  virtual_packer_service_list_jobs_presult result;
...
void virtual_packer_serviceAsyncProcessor::throw_list_jobs(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw)
{
...
void virtual_packer_serviceAsyncProcessor::process_terminate(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  virtual_packer_service_terminate_args args;
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
  ...
  freer.unregister();
  void (virtual_packer_serviceAsyncProcessor::*return_fn)(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx) =
...
void virtual_packer_serviceAsyncProcessor::return_terminate(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx)
{
  virtual_packer_service_terminate_presult result;
...
void virtual_packer_serviceAsyncProcessor::process_running_job(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  virtual_packer_service_running_job_args args;
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
...
void virtual_packer_serviceAsyncProcessor::return_running_job(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return)
{
  virtual_packer_service_running_job_presult result;
  result.success = const_cast<bool*>(&_return);
  result.__isset.success = true;
...
void virtual_packer_serviceAsyncProcessor::throw_running_job(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw)
{
...
::boost::shared_ptr< ::apache::thrift::async::TAsyncProcessor > virtual_packer_serviceAsyncProcessorFactory::getProcessor(const ::apache::thrift::TConnectionInfo& connInfo) {
  ::apache::thrift::ReleaseHandler< virtual_packer_serviceCobSvIfFactory > cleanup(handlerFactory_);
  ::boost::shared_ptr< virtual_packer_serviceCobSvIf > handler(handlerFactory_->getHandler(connInfo), cleanup);
  ::boost::shared_ptr< ::apache::thrift::async::TAsyncProcessor > processor(new virtual_packer_serviceAsyncProcessor(handler));
  return processor;
}
