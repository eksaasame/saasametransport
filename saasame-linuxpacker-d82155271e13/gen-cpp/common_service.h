...
class common_serviceIfSingletonFactory : virtual public common_serviceIfFactory {
 public:
  common_serviceIfSingletonFactory(const boost::shared_ptr<common_serviceIf>& iface) : iface_(iface) {}
 ...
 protected:
  boost::shared_ptr<common_serviceIf> iface_;
};
...
class common_serviceClient : virtual public common_serviceIf {
 public:
  common_serviceClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  common_serviceClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, boost::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
...
class common_serviceProcessor : public ::apache::thrift::TDispatchProcessor {
 ...
 public:
  common_serviceProcessor(boost::shared_ptr<common_serviceIf> iface) :
    iface_(iface) {
...
class common_serviceProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  common_serviceProcessorFactory(const ::boost::shared_ptr< common_serviceIfFactory >& handlerFactory) :
      handlerFactory_(handlerFactory) {}

  ::boost::shared_ptr< ::apache::thrift::TProcessor > getProcessor(const ::apache::thrift::TConnectionInfo& connInfo);

 protected:
  ::boost::shared_ptr< common_serviceIfFactory > handlerFactory_;
};

class common_serviceMultiface : virtual public common_serviceIf {
 public:
  common_serviceMultiface(std::vector<boost::shared_ptr<common_serviceIf> >& ifaces) : ifaces_(ifaces) {
  }
  virtual ~common_serviceMultiface() {}
 protected:
  std::vector<boost::shared_ptr<common_serviceIf> > ifaces_;
  common_serviceMultiface() {}
  void add(boost::shared_ptr<common_serviceIf> iface) {
...
class common_serviceConcurrentClient : virtual public common_serviceIf {
 public:
  common_serviceConcurrentClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  common_serviceConcurrentClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, boost::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
    setProtocol(iprot,oprot);
  }
 private:
  void setProtocol(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
...
class common_serviceCobClIf {
 public:
  ...
  virtual void ping(tcxx::function<void(common_serviceCobClient* client)> cob) = 0;
  virtual void get_host_detail(tcxx::function<void(common_serviceCobClient* client)> cob, const std::string& session_id, const machine_detail_filter::type filter) = 0;
  virtual void get_service_list(tcxx::function<void(common_serviceCobClient* client)> cob, const std::string& session_id) = 0;
  virtual void enumerate_disks(tcxx::function<void(common_serviceCobClient* client)> cob, const enumerate_disk_filter_style::type filter) = 0;
  virtual void verify_carrier(tcxx::function<void(common_serviceCobClient* client)> cob, const std::string& carrier, const bool is_ssl) = 0;
  virtual void take_xray(tcxx::function<void(common_serviceCobClient* client)> cob) = 0;
  virtual void take_xrays(tcxx::function<void(common_serviceCobClient* client)> cob) = 0;
  virtual void create_mutex(tcxx::function<void(common_serviceCobClient* client)> cob, const std::string& session, const int16_t timeout) = 0;
  virtual void delete_mutex(tcxx::function<void(common_serviceCobClient* client)> cob, const std::string& session) = 0;
};
...
class common_serviceCobSvIf {
 public:
  ...
  virtual void get_host_detail(tcxx::function<void(physical_machine_info const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const machine_detail_filter::type filter) = 0;
  virtual void get_service_list(tcxx::function<void(std::set<service_info>  const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id) = 0;
  ...
  virtual void verify_carrier(tcxx::function<void(bool const& _return)> cob, const std::string& carrier, const bool is_ssl) = 0;
  virtual void take_xray(tcxx::function<void(std::string const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */) = 0;
  virtual void take_xrays(tcxx::function<void(std::string const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */) = 0;
  virtual void create_mutex(tcxx::function<void(bool const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session, const int16_t timeout) = 0;
  virtual void delete_mutex(tcxx::function<void(bool const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session) = 0;
};
...
class common_serviceCobSvIfSingletonFactory : virtual public common_serviceCobSvIfFactory {
 public:
  common_serviceCobSvIfSingletonFactory(const boost::shared_ptr<common_serviceCobSvIf>& iface) : iface_(iface) {}
 ...
 protected:
  boost::shared_ptr<common_serviceCobSvIf> iface_;
};
...
class common_serviceCobClient : virtual public common_serviceCobClIf {
 public:
  common_serviceCobClient(boost::shared_ptr< ::apache::thrift::async::TAsyncChannel> channel, ::apache::thrift::protocol::TProtocolFactory* protocolFactory) :
    channel_(channel),
  ...
  void ping(tcxx::function<void(common_serviceCobClient* client)> cob);
  void send_ping();
  void recv_ping(service_info& _return);
  void get_host_detail(tcxx::function<void(common_serviceCobClient* client)> cob, const std::string& session_id, const machine_detail_filter::type filter);
  void send_get_host_detail(const std::string& session_id, const machine_detail_filter::type filter);
  void recv_get_host_detail(physical_machine_info& _return);
  void get_service_list(tcxx::function<void(common_serviceCobClient* client)> cob, const std::string& session_id);
  void send_get_service_list(const std::string& session_id);
  void recv_get_service_list(std::set<service_info> & _return);
  void enumerate_disks(tcxx::function<void(common_serviceCobClient* client)> cob, const enumerate_disk_filter_style::type filter);
  void send_enumerate_disks(const enumerate_disk_filter_style::type filter);
  void recv_enumerate_disks(std::set<disk_info> & _return);
  void verify_carrier(tcxx::function<void(common_serviceCobClient* client)> cob, const std::string& carrier, const bool is_ssl);
  void send_verify_carrier(const std::string& carrier, const bool is_ssl);
  bool recv_verify_carrier();
  void take_xray(tcxx::function<void(common_serviceCobClient* client)> cob);
  void send_take_xray();
  void recv_take_xray(std::string& _return);
  void take_xrays(tcxx::function<void(common_serviceCobClient* client)> cob);
  void send_take_xrays();
  void recv_take_xrays(std::string& _return);
  void create_mutex(tcxx::function<void(common_serviceCobClient* client)> cob, const std::string& session, const int16_t timeout);
  void send_create_mutex(const std::string& session, const int16_t timeout);
  bool recv_create_mutex();
  void delete_mutex(tcxx::function<void(common_serviceCobClient* client)> cob, const std::string& session);
  void send_delete_mutex(const std::string& session);
  bool recv_delete_mutex();
 protected:
...
class common_serviceAsyncProcessor : public ::apache::thrift::async::TAsyncDispatchProcessor {
 ...
 private:
  typedef  void (common_serviceAsyncProcessor::*ProcessFunction)(tcxx::function<void(bool ok)>, int32_t, ::apache::thrift::protocol::TProtocol*, ::apache::thrift::protocol::TProtocol*);
  typedef std::map<std::string, ProcessFunction> ProcessMap;
  ProcessMap processMap_;
  ...
  void process_get_host_detail(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_get_host_detail(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const physical_machine_info& _return);
  void throw_get_host_detail(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_get_service_list(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_get_service_list(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::set<service_info> & _return);
  void throw_get_service_list(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  ...
  void process_verify_carrier(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_verify_carrier(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return);
  void throw_verify_carrier(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_take_xray(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_take_xray(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::string& _return);
  void throw_take_xray(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_take_xrays(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_take_xrays(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::string& _return);
  void throw_take_xrays(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_create_mutex(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_create_mutex(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return);
  void throw_create_mutex(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_delete_mutex(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_delete_mutex(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return);
  void throw_delete_mutex(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
 public:
  common_serviceAsyncProcessor(boost::shared_ptr<common_serviceCobSvIf> iface) :
    iface_(iface) {
...
class common_serviceAsyncProcessorFactory : public ::apache::thrift::async::TAsyncProcessorFactory {
 public:
  common_serviceAsyncProcessorFactory(const ::boost::shared_ptr< common_serviceCobSvIfFactory >& handlerFactory) :
      handlerFactory_(handlerFactory) {}

  ::boost::shared_ptr< ::apache::thrift::async::TAsyncProcessor > getProcessor(const ::apache::thrift::TConnectionInfo& connInfo);

 protected:
  ::boost::shared_ptr< common_serviceCobSvIfFactory > handlerFactory_;
};
