...
class loader_serviceIfSingletonFactory : virtual public loader_serviceIfFactory {
 public:
  loader_serviceIfSingletonFactory(const boost::shared_ptr<loader_serviceIf>& iface) : iface_(iface) {}
 ...
 protected:
  boost::shared_ptr<loader_serviceIf> iface_;
};
...
class loader_serviceClient : virtual public loader_serviceIf, public common_connection_serviceClient {
 public:
  loader_serviceClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) :
    common_connection_serviceClient(prot, prot) {}
  loader_serviceClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, boost::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) :    common_connection_serviceClient(iprot, oprot) {}
...
class loader_serviceProcessor : public common_connection_serviceProcessor {
 ...
 public:
  loader_serviceProcessor(boost::shared_ptr<loader_serviceIf> iface) :
...
class loader_serviceProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  loader_serviceProcessorFactory(const ::boost::shared_ptr< loader_serviceIfFactory >& handlerFactory) :
      handlerFactory_(handlerFactory) {}

  ::boost::shared_ptr< ::apache::thrift::TProcessor > getProcessor(const ::apache::thrift::TConnectionInfo& connInfo);

 protected:
  ::boost::shared_ptr< loader_serviceIfFactory > handlerFactory_;
};

class loader_serviceMultiface : virtual public loader_serviceIf, public common_connection_serviceMultiface {
 public:
  loader_serviceMultiface(std::vector<boost::shared_ptr<loader_serviceIf> >& ifaces) : ifaces_(ifaces) {
    std::vector<boost::shared_ptr<loader_serviceIf> >::iterator iter;
 ...
 protected:
  std::vector<boost::shared_ptr<loader_serviceIf> > ifaces_;
  loader_serviceMultiface() {}
  void add(boost::shared_ptr<loader_serviceIf> iface) {
...
class loader_serviceConcurrentClient : virtual public loader_serviceIf, public common_connection_serviceConcurrentClient {
 public:
  loader_serviceConcurrentClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) :
    common_connection_serviceConcurrentClient(prot, prot) {}
  loader_serviceConcurrentClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, boost::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) :    common_connection_serviceConcurrentClient(iprot, oprot) {}
  boost::shared_ptr< ::apache::thrift::protocol::TProtocol> getInputProtocol() {
    return piprot_;
  }
  boost::shared_ptr< ::apache::thrift::protocol::TProtocol> getOutputProtocol() {
...
class loader_serviceCobClIf : virtual public common_connection_serviceCobClIf {
 public:
  ...
  virtual void create_job_ex(tcxx::function<void(loader_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id, const create_job_detail& create_job) = 0;
  virtual void create_job(tcxx::function<void(loader_serviceCobClient* client)> cob, const std::string& session_id, const create_job_detail& create_job) = 0;
  virtual void get_job(tcxx::function<void(loader_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id) = 0;
  virtual void interrupt_job(tcxx::function<void(loader_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id) = 0;
  virtual void resume_job(tcxx::function<void(loader_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id) = 0;
  virtual void remove_job(tcxx::function<void(loader_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id) = 0;
  virtual void list_jobs(tcxx::function<void(loader_serviceCobClient* client)> cob, const std::string& session_id) = 0;
  virtual void update_job(tcxx::function<void(loader_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id, const create_job_detail& job) = 0;
  virtual void terminate(tcxx::function<void(loader_serviceCobClient* client)> cob, const std::string& session_id) = 0;
  virtual void remove_snapshot_image(tcxx::function<void(loader_serviceCobClient* client)> cob, const std::string& session_id, const std::map<std::string, image_map_info> & images) = 0;
  virtual void running_job(tcxx::function<void(loader_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id) = 0;
  virtual void verify_management(tcxx::function<void(loader_serviceCobClient* client)> cob, const std::string& management, const int32_t port, const bool is_ssl) = 0;
  virtual void set_customized_id(tcxx::function<void(loader_serviceCobClient* client)> cob, const std::string& session_id, const std::string& disk_addr, const std::string& disk_id) = 0;
  virtual void create_vhd_disk_from_snapshot(tcxx::function<void(loader_serviceCobClient* client)> cob, const std::string& connection_string, const std::string& container, const std::string& original_disk_name, const std::string& target_disk_name, const std::string& snapshot) = 0;
  virtual void is_snapshot_vhd_disk_ready(tcxx::function<void(loader_serviceCobClient* client)> cob, const std::string& task_id) = 0;
  virtual void delete_vhd_disk(tcxx::function<void(loader_serviceCobClient* client)> cob, const std::string& connection_string, const std::string& container, const std::string& disk_name) = 0;
  virtual void delete_vhd_disk_snapshot(tcxx::function<void(loader_serviceCobClient* client)> cob, const std::string& connection_string, const std::string& container, const std::string& disk_name, const std::string& snapshot) = 0;
  virtual void get_vhd_disk_snapshots(tcxx::function<void(loader_serviceCobClient* client)> cob, const std::string& connection_string, const std::string& container, const std::string& disk_name) = 0;
  virtual void verify_connection_string(tcxx::function<void(loader_serviceCobClient* client)> cob, const std::string& connection_string) = 0;
};

class loader_serviceCobSvIf : virtual public common_connection_serviceCobSvIf {
 public:
  virtual ~loader_serviceCobSvIf() {}
  virtual void create_job_ex(tcxx::function<void(loader_job_detail const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& job_id, const create_job_detail& create_job) = 0;
  virtual void create_job(tcxx::function<void(loader_job_detail const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const create_job_detail& create_job) = 0;
  virtual void get_job(tcxx::function<void(loader_job_detail const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& job_id) = 0;
  ...
  virtual void list_jobs(tcxx::function<void(std::vector<loader_job_detail>  const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id) = 0;
  ...
  virtual void remove_snapshot_image(tcxx::function<void(bool const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::map<std::string, image_map_info> & images) = 0;
  ...
  virtual void set_customized_id(tcxx::function<void(bool const& _return)> cob, tcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& disk_addr, const std::string& disk_id) = 0;
...
class loader_serviceCobSvIfSingletonFactory : virtual public loader_serviceCobSvIfFactory {
 public:
  loader_serviceCobSvIfSingletonFactory(const boost::shared_ptr<loader_serviceCobSvIf>& iface) : iface_(iface) {}
 ...
 protected:
  boost::shared_ptr<loader_serviceCobSvIf> iface_;
};
...
class loader_serviceCobClient : virtual public loader_serviceCobClIf, public common_connection_serviceCobClient {
 public:
  loader_serviceCobClient(boost::shared_ptr< ::apache::thrift::async::TAsyncChannel> channel, ::apache::thrift::protocol::TProtocolFactory* protocolFactory) :
  ...
  void create_job_ex(tcxx::function<void(loader_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id, const create_job_detail& create_job);
  void send_create_job_ex(const std::string& session_id, const std::string& job_id, const create_job_detail& create_job);
  void recv_create_job_ex(loader_job_detail& _return);
  void create_job(tcxx::function<void(loader_serviceCobClient* client)> cob, const std::string& session_id, const create_job_detail& create_job);
  void send_create_job(const std::string& session_id, const create_job_detail& create_job);
  void recv_create_job(loader_job_detail& _return);
  void get_job(tcxx::function<void(loader_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id);
  void send_get_job(const std::string& session_id, const std::string& job_id);
  void recv_get_job(loader_job_detail& _return);
  void interrupt_job(tcxx::function<void(loader_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id);
  void send_interrupt_job(const std::string& session_id, const std::string& job_id);
  bool recv_interrupt_job();
  void resume_job(tcxx::function<void(loader_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id);
  void send_resume_job(const std::string& session_id, const std::string& job_id);
  bool recv_resume_job();
  void remove_job(tcxx::function<void(loader_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id);
  void send_remove_job(const std::string& session_id, const std::string& job_id);
  bool recv_remove_job();
  void list_jobs(tcxx::function<void(loader_serviceCobClient* client)> cob, const std::string& session_id);
  void send_list_jobs(const std::string& session_id);
  void recv_list_jobs(std::vector<loader_job_detail> & _return);
  void update_job(tcxx::function<void(loader_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id, const create_job_detail& job);
  void send_update_job(const std::string& session_id, const std::string& job_id, const create_job_detail& job);
  bool recv_update_job();
  void terminate(tcxx::function<void(loader_serviceCobClient* client)> cob, const std::string& session_id);
  void send_terminate(const std::string& session_id);
  void recv_terminate();
  void remove_snapshot_image(tcxx::function<void(loader_serviceCobClient* client)> cob, const std::string& session_id, const std::map<std::string, image_map_info> & images);
  void send_remove_snapshot_image(const std::string& session_id, const std::map<std::string, image_map_info> & images);
  bool recv_remove_snapshot_image();
  void running_job(tcxx::function<void(loader_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id);
  void send_running_job(const std::string& session_id, const std::string& job_id);
  bool recv_running_job();
  void verify_management(tcxx::function<void(loader_serviceCobClient* client)> cob, const std::string& management, const int32_t port, const bool is_ssl);
  void send_verify_management(const std::string& management, const int32_t port, const bool is_ssl);
  bool recv_verify_management();
  void set_customized_id(tcxx::function<void(loader_serviceCobClient* client)> cob, const std::string& session_id, const std::string& disk_addr, const std::string& disk_id);
  void send_set_customized_id(const std::string& session_id, const std::string& disk_addr, const std::string& disk_id);
  bool recv_set_customized_id();
  void create_vhd_disk_from_snapshot(tcxx::function<void(loader_serviceCobClient* client)> cob, const std::string& connection_string, const std::string& container, const std::string& original_disk_name, const std::string& target_disk_name, const std::string& snapshot);
  void send_create_vhd_disk_from_snapshot(const std::string& connection_string, const std::string& container, const std::string& original_disk_name, const std::string& target_disk_name, const std::string& snapshot);
  void recv_create_vhd_disk_from_snapshot(std::string& _return);
  void is_snapshot_vhd_disk_ready(tcxx::function<void(loader_serviceCobClient* client)> cob, const std::string& task_id);
  void send_is_snapshot_vhd_disk_ready(const std::string& task_id);
  bool recv_is_snapshot_vhd_disk_ready();
  void delete_vhd_disk(tcxx::function<void(loader_serviceCobClient* client)> cob, const std::string& connection_string, const std::string& container, const std::string& disk_name);
  void send_delete_vhd_disk(const std::string& connection_string, const std::string& container, const std::string& disk_name);
  bool recv_delete_vhd_disk();
  void delete_vhd_disk_snapshot(tcxx::function<void(loader_serviceCobClient* client)> cob, const std::string& connection_string, const std::string& container, const std::string& disk_name, const std::string& snapshot);
  void send_delete_vhd_disk_snapshot(const std::string& connection_string, const std::string& container, const std::string& disk_name, const std::string& snapshot);
  bool recv_delete_vhd_disk_snapshot();
  void get_vhd_disk_snapshots(tcxx::function<void(loader_serviceCobClient* client)> cob, const std::string& connection_string, const std::string& container, const std::string& disk_name);
  void send_get_vhd_disk_snapshots(const std::string& connection_string, const std::string& container, const std::string& disk_name);
  void recv_get_vhd_disk_snapshots(std::vector<vhd_snapshot> & _return);
  void verify_connection_string(tcxx::function<void(loader_serviceCobClient* client)> cob, const std::string& connection_string);
  void send_verify_connection_string(const std::string& connection_string);
  bool recv_verify_connection_string();
};
...
class loader_serviceAsyncProcessor : public common_connection_serviceAsyncProcessor {
 ...
 private:
  typedef  void (loader_serviceAsyncProcessor::*ProcessFunction)(tcxx::function<void(bool ok)>, int32_t, ::apache::thrift::protocol::TProtocol*, ::apache::thrift::protocol::TProtocol*);
  typedef std::map<std::string, ProcessFunction> ProcessMap;
  ProcessMap processMap_;
  ...
  void return_create_job_ex(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const loader_job_detail& _return);
  ...
  void return_create_job(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const loader_job_detail& _return);
  ...
  void return_get_job(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const loader_job_detail& _return);
  ...
  void return_list_jobs(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::vector<loader_job_detail> & _return);
  ...
  void process_remove_snapshot_image(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_remove_snapshot_image(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return);
  void throw_remove_snapshot_image(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  ...
  void process_set_customized_id(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_set_customized_id(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return);
  void throw_set_customized_id(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
 ...
 public:
  loader_serviceAsyncProcessor(boost::shared_ptr<loader_serviceCobSvIf> iface) :
...
class loader_serviceAsyncProcessorFactory : public ::apache::thrift::async::TAsyncProcessorFactory {
 public:
  loader_serviceAsyncProcessorFactory(const ::boost::shared_ptr< loader_serviceCobSvIfFactory >& handlerFactory) :
      handlerFactory_(handlerFactory) {}

  ::boost::shared_ptr< ::apache::thrift::async::TAsyncProcessor > getProcessor(const ::apache::thrift::TConnectionInfo& connInfo);

 protected:
  ::boost::shared_ptr< loader_serviceCobSvIfFactory > handlerFactory_;
};
