        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            this->images.clear();
            uint32_t _size1375;
            ::apache::thrift::protocol::TType _ktype1376;
            ::apache::thrift::protocol::TType _vtype1377;
            xfer += iprot->readMapBegin(_ktype1376, _vtype1377, _size1375);
            uint32_t _i1379;
            for (_i1379 = 0; _i1379 < _size1375; ++_i1379)
            {
              std::string _key1380;
              xfer += iprot->readString(_key1380);
              image_map_info& _val1381 = this->images[_key1380];
              xfer += _val1381.read(iprot);
            }
...
uint32_t service_proxy_remove_snapshot_image_p_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("images", ::apache::thrift::protocol::T_MAP, 2);
  {
    ...
    std::map<std::string, image_map_info> ::const_iterator _iter1382;
    for (_iter1382 = this->images.begin(); _iter1382 != this->images.end(); ++_iter1382)
    {
...
uint32_t service_proxy_remove_snapshot_image_p_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  {
    xfer += oprot->writeMapBegin(::apache::thrift::protocol::T_STRING, ::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>((*(this->images)).size()));
    std::map<std::string, image_map_info> ::const_iterator _iter1383;
    for (_iter1383 = (*(this->images)).begin(); _iter1383 != (*(this->images)).end(); ++_iter1383)
    {
...
uint32_t service_proxy_enumerate_connections_p_result::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.success) {
    xfer += oprot->writeFieldBegin("success", ::apache::thrift::protocol::T_LIST, 0);
    {
      ...
      std::vector<connection> ::const_iterator _iter1389;
...
uint32_t service_proxy_enumerate_connections_p_presult::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  {
    xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>((*(this->success)).size()));
    std::vector<connection> ::const_iterator _iter1395;
    ...
    switch (fid)
    {
      ...
      case 3:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->filter = (machine_detail_filter::type)ecast1396;
...
::boost::shared_ptr< ::apache::thrift::TProcessor > service_proxyProcessorFactory::getProcessor(const ::apache::thrift::TConnectionInfo& connInfo) {
  ::apache::thrift::ReleaseHandler< service_proxyIfFactory > cleanup(handlerFactory_);
  ::boost::shared_ptr< service_proxyIf > handler(handlerFactory_->getHandler(connInfo), cleanup);
  ::boost::shared_ptr< ::apache::thrift::TProcessor > processor(new service_proxyProcessor(handler));
  return processor;
}
...
void service_proxyCobClient::create_job_ex_p(tcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& job_id, const create_job_detail& create_job, const std::string& service_type)
{
  send_create_job_ex_p(session_id, job_id, create_job, service_type);
...
void service_proxyCobClient::get_job_p(tcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& job_id, const std::string& service_type)
{
  send_get_job_p(session_id, job_id, service_type);
  channel_->sendAndRecvMessage(tcxx::bind(cob, this), otrans_.get(), itrans_.get());
}
...
void service_proxyCobClient::interrupt_job_p(tcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& job_id, const std::string& service_type)
{
  send_interrupt_job_p(session_id, job_id, service_type);
  channel_->sendAndRecvMessage(tcxx::bind(cob, this), otrans_.get(), itrans_.get());
}
...
void service_proxyCobClient::resume_job_p(tcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& job_id, const std::string& service_type)
{
  send_resume_job_p(session_id, job_id, service_type);
  channel_->sendAndRecvMessage(tcxx::bind(cob, this), otrans_.get(), itrans_.get());
}
...
void service_proxyCobClient::remove_job_p(tcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& job_id, const std::string& service_type)
{
  send_remove_job_p(session_id, job_id, service_type);
  channel_->sendAndRecvMessage(tcxx::bind(cob, this), otrans_.get(), itrans_.get());
}
...
void service_proxyCobClient::running_job_p(tcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& job_id, const std::string& service_type)
{
  send_running_job_p(session_id, job_id, service_type);
  channel_->sendAndRecvMessage(tcxx::bind(cob, this), otrans_.get(), itrans_.get());
}
...
void service_proxyCobClient::update_job_p(tcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& job_id, const create_job_detail& create_job, const std::string& service_type)
{
  send_update_job_p(session_id, job_id, create_job, service_type);
  channel_->sendAndRecvMessage(tcxx::bind(cob, this), otrans_.get(), itrans_.get());
}
...
void service_proxyCobClient::remove_snapshot_image_p(tcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const std::map<std::string, image_map_info> & images, const std::string& service_type)
{
  send_remove_snapshot_image_p(session_id, images, service_type);
  channel_->sendAndRecvMessage(tcxx::bind(cob, this), otrans_.get(), itrans_.get());
}
...
void service_proxyCobClient::test_connection_p(tcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const connection& conn, const std::string& service_type)
{
  send_test_connection_p(session_id, conn, service_type);
  channel_->sendAndRecvMessage(tcxx::bind(cob, this), otrans_.get(), itrans_.get());
}
...
void service_proxyCobClient::add_connection_p(tcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const connection& conn, const std::string& service_type)
{
  send_add_connection_p(session_id, conn, service_type);
  channel_->sendAndRecvMessage(tcxx::bind(cob, this), otrans_.get(), itrans_.get());
}
...
void service_proxyCobClient::remove_connection_p(tcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& connection_id, const std::string& service_type)
{
  send_remove_connection_p(session_id, connection_id, service_type);
  channel_->sendAndRecvMessage(tcxx::bind(cob, this), otrans_.get(), itrans_.get());
}
...
void service_proxyCobClient::modify_connection_p(tcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const connection& conn, const std::string& service_type)
{
  send_modify_connection_p(session_id, conn, service_type);
  channel_->sendAndRecvMessage(tcxx::bind(cob, this), otrans_.get(), itrans_.get());
}
...
void service_proxyCobClient::enumerate_connections_p(tcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& service_type)
{
  send_enumerate_connections_p(session_id, service_type);
  channel_->sendAndRecvMessage(tcxx::bind(cob, this), otrans_.get(), itrans_.get());
}
...
void service_proxyCobClient::get_connection_p(tcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& connection_id, const std::string& service_type)
{
  send_get_connection_p(session_id, connection_id, service_type);
  channel_->sendAndRecvMessage(tcxx::bind(cob, this), otrans_.get(), itrans_.get());
}
...
void service_proxyCobClient::get_virtual_host_info_p(tcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password)
{
  send_get_virtual_host_info_p(session_id, host, username, password);
  channel_->sendAndRecvMessage(tcxx::bind(cob, this), otrans_.get(), itrans_.get());
}
...
void service_proxyCobClient::get_virtual_machine_detail_p(tcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id)
{
  send_get_virtual_machine_detail_p(session_id, host, username, password, machine_id);
  channel_->sendAndRecvMessage(tcxx::bind(cob, this), otrans_.get(), itrans_.get());
}
...
void service_proxyCobClient::get_physical_machine_detail_p(tcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& host, const machine_detail_filter::type filter)
{
  send_get_physical_machine_detail_p(session_id, host, filter);
  channel_->sendAndRecvMessage(tcxx::bind(cob, this), otrans_.get(), itrans_.get());
}
...
void service_proxyCobClient::verify_packer_to_carrier_p(tcxx::function<void(service_proxyCobClient* client)> cob, const std::string& packer, const std::string& carrier, const int32_t port, const bool is_ssl)
{
  send_verify_packer_to_carrier_p(packer, carrier, port, is_ssl);
  channel_->sendAndRecvMessage(tcxx::bind(cob, this), otrans_.get(), itrans_.get());
}
...
void service_proxyCobClient::take_packer_xray_p(tcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& host)
{
  send_take_packer_xray_p(session_id, host);
  channel_->sendAndRecvMessage(tcxx::bind(cob, this), otrans_.get(), itrans_.get());
}
...
void service_proxyCobClient::get_packer_service_info_p(tcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& host)
{
  send_get_packer_service_info_p(session_id, host);
  channel_->sendAndRecvMessage(tcxx::bind(cob, this), otrans_.get(), itrans_.get());
}
...
void service_proxyCobClient::set_customized_id_p(tcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& disk_addr, const std::string& disk_id)
{
  send_set_customized_id_p(session_id, disk_addr, disk_id);
  channel_->sendAndRecvMessage(tcxx::bind(cob, this), otrans_.get(), itrans_.get());
}
...
void service_proxyAsyncProcessor::dispatchCall(tcxx::function<void(bool ok)> cob, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, const std::string& fname, int32_t seqid) {
  ProcessMap::iterator pfn;
  pfn = processMap_.find(fname);
  if (pfn == processMap_.end()) {
...
void service_proxyAsyncProcessor::process_create_job_ex_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  service_proxy_create_job_ex_p_args args;
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
  ...
  freer.unregister();
  void (service_proxyAsyncProcessor::*return_fn)(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const job_detail& _return) =
    &service_proxyAsyncProcessor::return_create_job_ex_p;
  void (service_proxyAsyncProcessor::*throw_fn)(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw) =
...
void service_proxyAsyncProcessor::return_create_job_ex_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const job_detail& _return)
{
  service_proxy_create_job_ex_p_presult result;
...
void service_proxyAsyncProcessor::throw_create_job_ex_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw)
{
...
void service_proxyAsyncProcessor::process_get_job_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  service_proxy_get_job_p_args args;
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
...
void service_proxyAsyncProcessor::return_get_job_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const job_detail& _return)
{
  service_proxy_get_job_p_presult result;
  result.success = const_cast<job_detail*>(&_return);
  result.__isset.success = true;
...
void service_proxyAsyncProcessor::throw_get_job_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw)
{
...
void service_proxyAsyncProcessor::process_interrupt_job_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  service_proxy_interrupt_job_p_args args;
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
  ...
  freer.unregister();
  void (service_proxyAsyncProcessor::*return_fn)(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return) =
...
void service_proxyAsyncProcessor::return_interrupt_job_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return)
{
  service_proxy_interrupt_job_p_presult result;
...
void service_proxyAsyncProcessor::throw_interrupt_job_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw)
{
...
void service_proxyAsyncProcessor::process_resume_job_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  service_proxy_resume_job_p_args args;
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
...
void service_proxyAsyncProcessor::return_resume_job_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return)
{
  service_proxy_resume_job_p_presult result;
  result.success = const_cast<bool*>(&_return);
  result.__isset.success = true;
...
void service_proxyAsyncProcessor::throw_resume_job_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw)
{
...
void service_proxyAsyncProcessor::process_remove_job_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  service_proxy_remove_job_p_args args;
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
...
void service_proxyAsyncProcessor::return_remove_job_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return)
{
  service_proxy_remove_job_p_presult result;
  result.success = const_cast<bool*>(&_return);
  result.__isset.success = true;
...
void service_proxyAsyncProcessor::throw_remove_job_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw)
{
...
void service_proxyAsyncProcessor::process_running_job_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  service_proxy_running_job_p_args args;
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
...
void service_proxyAsyncProcessor::return_running_job_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return)
{
  service_proxy_running_job_p_presult result;
  result.success = const_cast<bool*>(&_return);
  result.__isset.success = true;
...
void service_proxyAsyncProcessor::throw_running_job_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw)
{
...
void service_proxyAsyncProcessor::process_update_job_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  service_proxy_update_job_p_args args;
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
...
void service_proxyAsyncProcessor::return_update_job_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return)
{
  service_proxy_update_job_p_presult result;
  result.success = const_cast<bool*>(&_return);
  result.__isset.success = true;
...
void service_proxyAsyncProcessor::throw_update_job_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw)
{
...
void service_proxyAsyncProcessor::process_remove_snapshot_image_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  service_proxy_remove_snapshot_image_p_args args;
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
...
void service_proxyAsyncProcessor::return_remove_snapshot_image_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return)
{
  service_proxy_remove_snapshot_image_p_presult result;
  result.success = const_cast<bool*>(&_return);
  result.__isset.success = true;
...
void service_proxyAsyncProcessor::throw_remove_snapshot_image_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw)
{
...
void service_proxyAsyncProcessor::process_test_connection_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  service_proxy_test_connection_p_args args;
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
...
void service_proxyAsyncProcessor::return_test_connection_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return)
{
  service_proxy_test_connection_p_presult result;
  result.success = const_cast<bool*>(&_return);
  result.__isset.success = true;
...
void service_proxyAsyncProcessor::throw_test_connection_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw)
{
...
void service_proxyAsyncProcessor::process_add_connection_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  service_proxy_add_connection_p_args args;
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
...
void service_proxyAsyncProcessor::return_add_connection_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return)
{
  service_proxy_add_connection_p_presult result;
  result.success = const_cast<bool*>(&_return);
  result.__isset.success = true;
...
void service_proxyAsyncProcessor::throw_add_connection_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw)
{
...
void service_proxyAsyncProcessor::process_remove_connection_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  service_proxy_remove_connection_p_args args;
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
...
void service_proxyAsyncProcessor::return_remove_connection_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return)
{
  service_proxy_remove_connection_p_presult result;
  result.success = const_cast<bool*>(&_return);
  result.__isset.success = true;
...
void service_proxyAsyncProcessor::throw_remove_connection_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw)
{
...
void service_proxyAsyncProcessor::process_modify_connection_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  service_proxy_modify_connection_p_args args;
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
...
void service_proxyAsyncProcessor::return_modify_connection_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return)
{
  service_proxy_modify_connection_p_presult result;
  result.success = const_cast<bool*>(&_return);
  result.__isset.success = true;
...
void service_proxyAsyncProcessor::throw_modify_connection_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw)
{
...
void service_proxyAsyncProcessor::process_enumerate_connections_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  service_proxy_enumerate_connections_p_args args;
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
  ...
  freer.unregister();
  void (service_proxyAsyncProcessor::*return_fn)(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::vector<connection> & _return) =
...
void service_proxyAsyncProcessor::return_enumerate_connections_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::vector<connection> & _return)
{
  service_proxy_enumerate_connections_p_presult result;
...
void service_proxyAsyncProcessor::throw_enumerate_connections_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw)
{
...
void service_proxyAsyncProcessor::process_get_connection_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  service_proxy_get_connection_p_args args;
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
  ...
  freer.unregister();
  void (service_proxyAsyncProcessor::*return_fn)(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const connection& _return) =
...
void service_proxyAsyncProcessor::return_get_connection_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const connection& _return)
{
  service_proxy_get_connection_p_presult result;
...
void service_proxyAsyncProcessor::throw_get_connection_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw)
{
...
void service_proxyAsyncProcessor::process_get_virtual_host_info_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  service_proxy_get_virtual_host_info_p_args args;
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
  ...
  freer.unregister();
  void (service_proxyAsyncProcessor::*return_fn)(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const virtual_host& _return) =
...
void service_proxyAsyncProcessor::return_get_virtual_host_info_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const virtual_host& _return)
{
  service_proxy_get_virtual_host_info_p_presult result;
...
void service_proxyAsyncProcessor::throw_get_virtual_host_info_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw)
{
...
void service_proxyAsyncProcessor::process_get_virtual_machine_detail_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  service_proxy_get_virtual_machine_detail_p_args args;
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
  ...
  freer.unregister();
  void (service_proxyAsyncProcessor::*return_fn)(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const virtual_machine& _return) =
...
void service_proxyAsyncProcessor::return_get_virtual_machine_detail_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const virtual_machine& _return)
{
  service_proxy_get_virtual_machine_detail_p_presult result;
...
void service_proxyAsyncProcessor::throw_get_virtual_machine_detail_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw)
{
...
void service_proxyAsyncProcessor::process_get_physical_machine_detail_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  service_proxy_get_physical_machine_detail_p_args args;
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
  ...
  freer.unregister();
  void (service_proxyAsyncProcessor::*return_fn)(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const physical_machine_info& _return) =
...
void service_proxyAsyncProcessor::return_get_physical_machine_detail_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const physical_machine_info& _return)
{
  service_proxy_get_physical_machine_detail_p_presult result;
...
void service_proxyAsyncProcessor::throw_get_physical_machine_detail_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw)
{
...
void service_proxyAsyncProcessor::process_verify_packer_to_carrier_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  service_proxy_verify_packer_to_carrier_p_args args;
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
...
void service_proxyAsyncProcessor::return_verify_packer_to_carrier_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return)
{
  service_proxy_verify_packer_to_carrier_p_presult result;
  result.success = const_cast<bool*>(&_return);
  result.__isset.success = true;
...
void service_proxyAsyncProcessor::process_take_packer_xray_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  service_proxy_take_packer_xray_p_args args;
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
  ...
  freer.unregister();
  void (service_proxyAsyncProcessor::*return_fn)(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::string& _return) =
...
void service_proxyAsyncProcessor::return_take_packer_xray_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::string& _return)
{
  service_proxy_take_packer_xray_p_presult result;
...
void service_proxyAsyncProcessor::throw_take_packer_xray_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw)
{
...
void service_proxyAsyncProcessor::process_get_packer_service_info_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  service_proxy_get_packer_service_info_p_args args;
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
  ...
  freer.unregister();
  void (service_proxyAsyncProcessor::*return_fn)(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const service_info& _return) =
...
void service_proxyAsyncProcessor::return_get_packer_service_info_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const service_info& _return)
{
  service_proxy_get_packer_service_info_p_presult result;
...
void service_proxyAsyncProcessor::throw_get_packer_service_info_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw)
{
...
void service_proxyAsyncProcessor::process_set_customized_id_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  service_proxy_set_customized_id_p_args args;
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
...
void service_proxyAsyncProcessor::return_set_customized_id_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return)
{
  service_proxy_set_customized_id_p_presult result;
  result.success = const_cast<bool*>(&_return);
  result.__isset.success = true;
...
void service_proxyAsyncProcessor::throw_set_customized_id_p(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw)
{
...
::boost::shared_ptr< ::apache::thrift::async::TAsyncProcessor > service_proxyAsyncProcessorFactory::getProcessor(const ::apache::thrift::TConnectionInfo& connInfo) {
  ::apache::thrift::ReleaseHandler< service_proxyCobSvIfFactory > cleanup(handlerFactory_);
  ::boost::shared_ptr< service_proxyCobSvIf > handler(handlerFactory_->getHandler(connInfo), cleanup);
  ::boost::shared_ptr< ::apache::thrift::async::TAsyncProcessor > processor(new service_proxyAsyncProcessor(handler));
  return processor;
}
