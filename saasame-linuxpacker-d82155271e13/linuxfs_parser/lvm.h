...
public:
    ...
    linuxfs::io_range::map get_system_ranges();
...
public:
    ...
    linuxfs::io_range::map get_ranges_mapper(const linuxfs::io_range::vtr &ranges);
private:
    linuxfs::io_range::map mapper(__in uint64_t start, __in uint64_t length);
