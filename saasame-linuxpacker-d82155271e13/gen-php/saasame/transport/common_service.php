      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::SET) {
            ...
            $_size1037 = 0;
            $_etype1040 = 0;
            $xfer += $input->readSetBegin($_etype1040, $_size1037);
            for ($_i1041 = 0; $_i1041 < $_size1037; ++$_i1041)
            {
              $elem1042 = null;
              $elem1042 = new \saasame\transport\service_info();
              $xfer += $elem1042->read($input);
              if (is_scalar($elem1042)) {
                $this->success[$elem1042] = true;
              } else {
  ...
  public function write($output) {
    ...
    if ($this->success !== null) {
      ...
      $xfer += $output->writeFieldBegin('success', TType::SET, 0);
      {
        ...
        {
          foreach ($this->success as $iter1043 => $iter1044)
          {
            if (is_scalar($iter1044)) {
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::SET) {
            ...
            $_size1045 = 0;
            $_etype1048 = 0;
            $xfer += $input->readSetBegin($_etype1048, $_size1045);
            for ($_i1049 = 0; $_i1049 < $_size1045; ++$_i1049)
            {
              $elem1050 = null;
              $elem1050 = new \saasame\transport\disk_info();
              $xfer += $elem1050->read($input);
              if (is_scalar($elem1050)) {
                $this->success[$elem1050] = true;
              } else {
  ...
  public function write($output) {
    ...
    if ($this->success !== null) {
      ...
      $xfer += $output->writeFieldBegin('success', TType::SET, 0);
      {
        $output->writeSetBegin(TType::STRUCT, count($this->success));
        {
          foreach ($this->success as $iter1051 => $iter1052)
          {
