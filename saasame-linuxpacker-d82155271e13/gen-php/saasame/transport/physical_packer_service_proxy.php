      ...
      switch ($fid)
      {
        ...
        case 3:
          if ($ftype == TType::SET) {
            ...
            $_size1191 = 0;
            $_etype1194 = 0;
            $xfer += $input->readSetBegin($_etype1194, $_size1191);
            for ($_i1195 = 0; $_i1195 < $_size1191; ++$_i1195)
            {
              $elem1196 = null;
              $xfer += $input->readString($elem1196);
              if (is_scalar($elem1196)) {
                $this->disks[$elem1196] = true;
              } else {
                $this->disks []= $elem1196;
              }
            }
  ...
  public function write($output) {
    ...
    if ($this->disks !== null) {
      ...
      $xfer += $output->writeFieldBegin('disks', TType::SET, 3);
      {
        ...
        {
          foreach ($this->disks as $iter1197 => $iter1198)
          {
            if (is_scalar($iter1198)) {
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::LST) {
            ...
            {
              $elem1204 = null;
              $elem1204 = new \saasame\transport\snapshot();
      ...
      switch ($fid)
      {
        ...
        case 3:
          if ($ftype == TType::SET) {
            ...
            $_size1206 = 0;
            $_etype1209 = 0;
            $xfer += $input->readSetBegin($_etype1209, $_size1206);
            for ($_i1210 = 0; $_i1210 < $_size1206; ++$_i1210)
            {
              $elem1211 = null;
              $xfer += $input->readString($elem1211);
              if (is_scalar($elem1211)) {
                $this->disks[$elem1211] = true;
              } else {
                $this->disks []= $elem1211;
              }
            }
  ...
  public function write($output) {
    ...
    if ($this->disks !== null) {
      ...
      $xfer += $output->writeFieldBegin('disks', TType::SET, 3);
      {
        $output->writeSetBegin(TType::STRING, count($this->disks));
        {
          foreach ($this->disks as $iter1212 => $iter1213)
          {
            if (is_scalar($iter1213)) {
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::LST) {
            ...
            {
              $elem1219 = null;
              $elem1219 = new \saasame\transport\snapshot();
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::MAP) {
            ...
            $_ktype1222 = 0;
            $_vtype1223 = 0;
            $xfer += $input->readMapBegin($_ktype1222, $_vtype1223, $_size1221);
            for ($_i1225 = 0; $_i1225 < $_size1221; ++$_i1225)
            {
              $key1226 = '';
              $val1227 = array();
              $xfer += $input->readString($key1226);
              $val1227 = array();
              $_size1228 = 0;
              $_etype1231 = 0;
              ...
              {
                $elem1233 = null;
                $elem1233 = new \saasame\transport\snapshot();
                $xfer += $elem1233->read($input);
                $val1227 []= $elem1233;
              }
              $xfer += $input->readListEnd();
              $this->success[$key1226] = $val1227;
            }
      ...
      $xfer += $output->writeFieldBegin('success', TType::MAP, 0);
      {
        $output->writeMapBegin(TType::STRING, TType::LST, count($this->success));
        {
          foreach ($this->success as $kiter1234 => $viter1235)
          {
            ...
            {
              $output->writeListBegin(TType::STRUCT, count($viter1235));
              {
                foreach ($viter1235 as $iter1236)
                {
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::SET) {
            ...
            {
              $elem1242 = null;
              $elem1242 = new \saasame\transport\disk_info();
              $xfer += $elem1242->read($input);
              if (is_scalar($elem1242)) {
                $this->success[$elem1242] = true;
              } else {
  ...
  public function write($output) {
    ...
    if ($this->success !== null) {
      ...
      $xfer += $output->writeFieldBegin('success', TType::SET, 0);
      {
        ...
        {
          foreach ($this->success as $iter1243 => $iter1244)
          {
            if (is_scalar($iter1244)) {
