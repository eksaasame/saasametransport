      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::LST) {
            ...
            {
              $elem1173 = null;
              $elem1173 = new \saasame\transport\loader_job_detail();
      ...
      switch ($fid)
      {
        ...
        case 2:
          if ($ftype == TType::MAP) {
            ...
            {
              $key1180 = '';
              $val1181 = new \saasame\transport\image_map_info();
              $xfer += $input->readString($key1180);
              $val1181 = new \saasame\transport\image_map_info();
              $xfer += $val1181->read($input);
              $this->images[$key1180] = $val1181;
            }
  ...
  public function write($output) {
    ...
    if ($this->images !== null) {
      ...
      $xfer += $output->writeFieldBegin('images', TType::MAP, 2);
      {
        ...
        {
          foreach ($this->images as $kiter1182 => $viter1183)
          {
            $xfer += $output->writeString($kiter1182);
            $xfer += $viter1183->write($output);
          }
        }
        $output->writeMapEnd();
      }
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::LST) {
            ...
            {
              $elem1189 = null;
              $elem1189 = new \saasame\transport\vhd_snapshot();
              $xfer += $elem1189->read($input);
              $this->success []= $elem1189;
            }
            $xfer += $input->readListEnd();
          } else {
            $xfer += $input->skip($ftype);
  ...
  public function write($output) {
    ...
    if ($this->success !== null) {
      ...
      $xfer += $output->writeFieldBegin('success', TType::LST, 0);
      {
        $output->writeListBegin(TType::STRUCT, count($this->success));
        {
          foreach ($this->success as $iter1190)
          {
