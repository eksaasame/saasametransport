...
#define __bitwise__
#endif
#define xfs__bitwise __bitwise__

typedef __u16 xfs__bitwise __le16;
typedef __u16 xfs__bitwise __be16;
typedef __u32 xfs__bitwise __le32;
typedef __u32 xfs__bitwise __be32;
namespace xfsdt
{
    typedef xfsdt::__u64 xfs__bitwise __le64;
    typedef xfsdt::__u64 xfs__bitwise __be64;
}
...
typedef struct xfs_dsb {
    ...
    xfsdt::__be64		sb_dblocks;	/* number of data blocks */
    xfsdt::__be64		sb_rblocks;	/* number of realtime blocks */
    xfsdt::__be64		sb_rextents;	/* number of realtime extents */
    uuid_t		sb_uuid;	/* user-visible file system unique id */
    xfsdt::__be64		sb_logstart;	/* starting block of log if internal */
    xfsdt::__be64		sb_rootino;	/* root inode number */
    xfsdt::__be64		sb_rbmino;	/* bitmap inode for realtime extents */
    xfsdt::__be64		sb_rsumino;	/* summary inode for rt bitmap */
    ...
    */
    xfsdt::__be64		sb_icount;	/* allocated inodes */
    xfsdt::__be64		sb_ifree;	/* free inodes */
    xfsdt::__be64		sb_fdblocks;	/* free data blocks */
    xfsdt::__be64		sb_frextents;	/* free realtime extents */
    /*
    * End contiguous fields.
    */
    xfsdt::__be64		sb_uquotino;	/* user quota inode */
    xfsdt::__be64		sb_gquotino;	/* group quota inode */
    ...
    */
    ...
    xfsdt::__be64		sb_pquotino;	/* project quota inode */
    xfsdt::__be64		sb_lsn;		/* last write sequence */
...
typedef struct xfs_agf {
    ...
    */
    xfsdt::__be64		agf_spare64[14];

    /* unlogged fields, written during buffer writeback. */
    xfsdt::__be64		agf_lsn;	/* last write sequence */
...
typedef struct xfs_agi {
    ...
    */
    ...
    __be32		agi_pad32;
    xfsdt::__be64		agi_lsn;	/* last write sequence */
...
struct xfs_btree_block_lhdr {
    xfsdt::__be64		bb_leftsib;
    xfsdt::__be64		bb_rightsib;

    xfsdt::__be64		bb_blkno;
    xfsdt::__be64		bb_lsn;
    uuid_t		bb_uuid;
    xfsdt::__be64		bb_owner;
    __le32		bb_crc;
...
private:
    xfs_volume(universal_disk_rw::ptr &_rw, ULONGLONG _offset, ULONGLONG _size) : volume(_rw, _offset, _size, VOLUME_TYPE_XFS){
