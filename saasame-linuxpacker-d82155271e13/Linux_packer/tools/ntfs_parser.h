...
#define	MASK_ALL					((DWORD)-1)
    ...
    public:
        ...
        file_record::ptr   find_sub_entry(const std::string file_name, const file_record::ptr dir = NULL );
    ...
    private:
        bool visit_index_block(const file_record::ptr dir, const ULONGLONG vcn, const std::string& file_name, ULONGLONG &fileRef);
