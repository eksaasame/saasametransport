        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            for (_i1566 = 0; _i1566 < _size1562; ++_i1566)
            {
              ...
              image_map_info& _val1568 = this->images[_key1567];
              xfer += _val1568.read(iprot);
            }
...
uint32_t service_proxy_remove_snapshot_image_p_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("images", ::apache::thrift::protocol::T_MAP, 2);
  {
    ...
    std::map<std::string, image_map_info> ::const_iterator _iter1569;
    for (_iter1569 = this->images.begin(); _iter1569 != this->images.end(); ++_iter1569)
    {
      xfer += oprot->writeString(_iter1569->first);
      xfer += _iter1569->second.write(oprot);
    }
...
uint32_t service_proxy_remove_snapshot_image_p_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  {
    xfer += oprot->writeMapBegin(::apache::thrift::protocol::T_STRING, ::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>((*(this->images)).size()));
    std::map<std::string, image_map_info> ::const_iterator _iter1570;
    for (_iter1570 = (*(this->images)).begin(); _iter1570 != (*(this->images)).end(); ++_iter1570)
    {
      xfer += oprot->writeString(_iter1570->first);
      xfer += _iter1570->second.write(oprot);
    }
    xfer += oprot->writeMapEnd();
  }
  xfer += oprot->writeFieldEnd();
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->success.resize(_size1571);
            uint32_t _i1575;
            for (_i1575 = 0; _i1575 < _size1571; ++_i1575)
            {
              xfer += this->success[_i1575].read(iprot);
            }
...
uint32_t service_proxy_enumerate_connections_p_result::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.success) {
    xfer += oprot->writeFieldBegin("success", ::apache::thrift::protocol::T_LIST, 0);
    {
      ...
      std::vector<connection> ::const_iterator _iter1576;
      for (_iter1576 = this->success.begin(); _iter1576 != this->success.end(); ++_iter1576)
      {
        xfer += (*_iter1576).write(oprot);
      }
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            {
              xfer += (*(this->success))[_i1581].read(iprot);
            }
            xfer += iprot->readListEnd();
          }
          this->__isset.success = true;
...
uint32_t service_proxy_enumerate_connections_p_presult::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  {
    xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>((*(this->success)).size()));
    std::vector<connection> ::const_iterator _iter1582;
...
uint32_t service_proxy_get_virtual_hosts_p_result::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.success) {
    ...
    {
      xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->success.size()));
      std::vector<virtual_host> ::const_iterator _iter1588;
...
uint32_t service_proxy_get_virtual_hosts_p_presult::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  {
    xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>((*(this->success)).size()));
    std::vector<virtual_host> ::const_iterator _iter1594;
    for (_iter1594 = (*(this->success)).begin(); _iter1594 != (*(this->success)).end(); ++_iter1594)
    {
      xfer += (*_iter1594).write(oprot);
    }
    xfer += oprot->writeListEnd();
  }
  xfer += oprot->writeFieldEnd();
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->success.resize(_size1595);
            uint32_t _i1599;
            for (_i1599 = 0; _i1599 < _size1595; ++_i1599)
            {
              xfer += this->success[_i1599].read(iprot);
            }
            xfer += iprot->readListEnd();
          }
          this->__isset.success = true;
...
uint32_t service_proxy_get_virtual_machine_snapshots_p_result::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.success) {
    ...
    {
      xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->success.size()));
      std::vector<vmware_snapshot> ::const_iterator _iter1600;
      for (_iter1600 = this->success.begin(); _iter1600 != this->success.end(); ++_iter1600)
      {
        xfer += (*_iter1600).write(oprot);
      }
      xfer += oprot->writeListEnd();
    }
    xfer += oprot->writeFieldEnd();
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            (*(this->success)).resize(_size1601);
            uint32_t _i1605;
            for (_i1605 = 0; _i1605 < _size1601; ++_i1605)
            {
              xfer += (*(this->success))[_i1605].read(iprot);
            }
            xfer += iprot->readListEnd();
          }
          this->__isset.success = true;
...
uint32_t service_proxy_get_virtual_machine_snapshots_p_presult::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  {
    xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>((*(this->success)).size()));
    std::vector<vmware_snapshot> ::const_iterator _iter1606;
    for (_iter1606 = (*(this->success)).begin(); _iter1606 != (*(this->success)).end(); ++_iter1606)
    {
      xfer += (*_iter1606).write(oprot);
    }
    xfer += oprot->writeListEnd();
  }
  xfer += oprot->writeFieldEnd();
    ...
    switch (fid)
    {
      ...
      case 3:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          int32_t ecast1607;
          xfer += iprot->readI32(ecast1607);
          this->filter = (machine_detail_filter::type)ecast1607;
...
uint32_t service_proxy_get_datacenter_folder_list_p_presult::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  {
    xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRING, static_cast<uint32_t>((*(this->success)).size()));
    std::vector<std::string> ::const_iterator _iter1619;
    for (_iter1619 = (*(this->success)).begin(); _iter1619 != (*(this->success)).end(); ++_iter1619)
    {
      xfer += oprot->writeString((*_iter1619));
    }
    xfer += oprot->writeListEnd();
  }
  xfer += oprot->writeFieldEnd();
