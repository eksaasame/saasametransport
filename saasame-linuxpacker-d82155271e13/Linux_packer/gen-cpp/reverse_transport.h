...
class reverse_transportIfSingletonFactory : virtual public reverse_transportIfFactory {
 public:
  reverse_transportIfSingletonFactory(const ::apache::thrift::stdcxx::shared_ptr<reverse_transportIf>& iface) : iface_(iface) {}
 ...
 protected:
  ::apache::thrift::stdcxx::shared_ptr<reverse_transportIf> iface_;
};
...
class reverse_transportClient : virtual public reverse_transportIf {
 public:
  reverse_transportClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  reverse_transportClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
...
class reverse_transportProcessor : public ::apache::thrift::TDispatchProcessor {
 ...
 public:
  reverse_transportProcessor(::apache::thrift::stdcxx::shared_ptr<reverse_transportIf> iface) :
    iface_(iface) {
...
class reverse_transportProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  reverse_transportProcessorFactory(const ::apache::thrift::stdcxx::shared_ptr< reverse_transportIfFactory >& handlerFactory) :
      handlerFactory_(handlerFactory) {}

  ::apache::thrift::stdcxx::shared_ptr< ::apache::thrift::TProcessor > getProcessor(const ::apache::thrift::TConnectionInfo& connInfo);

 protected:
  ::apache::thrift::stdcxx::shared_ptr< reverse_transportIfFactory > handlerFactory_;
};

class reverse_transportMultiface : virtual public reverse_transportIf {
 public:
  reverse_transportMultiface(std::vector<apache::thrift::stdcxx::shared_ptr<reverse_transportIf> >& ifaces) : ifaces_(ifaces) {
  }
  virtual ~reverse_transportMultiface() {}
 protected:
  std::vector<apache::thrift::stdcxx::shared_ptr<reverse_transportIf> > ifaces_;
  reverse_transportMultiface() {}
  void add(::apache::thrift::stdcxx::shared_ptr<reverse_transportIf> iface) {
...
class reverse_transportConcurrentClient : virtual public reverse_transportIf {
 public:
  reverse_transportConcurrentClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  reverse_transportConcurrentClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
    setProtocol(iprot,oprot);
  }
 private:
  void setProtocol(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
...
class reverse_transportCobClIf {
 public:
  ...
  virtual void ping(::apache::thrift::stdcxx::function<void(reverse_transportCobClient* client)> cob) = 0;
  virtual void generate_session(::apache::thrift::stdcxx::function<void(reverse_transportCobClient* client)> cob, const std::string& addr) = 0;
  virtual void receive(::apache::thrift::stdcxx::function<void(reverse_transportCobClient* client)> cob, const std::string& session, const std::string& addr, const std::string& name) = 0;
  virtual void response(::apache::thrift::stdcxx::function<void(reverse_transportCobClient* client)> cob, const std::string& session, const std::string& addr, const transport_message& response) = 0;
};
...
class reverse_transportCobSvIf {
 public:
  ...
  virtual void receive(::apache::thrift::stdcxx::function<void(transport_message const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session, const std::string& addr, const std::string& name) = 0;
  virtual void response(::apache::thrift::stdcxx::function<void(bool const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session, const std::string& addr, const transport_message& response) = 0;
};
...
class reverse_transportCobSvIfSingletonFactory : virtual public reverse_transportCobSvIfFactory {
 public:
  reverse_transportCobSvIfSingletonFactory(const ::apache::thrift::stdcxx::shared_ptr<reverse_transportCobSvIf>& iface) : iface_(iface) {}
 ...
 protected:
  ::apache::thrift::stdcxx::shared_ptr<reverse_transportCobSvIf> iface_;
};
...
class reverse_transportCobSvNull : virtual public reverse_transportCobSvIf {
 public:
  ...
  void receive(::apache::thrift::stdcxx::function<void(transport_message const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& /* session */, const std::string& /* addr */, const std::string& /* name */) {
    transport_message _return;
    return cob(_return);
  }
  void response(::apache::thrift::stdcxx::function<void(bool const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& /* session */, const std::string& /* addr */, const transport_message& /* response */) {
    bool _return = false;
    return cob(_return);
  }
};
...
class reverse_transportCobClient : virtual public reverse_transportCobClIf {
 public:
  reverse_transportCobClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::async::TAsyncChannel> channel, ::apache::thrift::protocol::TProtocolFactory* protocolFactory) :
    channel_(channel),
  ...
  void ping(::apache::thrift::stdcxx::function<void(reverse_transportCobClient* client)> cob);
  void send_ping();
  void recv_ping(service_info& _return);
  void generate_session(::apache::thrift::stdcxx::function<void(reverse_transportCobClient* client)> cob, const std::string& addr);
  void send_generate_session(const std::string& addr);
  void recv_generate_session(std::string& _return);
  void receive(::apache::thrift::stdcxx::function<void(reverse_transportCobClient* client)> cob, const std::string& session, const std::string& addr, const std::string& name);
  void send_receive(const std::string& session, const std::string& addr, const std::string& name);
  void recv_receive(transport_message& _return);
  void response(::apache::thrift::stdcxx::function<void(reverse_transportCobClient* client)> cob, const std::string& session, const std::string& addr, const transport_message& response);
  void send_response(const std::string& session, const std::string& addr, const transport_message& response);
  bool recv_response();
 protected:
...
class reverse_transportAsyncProcessor : public ::apache::thrift::async::TAsyncDispatchProcessor {
 ...
 private:
  typedef  void (reverse_transportAsyncProcessor::*ProcessFunction)(::apache::thrift::stdcxx::function<void(bool ok)>, int32_t, ::apache::thrift::protocol::TProtocol*, ::apache::thrift::protocol::TProtocol*);
  typedef std::map<std::string, ProcessFunction> ProcessMap;
  ProcessMap processMap_;
  ...
  void process_receive(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_receive(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const transport_message& _return);
  void throw_receive(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_response(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_response(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return);
  void throw_response(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
 public:
  reverse_transportAsyncProcessor(::apache::thrift::stdcxx::shared_ptr<reverse_transportCobSvIf> iface) :
    iface_(iface) {
...
class reverse_transportAsyncProcessorFactory : public ::apache::thrift::async::TAsyncProcessorFactory {
 public:
  reverse_transportAsyncProcessorFactory(const ::apache::thrift::stdcxx::shared_ptr< reverse_transportCobSvIfFactory >& handlerFactory) :
      handlerFactory_(handlerFactory) {}
 ...
 protected:
  ::apache::thrift::stdcxx::shared_ptr< reverse_transportCobSvIfFactory > handlerFactory_;
};
