...
class scheduler_serviceIfSingletonFactory : virtual public scheduler_serviceIfFactory {
 public:
  scheduler_serviceIfSingletonFactory(const ::apache::thrift::stdcxx::shared_ptr<scheduler_serviceIf>& iface) : iface_(iface) {}
 ...
 protected:
  ::apache::thrift::stdcxx::shared_ptr<scheduler_serviceIf> iface_;
};
...
class scheduler_serviceClient : virtual public scheduler_serviceIf, public common_serviceClient {
 public:
  scheduler_serviceClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) :
    common_serviceClient(prot, prot) {}
  scheduler_serviceClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) :    common_serviceClient(iprot, oprot) {}
...
class scheduler_serviceProcessor : public common_serviceProcessor {
 ...
 public:
  scheduler_serviceProcessor(::apache::thrift::stdcxx::shared_ptr<scheduler_serviceIf> iface) :
...
class scheduler_serviceProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  scheduler_serviceProcessorFactory(const ::apache::thrift::stdcxx::shared_ptr< scheduler_serviceIfFactory >& handlerFactory) :
      handlerFactory_(handlerFactory) {}

  ::apache::thrift::stdcxx::shared_ptr< ::apache::thrift::TProcessor > getProcessor(const ::apache::thrift::TConnectionInfo& connInfo);

 protected:
  ::apache::thrift::stdcxx::shared_ptr< scheduler_serviceIfFactory > handlerFactory_;
};

class scheduler_serviceMultiface : virtual public scheduler_serviceIf, public common_serviceMultiface {
 public:
  scheduler_serviceMultiface(std::vector<apache::thrift::stdcxx::shared_ptr<scheduler_serviceIf> >& ifaces) : ifaces_(ifaces) {
    std::vector<apache::thrift::stdcxx::shared_ptr<scheduler_serviceIf> >::iterator iter;
 ...
 protected:
  std::vector<apache::thrift::stdcxx::shared_ptr<scheduler_serviceIf> > ifaces_;
  scheduler_serviceMultiface() {}
  void add(::apache::thrift::stdcxx::shared_ptr<scheduler_serviceIf> iface) {
...
class scheduler_serviceConcurrentClient : virtual public scheduler_serviceIf, public common_serviceConcurrentClient {
 public:
  scheduler_serviceConcurrentClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) :
    common_serviceConcurrentClient(prot, prot) {}
  scheduler_serviceConcurrentClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) :    common_serviceConcurrentClient(iprot, oprot) {}
  apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> getInputProtocol() {
    return piprot_;
  }
  apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> getOutputProtocol() {
...
class scheduler_serviceCobClIf : virtual public common_serviceCobClIf {
 public:
  ...
  virtual void get_physical_machine_detail(::apache::thrift::stdcxx::function<void(scheduler_serviceCobClient* client)> cob, const std::string& session_id, const std::string& host, const machine_detail_filter::type filter) = 0;
  virtual void get_physical_machine_detail2(::apache::thrift::stdcxx::function<void(scheduler_serviceCobClient* client)> cob, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const machine_detail_filter::type filter) = 0;
  virtual void get_virtual_host_info(::apache::thrift::stdcxx::function<void(scheduler_serviceCobClient* client)> cob, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password) = 0;
  virtual void get_virtual_machine_detail(::apache::thrift::stdcxx::function<void(scheduler_serviceCobClient* client)> cob, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id) = 0;
  virtual void create_job_ex(::apache::thrift::stdcxx::function<void(scheduler_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id, const create_job_detail& create_job) = 0;
  virtual void create_job(::apache::thrift::stdcxx::function<void(scheduler_serviceCobClient* client)> cob, const std::string& session_id, const create_job_detail& create_job) = 0;
  virtual void get_job(::apache::thrift::stdcxx::function<void(scheduler_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id) = 0;
  virtual void interrupt_job(::apache::thrift::stdcxx::function<void(scheduler_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id) = 0;
  virtual void resume_job(::apache::thrift::stdcxx::function<void(scheduler_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id) = 0;
  virtual void remove_job(::apache::thrift::stdcxx::function<void(scheduler_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id) = 0;
  virtual void list_jobs(::apache::thrift::stdcxx::function<void(scheduler_serviceCobClient* client)> cob, const std::string& session_id) = 0;
  virtual void update_job(::apache::thrift::stdcxx::function<void(scheduler_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id, const create_job_detail& create_job) = 0;
  virtual void terminate(::apache::thrift::stdcxx::function<void(scheduler_serviceCobClient* client)> cob, const std::string& session_id) = 0;
  virtual void running_job(::apache::thrift::stdcxx::function<void(scheduler_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id) = 0;
  virtual void verify_management(::apache::thrift::stdcxx::function<void(scheduler_serviceCobClient* client)> cob, const std::string& management, const int32_t port, const bool is_ssl) = 0;
  virtual void verify_packer_to_carrier(::apache::thrift::stdcxx::function<void(scheduler_serviceCobClient* client)> cob, const std::string& packer, const std::string& carrier, const int32_t port, const bool is_ssl) = 0;
  virtual void take_packer_xray(::apache::thrift::stdcxx::function<void(scheduler_serviceCobClient* client)> cob, const std::string& session_id, const std::string& host) = 0;
  virtual void get_packer_service_info(::apache::thrift::stdcxx::function<void(scheduler_serviceCobClient* client)> cob, const std::string& session_id, const std::string& host) = 0;
};

class scheduler_serviceCobSvIf : virtual public common_serviceCobSvIf {
 public:
  virtual ~scheduler_serviceCobSvIf() {}
  virtual void get_physical_machine_detail(::apache::thrift::stdcxx::function<void(physical_machine_info const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& host, const machine_detail_filter::type filter) = 0;
  ...
  virtual void create_job_ex(::apache::thrift::stdcxx::function<void(replica_job_detail const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& job_id, const create_job_detail& create_job) = 0;
  virtual void create_job(::apache::thrift::stdcxx::function<void(replica_job_detail const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const create_job_detail& create_job) = 0;
  virtual void get_job(::apache::thrift::stdcxx::function<void(replica_job_detail const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& job_id) = 0;
  ...
  virtual void list_jobs(::apache::thrift::stdcxx::function<void(std::vector<replica_job_detail>  const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id) = 0;
  virtual void update_job(::apache::thrift::stdcxx::function<void(bool const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& job_id, const create_job_detail& create_job) = 0;
  ...
  virtual void verify_packer_to_carrier(::apache::thrift::stdcxx::function<void(bool const& _return)> cob, const std::string& packer, const std::string& carrier, const int32_t port, const bool is_ssl) = 0;
  virtual void take_packer_xray(::apache::thrift::stdcxx::function<void(std::string const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& host) = 0;
  virtual void get_packer_service_info(::apache::thrift::stdcxx::function<void(service_info const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& host) = 0;
};
...
class scheduler_serviceCobSvIfSingletonFactory : virtual public scheduler_serviceCobSvIfFactory {
 public:
  scheduler_serviceCobSvIfSingletonFactory(const ::apache::thrift::stdcxx::shared_ptr<scheduler_serviceCobSvIf>& iface) : iface_(iface) {}
 ...
 protected:
  ::apache::thrift::stdcxx::shared_ptr<scheduler_serviceCobSvIf> iface_;
};
...
class scheduler_serviceCobClient : virtual public scheduler_serviceCobClIf, public common_serviceCobClient {
 public:
  scheduler_serviceCobClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::async::TAsyncChannel> channel, ::apache::thrift::protocol::TProtocolFactory* protocolFactory) :
  ...
  void get_physical_machine_detail(::apache::thrift::stdcxx::function<void(scheduler_serviceCobClient* client)> cob, const std::string& session_id, const std::string& host, const machine_detail_filter::type filter);
  void send_get_physical_machine_detail(const std::string& session_id, const std::string& host, const machine_detail_filter::type filter);
  void recv_get_physical_machine_detail(physical_machine_info& _return);
  void get_physical_machine_detail2(::apache::thrift::stdcxx::function<void(scheduler_serviceCobClient* client)> cob, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const machine_detail_filter::type filter);
  void send_get_physical_machine_detail2(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const machine_detail_filter::type filter);
  void recv_get_physical_machine_detail2(physical_machine_info& _return);
  void get_virtual_host_info(::apache::thrift::stdcxx::function<void(scheduler_serviceCobClient* client)> cob, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password);
  void send_get_virtual_host_info(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password);
  void recv_get_virtual_host_info(virtual_host& _return);
  void get_virtual_machine_detail(::apache::thrift::stdcxx::function<void(scheduler_serviceCobClient* client)> cob, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id);
  void send_get_virtual_machine_detail(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id);
  void recv_get_virtual_machine_detail(virtual_machine& _return);
  void create_job_ex(::apache::thrift::stdcxx::function<void(scheduler_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id, const create_job_detail& create_job);
  void send_create_job_ex(const std::string& session_id, const std::string& job_id, const create_job_detail& create_job);
  void recv_create_job_ex(replica_job_detail& _return);
  void create_job(::apache::thrift::stdcxx::function<void(scheduler_serviceCobClient* client)> cob, const std::string& session_id, const create_job_detail& create_job);
  void send_create_job(const std::string& session_id, const create_job_detail& create_job);
  void recv_create_job(replica_job_detail& _return);
  void get_job(::apache::thrift::stdcxx::function<void(scheduler_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id);
  void send_get_job(const std::string& session_id, const std::string& job_id);
  void recv_get_job(replica_job_detail& _return);
  void interrupt_job(::apache::thrift::stdcxx::function<void(scheduler_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id);
  void send_interrupt_job(const std::string& session_id, const std::string& job_id);
  bool recv_interrupt_job();
  void resume_job(::apache::thrift::stdcxx::function<void(scheduler_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id);
  void send_resume_job(const std::string& session_id, const std::string& job_id);
  bool recv_resume_job();
  void remove_job(::apache::thrift::stdcxx::function<void(scheduler_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id);
  void send_remove_job(const std::string& session_id, const std::string& job_id);
  bool recv_remove_job();
  void list_jobs(::apache::thrift::stdcxx::function<void(scheduler_serviceCobClient* client)> cob, const std::string& session_id);
  void send_list_jobs(const std::string& session_id);
  void recv_list_jobs(std::vector<replica_job_detail> & _return);
  void update_job(::apache::thrift::stdcxx::function<void(scheduler_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id, const create_job_detail& create_job);
  void send_update_job(const std::string& session_id, const std::string& job_id, const create_job_detail& create_job);
  bool recv_update_job();
  void terminate(::apache::thrift::stdcxx::function<void(scheduler_serviceCobClient* client)> cob, const std::string& session_id);
  void send_terminate(const std::string& session_id);
  void recv_terminate();
  void running_job(::apache::thrift::stdcxx::function<void(scheduler_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id);
  void send_running_job(const std::string& session_id, const std::string& job_id);
  bool recv_running_job();
  void verify_management(::apache::thrift::stdcxx::function<void(scheduler_serviceCobClient* client)> cob, const std::string& management, const int32_t port, const bool is_ssl);
  void send_verify_management(const std::string& management, const int32_t port, const bool is_ssl);
  bool recv_verify_management();
  void verify_packer_to_carrier(::apache::thrift::stdcxx::function<void(scheduler_serviceCobClient* client)> cob, const std::string& packer, const std::string& carrier, const int32_t port, const bool is_ssl);
  void send_verify_packer_to_carrier(const std::string& packer, const std::string& carrier, const int32_t port, const bool is_ssl);
  bool recv_verify_packer_to_carrier();
  void take_packer_xray(::apache::thrift::stdcxx::function<void(scheduler_serviceCobClient* client)> cob, const std::string& session_id, const std::string& host);
  void send_take_packer_xray(const std::string& session_id, const std::string& host);
  void recv_take_packer_xray(std::string& _return);
  void get_packer_service_info(::apache::thrift::stdcxx::function<void(scheduler_serviceCobClient* client)> cob, const std::string& session_id, const std::string& host);
  void send_get_packer_service_info(const std::string& session_id, const std::string& host);
  void recv_get_packer_service_info(service_info& _return);
};
...
class scheduler_serviceAsyncProcessor : public common_serviceAsyncProcessor {
 ...
 private:
  typedef  void (scheduler_serviceAsyncProcessor::*ProcessFunction)(::apache::thrift::stdcxx::function<void(bool ok)>, int32_t, ::apache::thrift::protocol::TProtocol*, ::apache::thrift::protocol::TProtocol*);
  typedef std::map<std::string, ProcessFunction> ProcessMap;
  ProcessMap processMap_;
  void process_get_physical_machine_detail(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_get_physical_machine_detail(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const physical_machine_info& _return);
  void throw_get_physical_machine_detail(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_get_physical_machine_detail2(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_get_physical_machine_detail2(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const physical_machine_info& _return);
  void throw_get_physical_machine_detail2(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  ...
  void return_create_job_ex(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const replica_job_detail& _return);
  ...
  void return_create_job(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const replica_job_detail& _return);
  ...
  void return_get_job(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const replica_job_detail& _return);
  ...
  void return_list_jobs(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::vector<replica_job_detail> & _return);
  ...
  void process_verify_packer_to_carrier(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_verify_packer_to_carrier(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return);
  void throw_verify_packer_to_carrier(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_take_packer_xray(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_take_packer_xray(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::string& _return);
  void throw_take_packer_xray(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_get_packer_service_info(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_get_packer_service_info(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const service_info& _return);
  void throw_get_packer_service_info(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
 public:
  scheduler_serviceAsyncProcessor(::apache::thrift::stdcxx::shared_ptr<scheduler_serviceCobSvIf> iface) :
...
class scheduler_serviceAsyncProcessorFactory : public ::apache::thrift::async::TAsyncProcessorFactory {
 public:
  scheduler_serviceAsyncProcessorFactory(const ::apache::thrift::stdcxx::shared_ptr< scheduler_serviceCobSvIfFactory >& handlerFactory) :
      handlerFactory_(handlerFactory) {}
 ...
 protected:
  ::apache::thrift::stdcxx::shared_ptr< scheduler_serviceCobSvIfFactory > handlerFactory_;
};
