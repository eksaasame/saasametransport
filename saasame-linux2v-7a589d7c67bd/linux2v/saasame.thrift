...
struct create_packer_job_detail{
	...
	14: map<string,string>               priority_carrier
...
service service_proxy extends common_service{
...
struct replica_job_create_detail{
   ...
   29: map<string,string>                           priority_carrier
...
struct aliyun_options{
   ...
   6: optional i32                            max_size					            = 512 //GB
...
enum async_job_op_result{
    JOB_OP_RESULT_UNKNOWN       = 0,
	JOB_OP_RESULT_SUCCESS       = 1,
    JOB_OP_RESULT_FAILED        = 2,
	JOB_OP_RESULT_NOT_FOUND     = 3
}

struct async_job_op_task {
	1: optional string                        task_id                                = ""
	2: optional string                        job_id                                 = ""
    3: optional string             			  service_type                           = ""
	4: optional async_job_op_type             type                                   = 0
	5: optional create_job_detail			  create_detail
	6: optional connection 					  conn
}
...
service management_service{
    ...
    string					              register_service( 1: string session_id, 2: register_service_info register_info, 3: physical_machine_info machine_info ) throws (1:invalid_operation ouch);
    string					              register_physical_packer( 1: string session_id, 2: register_physical_packer_info packer_info, 3: physical_machine_info machine_info ) throws (1:invalid_operation ouch);
	list<async_job_op_task>			      query_async_job_op_task_list( 1: string session_id, 2: string machine_id ) throws (1:invalid_operation ouch);
	bool								  async_job_op_task_callback( 1: string session_id, 2: string async_job_op_id, 3: async_job_op_result result ) throws (1:invalid_operation ouch);
...
struct running_task{
	1: optional string           id
	2: optional i32				 interval  				    = 30 //Seconds
...
service transport_service extends common_service{
