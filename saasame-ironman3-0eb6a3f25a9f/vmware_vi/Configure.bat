...
rem
set CONFIG_COPYRIGHT=Copyright 2006-2013 FalconStor Software.  All Rights Reserved.
set CONFIG_VERSION_MAJOR=5
set CONFIG_VERSION_MINOR=50

set INAS_MAJOR=5
set INAS_MINOR=5
set INAS_ISHIELD_VERSION=5.50.0
...
set PROD_REG_SHORTNAME=SanVI

set PRODUCT_EVENTLOG_STR=SanVI
...
set PRODUCT_NAME=SanVI
set VENDOR_ID=1
set PRODUCT_VENDOR_STR=FalconStor
set PRODUCT_VENDOR_WSTR=FalconStor
set PRODUCT_FULLNAME_STR=FalconStor® SanVI
set PRODUCT_NAME_STR=FalconStor SanVI
set PRODUCT_SHORTNAME_STR=SanVI
set PRODUCT_SHORTNAME_PREV_STR=SanVI
set PRODUCT_MMC_ROOTNODENAME=SanVI
set PRODUCT_SETUP_DEFAULT_DIR_STR=FalconStor\\SanVI
set PRODUCT_SETUP_PROGRAM_MENU_STR=FalconStor\\SanVI
set PRODUCT_SETUP_PROGRAM_MENU_PREV_STR=FalconStor\\SanVI
set PRODUCT_SETUP_PROGRAM_MENU_PREV_STR2=FalconStor\\SanVI
set PRODUCT_SETUP_PRODUCT_NAME_STR=%PRODUCT_NAME_STR%
set PRODUCT_HELPFILE_BASE_STR=SanVI
goto check
...
set PRODUCT_FULLNAME_STR=Violin® SanVI
set PRODUCT_NAME_STR=Violin SanVI
set PRODUCT_SHORTNAME_STR=SanVI
set PRODUCT_SHORTNAME_PREV_STR=SanVI
set PRODUCT_MMC_ROOTNODENAME=SanVI
set PRODUCT_SETUP_DEFAULT_DIR_STR=SANClient\\SanVI
set PRODUCT_SETUP_PROGRAM_MENU_STR=FalconStor\\SanVI
set PRODUCT_SETUP_PROGRAM_MENU_PREV_STR=FalconStor\\SanVI
set PRODUCT_SETUP_PROGRAM_MENU_PREV_STR2=FalconStor\\SanVI
set PRODUCT_SETUP_PRODUCT_NAME_STR=%PRODUCT_NAME_STR%
...
set PRODUCT_FULLNAME_STR=SanVI
set PRODUCT_NAME_STR=SanVI
set PRODUCT_SHORTNAME_STR=SanVI
set PRODUCT_SHORTNAME_PREV_STR=SanVI
set PRODUCT_MMC_ROOTNODENAME=SanVI
set PRODUCT_SETUP_DEFAULT_DIR_STR=SanVI
set PRODUCT_SETUP_PROGRAM_MENU_STR=SanVI
set PRODUCT_SETUP_PROGRAM_MENU_PREV_STR=FalconStor\\SanVI
set PRODUCT_SETUP_PROGRAM_MENU_PREV_STR2=FalconStor\\SanVI
set PRODUCT_SETUP_PRODUCT_NAME_STR=%PRODUCT_NAME_STR%
set PRODUCT_HELPFILE_BASE_STR=SanVI
