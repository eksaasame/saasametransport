...
class service_proxyIf : virtual public physical_packer_service_proxyIf {
 public:
  ...
  virtual void get_virtual_hosts_p(std::vector<virtual_host> & _return, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password) = 0;
  ...
  virtual bool power_off_virtual_machine_p(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id) = 0;
  virtual bool remove_virtual_machine_p(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id) = 0;
  virtual void get_virtual_machine_snapshots_p(std::vector<vmware_snapshot> & _return, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id) = 0;
  virtual bool remove_virtual_machine_snapshot_p(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id, const std::string& snapshot_id) = 0;
  ...
  virtual void get_datacenter_folder_list_p(std::vector<std::string> & _return, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& datacenter) = 0;
...
class service_proxyIfSingletonFactory : virtual public service_proxyIfFactory {
 public:
  service_proxyIfSingletonFactory(const ::apache::thrift::stdcxx::shared_ptr<service_proxyIf>& iface) : iface_(iface) {}
 ...
 protected:
  ::apache::thrift::stdcxx::shared_ptr<service_proxyIf> iface_;
};
...
typedef struct _service_proxy_get_virtual_hosts_p_args__isset {
  _service_proxy_get_virtual_hosts_p_args__isset() : session_id(false), host(false), username(false), password(false) {}
  bool session_id :1;
  bool host :1;
  bool username :1;
  bool password :1;
} _service_proxy_get_virtual_hosts_p_args__isset;

class service_proxy_get_virtual_hosts_p_args {
 public:

  service_proxy_get_virtual_hosts_p_args(const service_proxy_get_virtual_hosts_p_args&);
  service_proxy_get_virtual_hosts_p_args& operator=(const service_proxy_get_virtual_hosts_p_args&);
  service_proxy_get_virtual_hosts_p_args() : session_id(), host(), username(), password() {
  }

  virtual ~service_proxy_get_virtual_hosts_p_args() throw();
  std::string session_id;
  std::string host;
  std::string username;
  std::string password;

  _service_proxy_get_virtual_hosts_p_args__isset __isset;
  ...
  bool operator == (const service_proxy_get_virtual_hosts_p_args & rhs) const
  {
    if (!(session_id == rhs.session_id))
      return false;
    if (!(host == rhs.host))
  ...
  bool operator < (const service_proxy_get_virtual_hosts_p_args & ) const;
...
class service_proxy_get_virtual_hosts_p_pargs {
 public:


  virtual ~service_proxy_get_virtual_hosts_p_pargs() throw();
  const std::string* session_id;
  const std::string* host;
  const std::string* username;
  const std::string* password;
...
typedef struct _service_proxy_get_virtual_hosts_p_result__isset {
  _service_proxy_get_virtual_hosts_p_result__isset() : success(false), ouch(false) {}
  bool success :1;
  bool ouch :1;
} _service_proxy_get_virtual_hosts_p_result__isset;

class service_proxy_get_virtual_hosts_p_result {
 public:

  service_proxy_get_virtual_hosts_p_result(const service_proxy_get_virtual_hosts_p_result&);
  service_proxy_get_virtual_hosts_p_result& operator=(const service_proxy_get_virtual_hosts_p_result&);
  service_proxy_get_virtual_hosts_p_result() {
  }

  virtual ~service_proxy_get_virtual_hosts_p_result() throw();
  std::vector<virtual_host>  success;
  invalid_operation ouch;

  _service_proxy_get_virtual_hosts_p_result__isset __isset;

  void __set_success(const std::vector<virtual_host> & val);

  void __set_ouch(const invalid_operation& val);

  bool operator == (const service_proxy_get_virtual_hosts_p_result & rhs) const
  {
    if (!(success == rhs.success))
      return false;
    if (!(ouch == rhs.ouch))
  ...
  bool operator < (const service_proxy_get_virtual_hosts_p_result & ) const;
...
typedef struct _service_proxy_get_virtual_hosts_p_presult__isset {
  _service_proxy_get_virtual_hosts_p_presult__isset() : success(false), ouch(false) {}
  bool success :1;
  bool ouch :1;
} _service_proxy_get_virtual_hosts_p_presult__isset;

class service_proxy_get_virtual_hosts_p_presult {
 public:


  virtual ~service_proxy_get_virtual_hosts_p_presult() throw();
  std::vector<virtual_host> * success;
  invalid_operation ouch;

  _service_proxy_get_virtual_hosts_p_presult__isset __isset;
...
typedef struct _service_proxy_power_off_virtual_machine_p_args__isset {
  _service_proxy_power_off_virtual_machine_p_args__isset() : session_id(false), host(false), username(false), password(false), machine_id(false) {}
  bool session_id :1;
  bool host :1;
  bool username :1;
  bool password :1;
  bool machine_id :1;
} _service_proxy_power_off_virtual_machine_p_args__isset;

class service_proxy_power_off_virtual_machine_p_args {
 public:

  service_proxy_power_off_virtual_machine_p_args(const service_proxy_power_off_virtual_machine_p_args&);
  service_proxy_power_off_virtual_machine_p_args& operator=(const service_proxy_power_off_virtual_machine_p_args&);
  service_proxy_power_off_virtual_machine_p_args() : session_id(), host(), username(), password(), machine_id() {
  }

  virtual ~service_proxy_power_off_virtual_machine_p_args() throw();
  std::string session_id;
  std::string host;
  std::string username;
  std::string password;
  ...
  _service_proxy_power_off_virtual_machine_p_args__isset __isset;
  ...
  bool operator == (const service_proxy_power_off_virtual_machine_p_args & rhs) const
  {
    if (!(session_id == rhs.session_id))
      return false;
    if (!(host == rhs.host))
  ...
  bool operator < (const service_proxy_power_off_virtual_machine_p_args & ) const;
...
class service_proxy_power_off_virtual_machine_p_pargs {
 public:


  virtual ~service_proxy_power_off_virtual_machine_p_pargs() throw();
  const std::string* session_id;
  const std::string* host;
  const std::string* username;
  const std::string* password;
...
typedef struct _service_proxy_power_off_virtual_machine_p_result__isset {
  _service_proxy_power_off_virtual_machine_p_result__isset() : success(false), ouch(false) {}
  bool success :1;
  bool ouch :1;
} _service_proxy_power_off_virtual_machine_p_result__isset;

class service_proxy_power_off_virtual_machine_p_result {
 public:

  service_proxy_power_off_virtual_machine_p_result(const service_proxy_power_off_virtual_machine_p_result&);
  service_proxy_power_off_virtual_machine_p_result& operator=(const service_proxy_power_off_virtual_machine_p_result&);
  service_proxy_power_off_virtual_machine_p_result() : success(0) {
  }

  virtual ~service_proxy_power_off_virtual_machine_p_result() throw();
  bool success;
  invalid_operation ouch;

  _service_proxy_power_off_virtual_machine_p_result__isset __isset;

  void __set_success(const bool val);

  void __set_ouch(const invalid_operation& val);

  bool operator == (const service_proxy_power_off_virtual_machine_p_result & rhs) const
  {
    if (!(success == rhs.success))
      return false;
    if (!(ouch == rhs.ouch))
  ...
  bool operator < (const service_proxy_power_off_virtual_machine_p_result & ) const;
...
typedef struct _service_proxy_power_off_virtual_machine_p_presult__isset {
  _service_proxy_power_off_virtual_machine_p_presult__isset() : success(false), ouch(false) {}
  bool success :1;
  bool ouch :1;
} _service_proxy_power_off_virtual_machine_p_presult__isset;

class service_proxy_power_off_virtual_machine_p_presult {
 public:


  virtual ~service_proxy_power_off_virtual_machine_p_presult() throw();
  bool* success;
  invalid_operation ouch;

  _service_proxy_power_off_virtual_machine_p_presult__isset __isset;
...
typedef struct _service_proxy_remove_virtual_machine_p_args__isset {
  _service_proxy_remove_virtual_machine_p_args__isset() : session_id(false), host(false), username(false), password(false), machine_id(false) {}
  bool session_id :1;
  bool host :1;
  bool username :1;
  bool password :1;
  bool machine_id :1;
} _service_proxy_remove_virtual_machine_p_args__isset;

class service_proxy_remove_virtual_machine_p_args {
 public:

  service_proxy_remove_virtual_machine_p_args(const service_proxy_remove_virtual_machine_p_args&);
  service_proxy_remove_virtual_machine_p_args& operator=(const service_proxy_remove_virtual_machine_p_args&);
  service_proxy_remove_virtual_machine_p_args() : session_id(), host(), username(), password(), machine_id() {
  }

  virtual ~service_proxy_remove_virtual_machine_p_args() throw();
  std::string session_id;
  std::string host;
  std::string username;
  std::string password;
  ...
  _service_proxy_remove_virtual_machine_p_args__isset __isset;
  ...
  bool operator == (const service_proxy_remove_virtual_machine_p_args & rhs) const
  {
    if (!(session_id == rhs.session_id))
      return false;
    if (!(host == rhs.host))
  ...
  bool operator < (const service_proxy_remove_virtual_machine_p_args & ) const;
...
class service_proxy_remove_virtual_machine_p_pargs {
 public:


  virtual ~service_proxy_remove_virtual_machine_p_pargs() throw();
  const std::string* session_id;
  const std::string* host;
  const std::string* username;
  const std::string* password;
...
typedef struct _service_proxy_remove_virtual_machine_p_result__isset {
  _service_proxy_remove_virtual_machine_p_result__isset() : success(false), ouch(false) {}
  bool success :1;
  bool ouch :1;
} _service_proxy_remove_virtual_machine_p_result__isset;

class service_proxy_remove_virtual_machine_p_result {
 public:

  service_proxy_remove_virtual_machine_p_result(const service_proxy_remove_virtual_machine_p_result&);
  service_proxy_remove_virtual_machine_p_result& operator=(const service_proxy_remove_virtual_machine_p_result&);
  service_proxy_remove_virtual_machine_p_result() : success(0) {
  }

  virtual ~service_proxy_remove_virtual_machine_p_result() throw();
  bool success;
  invalid_operation ouch;

  _service_proxy_remove_virtual_machine_p_result__isset __isset;

  void __set_success(const bool val);

  void __set_ouch(const invalid_operation& val);

  bool operator == (const service_proxy_remove_virtual_machine_p_result & rhs) const
  {
    if (!(success == rhs.success))
      return false;
    if (!(ouch == rhs.ouch))
  ...
  bool operator < (const service_proxy_remove_virtual_machine_p_result & ) const;
...
typedef struct _service_proxy_remove_virtual_machine_p_presult__isset {
  _service_proxy_remove_virtual_machine_p_presult__isset() : success(false), ouch(false) {}
  bool success :1;
  bool ouch :1;
} _service_proxy_remove_virtual_machine_p_presult__isset;

class service_proxy_remove_virtual_machine_p_presult {
 public:


  virtual ~service_proxy_remove_virtual_machine_p_presult() throw();
  bool* success;
  invalid_operation ouch;

  _service_proxy_remove_virtual_machine_p_presult__isset __isset;
...
typedef struct _service_proxy_get_virtual_machine_snapshots_p_args__isset {
  _service_proxy_get_virtual_machine_snapshots_p_args__isset() : session_id(false), host(false), username(false), password(false), machine_id(false) {}
  bool session_id :1;
  bool host :1;
  bool username :1;
  bool password :1;
  bool machine_id :1;
} _service_proxy_get_virtual_machine_snapshots_p_args__isset;

class service_proxy_get_virtual_machine_snapshots_p_args {
 public:

  service_proxy_get_virtual_machine_snapshots_p_args(const service_proxy_get_virtual_machine_snapshots_p_args&);
  service_proxy_get_virtual_machine_snapshots_p_args& operator=(const service_proxy_get_virtual_machine_snapshots_p_args&);
  service_proxy_get_virtual_machine_snapshots_p_args() : session_id(), host(), username(), password(), machine_id() {
  }

  virtual ~service_proxy_get_virtual_machine_snapshots_p_args() throw();
  std::string session_id;
  std::string host;
  std::string username;
  std::string password;
  ...
  _service_proxy_get_virtual_machine_snapshots_p_args__isset __isset;
  ...
  bool operator == (const service_proxy_get_virtual_machine_snapshots_p_args & rhs) const
  {
    if (!(session_id == rhs.session_id))
      return false;
    if (!(host == rhs.host))
  ...
  bool operator < (const service_proxy_get_virtual_machine_snapshots_p_args & ) const;
...
class service_proxy_get_virtual_machine_snapshots_p_pargs {
 public:


  virtual ~service_proxy_get_virtual_machine_snapshots_p_pargs() throw();
  const std::string* session_id;
  const std::string* host;
  const std::string* username;
  const std::string* password;
...
typedef struct _service_proxy_get_virtual_machine_snapshots_p_result__isset {
  _service_proxy_get_virtual_machine_snapshots_p_result__isset() : success(false), ouch(false) {}
  bool success :1;
  bool ouch :1;
} _service_proxy_get_virtual_machine_snapshots_p_result__isset;

class service_proxy_get_virtual_machine_snapshots_p_result {
 public:

  service_proxy_get_virtual_machine_snapshots_p_result(const service_proxy_get_virtual_machine_snapshots_p_result&);
  service_proxy_get_virtual_machine_snapshots_p_result& operator=(const service_proxy_get_virtual_machine_snapshots_p_result&);
  service_proxy_get_virtual_machine_snapshots_p_result() {
  }

  virtual ~service_proxy_get_virtual_machine_snapshots_p_result() throw();
  std::vector<vmware_snapshot>  success;
  invalid_operation ouch;

  _service_proxy_get_virtual_machine_snapshots_p_result__isset __isset;

  void __set_success(const std::vector<vmware_snapshot> & val);

  void __set_ouch(const invalid_operation& val);

  bool operator == (const service_proxy_get_virtual_machine_snapshots_p_result & rhs) const
  {
    if (!(success == rhs.success))
      return false;
    if (!(ouch == rhs.ouch))
  ...
  bool operator < (const service_proxy_get_virtual_machine_snapshots_p_result & ) const;
...
typedef struct _service_proxy_get_virtual_machine_snapshots_p_presult__isset {
  _service_proxy_get_virtual_machine_snapshots_p_presult__isset() : success(false), ouch(false) {}
  bool success :1;
  bool ouch :1;
} _service_proxy_get_virtual_machine_snapshots_p_presult__isset;

class service_proxy_get_virtual_machine_snapshots_p_presult {
 public:


  virtual ~service_proxy_get_virtual_machine_snapshots_p_presult() throw();
  std::vector<vmware_snapshot> * success;
  invalid_operation ouch;

  _service_proxy_get_virtual_machine_snapshots_p_presult__isset __isset;
...
typedef struct _service_proxy_remove_virtual_machine_snapshot_p_args__isset {
  _service_proxy_remove_virtual_machine_snapshot_p_args__isset() : session_id(false), host(false), username(false), password(false), machine_id(false), snapshot_id(false) {}
  bool session_id :1;
  bool host :1;
  bool username :1;
  bool password :1;
  bool machine_id :1;
  bool snapshot_id :1;
} _service_proxy_remove_virtual_machine_snapshot_p_args__isset;

class service_proxy_remove_virtual_machine_snapshot_p_args {
 public:

  service_proxy_remove_virtual_machine_snapshot_p_args(const service_proxy_remove_virtual_machine_snapshot_p_args&);
  service_proxy_remove_virtual_machine_snapshot_p_args& operator=(const service_proxy_remove_virtual_machine_snapshot_p_args&);
  service_proxy_remove_virtual_machine_snapshot_p_args() : session_id(), host(), username(), password(), machine_id(), snapshot_id() {
  }

  virtual ~service_proxy_remove_virtual_machine_snapshot_p_args() throw();
  std::string session_id;
  std::string host;
  std::string username;
  std::string password;
  ...
  _service_proxy_remove_virtual_machine_snapshot_p_args__isset __isset;
  ...
  bool operator == (const service_proxy_remove_virtual_machine_snapshot_p_args & rhs) const
  {
    if (!(session_id == rhs.session_id))
      return false;
    if (!(host == rhs.host))
  ...
  bool operator < (const service_proxy_remove_virtual_machine_snapshot_p_args & ) const;
...
class service_proxy_remove_virtual_machine_snapshot_p_pargs {
 public:


  virtual ~service_proxy_remove_virtual_machine_snapshot_p_pargs() throw();
  const std::string* session_id;
  const std::string* host;
  const std::string* username;
  const std::string* password;
...
typedef struct _service_proxy_remove_virtual_machine_snapshot_p_result__isset {
  _service_proxy_remove_virtual_machine_snapshot_p_result__isset() : success(false), ouch(false) {}
  bool success :1;
  bool ouch :1;
} _service_proxy_remove_virtual_machine_snapshot_p_result__isset;

class service_proxy_remove_virtual_machine_snapshot_p_result {
 public:

  service_proxy_remove_virtual_machine_snapshot_p_result(const service_proxy_remove_virtual_machine_snapshot_p_result&);
  service_proxy_remove_virtual_machine_snapshot_p_result& operator=(const service_proxy_remove_virtual_machine_snapshot_p_result&);
  service_proxy_remove_virtual_machine_snapshot_p_result() : success(0) {
  }

  virtual ~service_proxy_remove_virtual_machine_snapshot_p_result() throw();
  bool success;
  invalid_operation ouch;

  _service_proxy_remove_virtual_machine_snapshot_p_result__isset __isset;

  void __set_success(const bool val);

  void __set_ouch(const invalid_operation& val);

  bool operator == (const service_proxy_remove_virtual_machine_snapshot_p_result & rhs) const
  {
    if (!(success == rhs.success))
      return false;
    if (!(ouch == rhs.ouch))
  ...
  bool operator < (const service_proxy_remove_virtual_machine_snapshot_p_result & ) const;
...
typedef struct _service_proxy_remove_virtual_machine_snapshot_p_presult__isset {
  _service_proxy_remove_virtual_machine_snapshot_p_presult__isset() : success(false), ouch(false) {}
  bool success :1;
  bool ouch :1;
} _service_proxy_remove_virtual_machine_snapshot_p_presult__isset;

class service_proxy_remove_virtual_machine_snapshot_p_presult {
 public:


  virtual ~service_proxy_remove_virtual_machine_snapshot_p_presult() throw();
  bool* success;
  invalid_operation ouch;

  _service_proxy_remove_virtual_machine_snapshot_p_presult__isset __isset;
...
typedef struct _service_proxy_get_datacenter_folder_list_p_args__isset {
  _service_proxy_get_datacenter_folder_list_p_args__isset() : session_id(false), host(false), username(false), password(false), datacenter(false) {}
  bool session_id :1;
  bool host :1;
  bool username :1;
  bool password :1;
  bool datacenter :1;
} _service_proxy_get_datacenter_folder_list_p_args__isset;

class service_proxy_get_datacenter_folder_list_p_args {
 public:

  service_proxy_get_datacenter_folder_list_p_args(const service_proxy_get_datacenter_folder_list_p_args&);
  service_proxy_get_datacenter_folder_list_p_args& operator=(const service_proxy_get_datacenter_folder_list_p_args&);
  service_proxy_get_datacenter_folder_list_p_args() : session_id(), host(), username(), password(), datacenter() {
  }

  virtual ~service_proxy_get_datacenter_folder_list_p_args() throw();
  std::string session_id;
  std::string host;
  std::string username;
  std::string password;
  ...
  _service_proxy_get_datacenter_folder_list_p_args__isset __isset;
  ...
  bool operator == (const service_proxy_get_datacenter_folder_list_p_args & rhs) const
  {
    if (!(session_id == rhs.session_id))
      return false;
    if (!(host == rhs.host))
  ...
  bool operator < (const service_proxy_get_datacenter_folder_list_p_args & ) const;
...
class service_proxy_get_datacenter_folder_list_p_pargs {
 public:


  virtual ~service_proxy_get_datacenter_folder_list_p_pargs() throw();
  const std::string* session_id;
  const std::string* host;
  const std::string* username;
  const std::string* password;
...
typedef struct _service_proxy_get_datacenter_folder_list_p_result__isset {
  _service_proxy_get_datacenter_folder_list_p_result__isset() : success(false), ouch(false) {}
  bool success :1;
  bool ouch :1;
} _service_proxy_get_datacenter_folder_list_p_result__isset;

class service_proxy_get_datacenter_folder_list_p_result {
 public:

  service_proxy_get_datacenter_folder_list_p_result(const service_proxy_get_datacenter_folder_list_p_result&);
  service_proxy_get_datacenter_folder_list_p_result& operator=(const service_proxy_get_datacenter_folder_list_p_result&);
  service_proxy_get_datacenter_folder_list_p_result() {
  }

  virtual ~service_proxy_get_datacenter_folder_list_p_result() throw();
  std::vector<std::string>  success;
  invalid_operation ouch;

  _service_proxy_get_datacenter_folder_list_p_result__isset __isset;

  void __set_success(const std::vector<std::string> & val);

  void __set_ouch(const invalid_operation& val);

  bool operator == (const service_proxy_get_datacenter_folder_list_p_result & rhs) const
  {
    if (!(success == rhs.success))
      return false;
    if (!(ouch == rhs.ouch))
  ...
  bool operator < (const service_proxy_get_datacenter_folder_list_p_result & ) const;
...
typedef struct _service_proxy_get_datacenter_folder_list_p_presult__isset {
  _service_proxy_get_datacenter_folder_list_p_presult__isset() : success(false), ouch(false) {}
  bool success :1;
  bool ouch :1;
} _service_proxy_get_datacenter_folder_list_p_presult__isset;

class service_proxy_get_datacenter_folder_list_p_presult {
 public:


  virtual ~service_proxy_get_datacenter_folder_list_p_presult() throw();
  std::vector<std::string> * success;
  invalid_operation ouch;

  _service_proxy_get_datacenter_folder_list_p_presult__isset __isset;
...
class service_proxyClient : virtual public service_proxyIf, public physical_packer_service_proxyClient {
 public:
  service_proxyClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) :
    physical_packer_service_proxyClient(prot, prot) {}
  service_proxyClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) :    physical_packer_service_proxyClient(iprot, oprot) {}
  ...
  void get_virtual_hosts_p(std::vector<virtual_host> & _return, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password);
  void send_get_virtual_hosts_p(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password);
  ...
  bool power_off_virtual_machine_p(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id);
  void send_power_off_virtual_machine_p(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id);
  bool recv_power_off_virtual_machine_p();
  bool remove_virtual_machine_p(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id);
  void send_remove_virtual_machine_p(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id);
  bool recv_remove_virtual_machine_p();
  void get_virtual_machine_snapshots_p(std::vector<vmware_snapshot> & _return, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id);
  void send_get_virtual_machine_snapshots_p(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id);
  void recv_get_virtual_machine_snapshots_p(std::vector<vmware_snapshot> & _return);
  bool remove_virtual_machine_snapshot_p(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id, const std::string& snapshot_id);
  void send_remove_virtual_machine_snapshot_p(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id, const std::string& snapshot_id);
  ...
  void get_datacenter_folder_list_p(std::vector<std::string> & _return, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& datacenter);
  void send_get_datacenter_folder_list_p(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& datacenter);
...
class service_proxyProcessor : public physical_packer_service_proxyProcessor {
 ...
 public:
  service_proxyProcessor(::apache::thrift::stdcxx::shared_ptr<service_proxyIf> iface) :
    ...
    processMap_["get_virtual_hosts_p"] = &service_proxyProcessor::process_get_virtual_hosts_p;
    processMap_["get_virtual_machine_detail_p"] = &service_proxyProcessor::process_get_virtual_machine_detail_p;
    processMap_["power_off_virtual_machine_p"] = &service_proxyProcessor::process_power_off_virtual_machine_p;
    processMap_["remove_virtual_machine_p"] = &service_proxyProcessor::process_remove_virtual_machine_p;
    processMap_["get_virtual_machine_snapshots_p"] = &service_proxyProcessor::process_get_virtual_machine_snapshots_p;
    processMap_["remove_virtual_machine_snapshot_p"] = &service_proxyProcessor::process_remove_virtual_machine_snapshot_p;
    processMap_["get_physical_machine_detail_p"] = &service_proxyProcessor::process_get_physical_machine_detail_p;
    processMap_["get_datacenter_folder_list_p"] = &service_proxyProcessor::process_get_datacenter_folder_list_p;
...
class service_proxyProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  service_proxyProcessorFactory(const ::apache::thrift::stdcxx::shared_ptr< service_proxyIfFactory >& handlerFactory) :
      handlerFactory_(handlerFactory) {}

  ::apache::thrift::stdcxx::shared_ptr< ::apache::thrift::TProcessor > getProcessor(const ::apache::thrift::TConnectionInfo& connInfo);

 protected:
  ::apache::thrift::stdcxx::shared_ptr< service_proxyIfFactory > handlerFactory_;
};

class service_proxyMultiface : virtual public service_proxyIf, public physical_packer_service_proxyMultiface {
 public:
  service_proxyMultiface(std::vector<apache::thrift::stdcxx::shared_ptr<service_proxyIf> >& ifaces) : ifaces_(ifaces) {
    std::vector<apache::thrift::stdcxx::shared_ptr<service_proxyIf> >::iterator iter;
 ...
 protected:
  std::vector<apache::thrift::stdcxx::shared_ptr<service_proxyIf> > ifaces_;
  service_proxyMultiface() {}
  void add(::apache::thrift::stdcxx::shared_ptr<service_proxyIf> iface) {
 ...
 public:
  ...
  void get_virtual_hosts_p(std::vector<virtual_host> & _return, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->get_virtual_hosts_p(_return, session_id, host, username, password);
    }
    ifaces_[i]->get_virtual_hosts_p(_return, session_id, host, username, password);
    return;
  }
  ...
  bool power_off_virtual_machine_p(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->power_off_virtual_machine_p(session_id, host, username, password, machine_id);
    }
    return ifaces_[i]->power_off_virtual_machine_p(session_id, host, username, password, machine_id);
  }
  ...
  bool remove_virtual_machine_p(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->remove_virtual_machine_p(session_id, host, username, password, machine_id);
    }
    return ifaces_[i]->remove_virtual_machine_p(session_id, host, username, password, machine_id);
  }
  ...
  void get_virtual_machine_snapshots_p(std::vector<vmware_snapshot> & _return, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->get_virtual_machine_snapshots_p(_return, session_id, host, username, password, machine_id);
    }
    ifaces_[i]->get_virtual_machine_snapshots_p(_return, session_id, host, username, password, machine_id);
    return;
  }
  ...
  bool remove_virtual_machine_snapshot_p(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id, const std::string& snapshot_id) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->remove_virtual_machine_snapshot_p(session_id, host, username, password, machine_id, snapshot_id);
    }
    return ifaces_[i]->remove_virtual_machine_snapshot_p(session_id, host, username, password, machine_id, snapshot_id);
  }
  ...
  void get_datacenter_folder_list_p(std::vector<std::string> & _return, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& datacenter) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->get_datacenter_folder_list_p(_return, session_id, host, username, password, datacenter);
    }
    ifaces_[i]->get_datacenter_folder_list_p(_return, session_id, host, username, password, datacenter);
    return;
  }
...
class service_proxyConcurrentClient : virtual public service_proxyIf, public physical_packer_service_proxyConcurrentClient {
 public:
  service_proxyConcurrentClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) :
    physical_packer_service_proxyConcurrentClient(prot, prot) {}
  service_proxyConcurrentClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) :    physical_packer_service_proxyConcurrentClient(iprot, oprot) {}
  apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> getInputProtocol() {
    return piprot_;
  }
  apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> getOutputProtocol() {
  ...
  void get_virtual_hosts_p(std::vector<virtual_host> & _return, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password);
  int32_t send_get_virtual_hosts_p(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password);
  ...
  bool power_off_virtual_machine_p(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id);
  int32_t send_power_off_virtual_machine_p(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id);
  bool recv_power_off_virtual_machine_p(const int32_t seqid);
  bool remove_virtual_machine_p(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id);
  int32_t send_remove_virtual_machine_p(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id);
  bool recv_remove_virtual_machine_p(const int32_t seqid);
  void get_virtual_machine_snapshots_p(std::vector<vmware_snapshot> & _return, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id);
  int32_t send_get_virtual_machine_snapshots_p(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id);
  void recv_get_virtual_machine_snapshots_p(std::vector<vmware_snapshot> & _return, const int32_t seqid);
  bool remove_virtual_machine_snapshot_p(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id, const std::string& snapshot_id);
  int32_t send_remove_virtual_machine_snapshot_p(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id, const std::string& snapshot_id);
  ...
  void get_datacenter_folder_list_p(std::vector<std::string> & _return, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& datacenter);
  int32_t send_get_datacenter_folder_list_p(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& datacenter);
...
class service_proxyCobClIf : virtual public physical_packer_service_proxyCobClIf {
 public:
  ...
  virtual void create_job_ex_p(::apache::thrift::stdcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& job_id, const create_job_detail& create_job, const std::string& service_type) = 0;
  virtual void get_job_p(::apache::thrift::stdcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& job_id, const std::string& service_type) = 0;
  virtual void interrupt_job_p(::apache::thrift::stdcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& job_id, const std::string& service_type) = 0;
  virtual void resume_job_p(::apache::thrift::stdcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& job_id, const std::string& service_type) = 0;
  virtual void remove_job_p(::apache::thrift::stdcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& job_id, const std::string& service_type) = 0;
  virtual void running_job_p(::apache::thrift::stdcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& job_id, const std::string& service_type) = 0;
  virtual void update_job_p(::apache::thrift::stdcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& job_id, const create_job_detail& create_job, const std::string& service_type) = 0;
  virtual void remove_snapshot_image_p(::apache::thrift::stdcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const std::map<std::string, image_map_info> & images, const std::string& service_type) = 0;
  virtual void test_connection_p(::apache::thrift::stdcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const connection& conn, const std::string& service_type) = 0;
  virtual void add_connection_p(::apache::thrift::stdcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const connection& conn, const std::string& service_type) = 0;
  virtual void remove_connection_p(::apache::thrift::stdcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& connection_id, const std::string& service_type) = 0;
  virtual void modify_connection_p(::apache::thrift::stdcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const connection& conn, const std::string& service_type) = 0;
  virtual void enumerate_connections_p(::apache::thrift::stdcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& service_type) = 0;
  virtual void get_connection_p(::apache::thrift::stdcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& connection_id, const std::string& service_type) = 0;
  virtual void get_virtual_host_info_p(::apache::thrift::stdcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password) = 0;
  virtual void get_virtual_hosts_p(::apache::thrift::stdcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password) = 0;
  virtual void get_virtual_machine_detail_p(::apache::thrift::stdcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id) = 0;
  virtual void power_off_virtual_machine_p(::apache::thrift::stdcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id) = 0;
  virtual void remove_virtual_machine_p(::apache::thrift::stdcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id) = 0;
  virtual void get_virtual_machine_snapshots_p(::apache::thrift::stdcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id) = 0;
  virtual void remove_virtual_machine_snapshot_p(::apache::thrift::stdcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id, const std::string& snapshot_id) = 0;
  virtual void get_physical_machine_detail_p(::apache::thrift::stdcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& host, const machine_detail_filter::type filter) = 0;
  virtual void get_datacenter_folder_list_p(::apache::thrift::stdcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& datacenter) = 0;
  virtual void verify_packer_to_carrier_p(::apache::thrift::stdcxx::function<void(service_proxyCobClient* client)> cob, const std::string& packer, const std::string& carrier, const int32_t port, const bool is_ssl) = 0;
  virtual void take_packer_xray_p(::apache::thrift::stdcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& host) = 0;
  virtual void get_packer_service_info_p(::apache::thrift::stdcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& host) = 0;
  virtual void set_customized_id_p(::apache::thrift::stdcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& disk_addr, const std::string& disk_id) = 0;
};

class service_proxyCobSvIf : virtual public physical_packer_service_proxyCobSvIf {
 public:
  virtual ~service_proxyCobSvIf() {}
  virtual void create_job_ex_p(::apache::thrift::stdcxx::function<void(job_detail const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& job_id, const create_job_detail& create_job, const std::string& service_type) = 0;
  virtual void get_job_p(::apache::thrift::stdcxx::function<void(job_detail const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& job_id, const std::string& service_type) = 0;
  virtual void interrupt_job_p(::apache::thrift::stdcxx::function<void(bool const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& job_id, const std::string& service_type) = 0;
  virtual void resume_job_p(::apache::thrift::stdcxx::function<void(bool const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& job_id, const std::string& service_type) = 0;
  virtual void remove_job_p(::apache::thrift::stdcxx::function<void(bool const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& job_id, const std::string& service_type) = 0;
  virtual void running_job_p(::apache::thrift::stdcxx::function<void(bool const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& job_id, const std::string& service_type) = 0;
  virtual void update_job_p(::apache::thrift::stdcxx::function<void(bool const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& job_id, const create_job_detail& create_job, const std::string& service_type) = 0;
  virtual void remove_snapshot_image_p(::apache::thrift::stdcxx::function<void(bool const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::map<std::string, image_map_info> & images, const std::string& service_type) = 0;
  virtual void test_connection_p(::apache::thrift::stdcxx::function<void(bool const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const connection& conn, const std::string& service_type) = 0;
  virtual void add_connection_p(::apache::thrift::stdcxx::function<void(bool const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const connection& conn, const std::string& service_type) = 0;
  virtual void remove_connection_p(::apache::thrift::stdcxx::function<void(bool const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& connection_id, const std::string& service_type) = 0;
  virtual void modify_connection_p(::apache::thrift::stdcxx::function<void(bool const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const connection& conn, const std::string& service_type) = 0;
  virtual void enumerate_connections_p(::apache::thrift::stdcxx::function<void(std::vector<connection>  const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& service_type) = 0;
  virtual void get_connection_p(::apache::thrift::stdcxx::function<void(connection const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& connection_id, const std::string& service_type) = 0;
  virtual void get_virtual_host_info_p(::apache::thrift::stdcxx::function<void(virtual_host const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password) = 0;
  virtual void get_virtual_hosts_p(::apache::thrift::stdcxx::function<void(std::vector<virtual_host>  const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password) = 0;
  virtual void get_virtual_machine_detail_p(::apache::thrift::stdcxx::function<void(virtual_machine const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id) = 0;
  ...
  virtual void remove_virtual_machine_snapshot_p(::apache::thrift::stdcxx::function<void(bool const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id, const std::string& snapshot_id) = 0;
  virtual void get_physical_machine_detail_p(::apache::thrift::stdcxx::function<void(physical_machine_info const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& host, const machine_detail_filter::type filter) = 0;
  virtual void get_datacenter_folder_list_p(::apache::thrift::stdcxx::function<void(std::vector<std::string>  const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& datacenter) = 0;
  virtual void verify_packer_to_carrier_p(::apache::thrift::stdcxx::function<void(bool const& _return)> cob, const std::string& packer, const std::string& carrier, const int32_t port, const bool is_ssl) = 0;
  virtual void take_packer_xray_p(::apache::thrift::stdcxx::function<void(std::string const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& host) = 0;
  virtual void get_packer_service_info_p(::apache::thrift::stdcxx::function<void(service_info const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& host) = 0;
  virtual void set_customized_id_p(::apache::thrift::stdcxx::function<void(bool const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& disk_addr, const std::string& disk_id) = 0;
};
...
class service_proxyCobSvIfSingletonFactory : virtual public service_proxyCobSvIfFactory {
 public:
  service_proxyCobSvIfSingletonFactory(const ::apache::thrift::stdcxx::shared_ptr<service_proxyCobSvIf>& iface) : iface_(iface) {}
 ...
 protected:
  ::apache::thrift::stdcxx::shared_ptr<service_proxyCobSvIf> iface_;
};
...
class service_proxyCobSvNull : virtual public service_proxyCobSvIf , virtual public physical_packer_service_proxyCobSvNull {
 public:
  ...
  void create_job_ex_p(::apache::thrift::stdcxx::function<void(job_detail const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& /* session_id */, const std::string& /* job_id */, const create_job_detail& /* create_job */, const std::string& /* service_type */) {
    job_detail _return;
    return cob(_return);
  }
  void get_job_p(::apache::thrift::stdcxx::function<void(job_detail const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& /* session_id */, const std::string& /* job_id */, const std::string& /* service_type */) {
    job_detail _return;
    return cob(_return);
  }
  void interrupt_job_p(::apache::thrift::stdcxx::function<void(bool const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& /* session_id */, const std::string& /* job_id */, const std::string& /* service_type */) {
    bool _return = false;
    return cob(_return);
  }
  void resume_job_p(::apache::thrift::stdcxx::function<void(bool const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& /* session_id */, const std::string& /* job_id */, const std::string& /* service_type */) {
    bool _return = false;
    return cob(_return);
  }
  void remove_job_p(::apache::thrift::stdcxx::function<void(bool const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& /* session_id */, const std::string& /* job_id */, const std::string& /* service_type */) {
    bool _return = false;
    return cob(_return);
  }
  void running_job_p(::apache::thrift::stdcxx::function<void(bool const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& /* session_id */, const std::string& /* job_id */, const std::string& /* service_type */) {
    bool _return = false;
    return cob(_return);
  }
  void update_job_p(::apache::thrift::stdcxx::function<void(bool const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& /* session_id */, const std::string& /* job_id */, const create_job_detail& /* create_job */, const std::string& /* service_type */) {
    bool _return = false;
    return cob(_return);
  }
  void remove_snapshot_image_p(::apache::thrift::stdcxx::function<void(bool const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& /* session_id */, const std::map<std::string, image_map_info> & /* images */, const std::string& /* service_type */) {
    bool _return = false;
    return cob(_return);
  }
  void test_connection_p(::apache::thrift::stdcxx::function<void(bool const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& /* session_id */, const connection& /* conn */, const std::string& /* service_type */) {
    bool _return = false;
    return cob(_return);
  }
  void add_connection_p(::apache::thrift::stdcxx::function<void(bool const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& /* session_id */, const connection& /* conn */, const std::string& /* service_type */) {
    bool _return = false;
    return cob(_return);
  }
  void remove_connection_p(::apache::thrift::stdcxx::function<void(bool const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& /* session_id */, const std::string& /* connection_id */, const std::string& /* service_type */) {
    bool _return = false;
    return cob(_return);
  }
  void modify_connection_p(::apache::thrift::stdcxx::function<void(bool const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& /* session_id */, const connection& /* conn */, const std::string& /* service_type */) {
    bool _return = false;
    return cob(_return);
  }
  void enumerate_connections_p(::apache::thrift::stdcxx::function<void(std::vector<connection>  const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& /* session_id */, const std::string& /* service_type */) {
    std::vector<connection>  _return;
    return cob(_return);
  }
  void get_connection_p(::apache::thrift::stdcxx::function<void(connection const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& /* session_id */, const std::string& /* connection_id */, const std::string& /* service_type */) {
    connection _return;
    return cob(_return);
  }
  void get_virtual_host_info_p(::apache::thrift::stdcxx::function<void(virtual_host const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& /* session_id */, const std::string& /* host */, const std::string& /* username */, const std::string& /* password */) {
    virtual_host _return;
    return cob(_return);
  }
  void get_virtual_hosts_p(::apache::thrift::stdcxx::function<void(std::vector<virtual_host>  const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& /* session_id */, const std::string& /* host */, const std::string& /* username */, const std::string& /* password */) {
  ...
  void power_off_virtual_machine_p(::apache::thrift::stdcxx::function<void(bool const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& /* session_id */, const std::string& /* host */, const std::string& /* username */, const std::string& /* password */, const std::string& /* machine_id */) {
    bool _return = false;
    return cob(_return);
  }
  void remove_virtual_machine_p(::apache::thrift::stdcxx::function<void(bool const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& /* session_id */, const std::string& /* host */, const std::string& /* username */, const std::string& /* password */, const std::string& /* machine_id */) {
    bool _return = false;
    return cob(_return);
  }
  ...
  void get_physical_machine_detail_p(::apache::thrift::stdcxx::function<void(physical_machine_info const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& /* session_id */, const std::string& /* host */, const machine_detail_filter::type /* filter */) {
  ...
  void verify_packer_to_carrier_p(::apache::thrift::stdcxx::function<void(bool const& _return)> cob, const std::string& /* packer */, const std::string& /* carrier */, const int32_t /* port */, const bool /* is_ssl */) {
    bool _return = false;
    return cob(_return);
  }
  void take_packer_xray_p(::apache::thrift::stdcxx::function<void(std::string const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& /* session_id */, const std::string& /* host */) {
    std::string _return;
    return cob(_return);
  }
  void get_packer_service_info_p(::apache::thrift::stdcxx::function<void(service_info const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& /* session_id */, const std::string& /* host */) {
    service_info _return;
    return cob(_return);
  }
  void set_customized_id_p(::apache::thrift::stdcxx::function<void(bool const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& /* session_id */, const std::string& /* disk_addr */, const std::string& /* disk_id */) {
    bool _return = false;
    return cob(_return);
  }
};
...
class service_proxyCobClient : virtual public service_proxyCobClIf, public physical_packer_service_proxyCobClient {
 public:
  service_proxyCobClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::async::TAsyncChannel> channel, ::apache::thrift::protocol::TProtocolFactory* protocolFactory) :
  ...
  void create_job_ex_p(::apache::thrift::stdcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& job_id, const create_job_detail& create_job, const std::string& service_type);
  void send_create_job_ex_p(const std::string& session_id, const std::string& job_id, const create_job_detail& create_job, const std::string& service_type);
  void recv_create_job_ex_p(job_detail& _return);
  void get_job_p(::apache::thrift::stdcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& job_id, const std::string& service_type);
  void send_get_job_p(const std::string& session_id, const std::string& job_id, const std::string& service_type);
  void recv_get_job_p(job_detail& _return);
  void interrupt_job_p(::apache::thrift::stdcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& job_id, const std::string& service_type);
  void send_interrupt_job_p(const std::string& session_id, const std::string& job_id, const std::string& service_type);
  bool recv_interrupt_job_p();
  void resume_job_p(::apache::thrift::stdcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& job_id, const std::string& service_type);
  void send_resume_job_p(const std::string& session_id, const std::string& job_id, const std::string& service_type);
  bool recv_resume_job_p();
  void remove_job_p(::apache::thrift::stdcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& job_id, const std::string& service_type);
  void send_remove_job_p(const std::string& session_id, const std::string& job_id, const std::string& service_type);
  bool recv_remove_job_p();
  void running_job_p(::apache::thrift::stdcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& job_id, const std::string& service_type);
  void send_running_job_p(const std::string& session_id, const std::string& job_id, const std::string& service_type);
  bool recv_running_job_p();
  void update_job_p(::apache::thrift::stdcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& job_id, const create_job_detail& create_job, const std::string& service_type);
  void send_update_job_p(const std::string& session_id, const std::string& job_id, const create_job_detail& create_job, const std::string& service_type);
  bool recv_update_job_p();
  void remove_snapshot_image_p(::apache::thrift::stdcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const std::map<std::string, image_map_info> & images, const std::string& service_type);
  void send_remove_snapshot_image_p(const std::string& session_id, const std::map<std::string, image_map_info> & images, const std::string& service_type);
  bool recv_remove_snapshot_image_p();
  void test_connection_p(::apache::thrift::stdcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const connection& conn, const std::string& service_type);
  void send_test_connection_p(const std::string& session_id, const connection& conn, const std::string& service_type);
  bool recv_test_connection_p();
  void add_connection_p(::apache::thrift::stdcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const connection& conn, const std::string& service_type);
  void send_add_connection_p(const std::string& session_id, const connection& conn, const std::string& service_type);
  bool recv_add_connection_p();
  void remove_connection_p(::apache::thrift::stdcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& connection_id, const std::string& service_type);
  void send_remove_connection_p(const std::string& session_id, const std::string& connection_id, const std::string& service_type);
  bool recv_remove_connection_p();
  void modify_connection_p(::apache::thrift::stdcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const connection& conn, const std::string& service_type);
  void send_modify_connection_p(const std::string& session_id, const connection& conn, const std::string& service_type);
  bool recv_modify_connection_p();
  void enumerate_connections_p(::apache::thrift::stdcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& service_type);
  void send_enumerate_connections_p(const std::string& session_id, const std::string& service_type);
  void recv_enumerate_connections_p(std::vector<connection> & _return);
  void get_connection_p(::apache::thrift::stdcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& connection_id, const std::string& service_type);
  void send_get_connection_p(const std::string& session_id, const std::string& connection_id, const std::string& service_type);
  void recv_get_connection_p(connection& _return);
  void get_virtual_host_info_p(::apache::thrift::stdcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password);
  void send_get_virtual_host_info_p(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password);
  void recv_get_virtual_host_info_p(virtual_host& _return);
  void get_virtual_hosts_p(::apache::thrift::stdcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password);
  void send_get_virtual_hosts_p(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password);
  void recv_get_virtual_hosts_p(std::vector<virtual_host> & _return);
  void get_virtual_machine_detail_p(::apache::thrift::stdcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id);
  void send_get_virtual_machine_detail_p(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id);
  void recv_get_virtual_machine_detail_p(virtual_machine& _return);
  void power_off_virtual_machine_p(::apache::thrift::stdcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id);
  void send_power_off_virtual_machine_p(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id);
  bool recv_power_off_virtual_machine_p();
  void remove_virtual_machine_p(::apache::thrift::stdcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id);
  void send_remove_virtual_machine_p(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id);
  bool recv_remove_virtual_machine_p();
  void get_virtual_machine_snapshots_p(::apache::thrift::stdcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id);
  void send_get_virtual_machine_snapshots_p(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id);
  void recv_get_virtual_machine_snapshots_p(std::vector<vmware_snapshot> & _return);
  void remove_virtual_machine_snapshot_p(::apache::thrift::stdcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id, const std::string& snapshot_id);
  void send_remove_virtual_machine_snapshot_p(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id, const std::string& snapshot_id);
  bool recv_remove_virtual_machine_snapshot_p();
  void get_physical_machine_detail_p(::apache::thrift::stdcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& host, const machine_detail_filter::type filter);
  void send_get_physical_machine_detail_p(const std::string& session_id, const std::string& host, const machine_detail_filter::type filter);
  void recv_get_physical_machine_detail_p(physical_machine_info& _return);
  void get_datacenter_folder_list_p(::apache::thrift::stdcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& datacenter);
  void send_get_datacenter_folder_list_p(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& datacenter);
  void recv_get_datacenter_folder_list_p(std::vector<std::string> & _return);
  void verify_packer_to_carrier_p(::apache::thrift::stdcxx::function<void(service_proxyCobClient* client)> cob, const std::string& packer, const std::string& carrier, const int32_t port, const bool is_ssl);
  void send_verify_packer_to_carrier_p(const std::string& packer, const std::string& carrier, const int32_t port, const bool is_ssl);
  bool recv_verify_packer_to_carrier_p();
  void take_packer_xray_p(::apache::thrift::stdcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& host);
  void send_take_packer_xray_p(const std::string& session_id, const std::string& host);
  void recv_take_packer_xray_p(std::string& _return);
  void get_packer_service_info_p(::apache::thrift::stdcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& host);
  void send_get_packer_service_info_p(const std::string& session_id, const std::string& host);
  void recv_get_packer_service_info_p(service_info& _return);
  void set_customized_id_p(::apache::thrift::stdcxx::function<void(service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& disk_addr, const std::string& disk_id);
  void send_set_customized_id_p(const std::string& session_id, const std::string& disk_addr, const std::string& disk_id);
  bool recv_set_customized_id_p();
};
...
class service_proxyAsyncProcessor : public physical_packer_service_proxyAsyncProcessor {
 ...
 private:
  typedef  void (service_proxyAsyncProcessor::*ProcessFunction)(::apache::thrift::stdcxx::function<void(bool ok)>, int32_t, ::apache::thrift::protocol::TProtocol*, ::apache::thrift::protocol::TProtocol*);
  typedef std::map<std::string, ProcessFunction> ProcessMap;
  ProcessMap processMap_;
 ...
 public:
  service_proxyAsyncProcessor(::apache::thrift::stdcxx::shared_ptr<service_proxyCobSvIf> iface) :
    ...
    processMap_["get_virtual_hosts_p"] = &service_proxyAsyncProcessor::process_get_virtual_hosts_p;
    processMap_["get_virtual_machine_detail_p"] = &service_proxyAsyncProcessor::process_get_virtual_machine_detail_p;
    processMap_["power_off_virtual_machine_p"] = &service_proxyAsyncProcessor::process_power_off_virtual_machine_p;
    processMap_["remove_virtual_machine_p"] = &service_proxyAsyncProcessor::process_remove_virtual_machine_p;
    processMap_["get_virtual_machine_snapshots_p"] = &service_proxyAsyncProcessor::process_get_virtual_machine_snapshots_p;
    processMap_["remove_virtual_machine_snapshot_p"] = &service_proxyAsyncProcessor::process_remove_virtual_machine_snapshot_p;
    processMap_["get_physical_machine_detail_p"] = &service_proxyAsyncProcessor::process_get_physical_machine_detail_p;
    processMap_["get_datacenter_folder_list_p"] = &service_proxyAsyncProcessor::process_get_datacenter_folder_list_p;
...
class service_proxyAsyncProcessorFactory : public ::apache::thrift::async::TAsyncProcessorFactory {
 public:
  service_proxyAsyncProcessorFactory(const ::apache::thrift::stdcxx::shared_ptr< service_proxyCobSvIfFactory >& handlerFactory) :
      handlerFactory_(handlerFactory) {}
 ...
 protected:
  ::apache::thrift::stdcxx::shared_ptr< service_proxyCobSvIfFactory > handlerFactory_;
};
