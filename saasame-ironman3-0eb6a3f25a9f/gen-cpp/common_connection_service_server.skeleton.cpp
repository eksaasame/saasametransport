...
int main(int argc, char **argv) {
  int port = 9090;
  ::apache::thrift::stdcxx::shared_ptr<common_connection_serviceHandler> handler(new common_connection_serviceHandler());
  ::apache::thrift::stdcxx::shared_ptr<TProcessor> processor(new common_connection_serviceProcessor(handler));
