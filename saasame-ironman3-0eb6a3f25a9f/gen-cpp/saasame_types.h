...
extern const std::map<int, const char*> _hv_controller_type_VALUES_TO_NAMES;
...
extern const std::map<int, const char*> _recovery_type_VALUES_TO_NAMES;
...
typedef struct _physical_machine_info__isset {
  ...
  bool is_winpe :1;
  bool system_default_ui_language :1;
...
class physical_machine_info : public virtual ::apache::thrift::TBase {
 public:
  ...
  bool is_winpe;
  int16_t system_default_ui_language;
  ...
  void __set_system_default_ui_language(const int16_t val);
  ...
  bool operator == (const physical_machine_info & rhs) const
  {
    ...
    if (__isset.is_winpe != rhs.__isset.is_winpe)
      ...
      return false;
    if (__isset.system_default_ui_language != rhs.__isset.system_default_ui_language)
      return false;
    else if (__isset.system_default_ui_language && !(system_default_ui_language == rhs.system_default_ui_language))
      return false;
    return true;
  }
  bool operator != (const physical_machine_info &rhs) const {
...
typedef struct _virtual_host__isset {
  ...
  bool uuid :1;
  bool number_of_cpu_cores :1;
  bool number_of_cpu_packages :1;
  bool size_of_memory :1;
  bool number_of_cpu_threads :1;
...
class virtual_host : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual_host() : name_ref(""), name(""), ip_address(""), product_name(""), version(""), power_state((hv_host_power_state::type)0), state(""), in_maintenance_mode(false), datacenter_name(""), domain_name(""), cluster_key(""), full_name(""), connection_type((hv_connection_type::type)0), virtual_center_name(), virtual_center_version(), uuid(), number_of_cpu_cores(0), number_of_cpu_packages(0), size_of_memory(0LL), number_of_cpu_threads(0) {
  ...
  std::string uuid;
  int16_t number_of_cpu_cores;
  int16_t number_of_cpu_packages;
  int64_t size_of_memory;
  int16_t number_of_cpu_threads;
  ...
  void __set_number_of_cpu_cores(const int16_t val);

  void __set_number_of_cpu_packages(const int16_t val);

  void __set_size_of_memory(const int64_t val);

  void __set_number_of_cpu_threads(const int16_t val);
  ...
  bool operator == (const virtual_host & rhs) const
  {
    ...
    if (__isset.uuid != rhs.__isset.uuid)
      ...
      return false;
    if (__isset.number_of_cpu_cores != rhs.__isset.number_of_cpu_cores)
      return false;
    else if (__isset.number_of_cpu_cores && !(number_of_cpu_cores == rhs.number_of_cpu_cores))
      return false;
    if (__isset.number_of_cpu_packages != rhs.__isset.number_of_cpu_packages)
      return false;
    else if (__isset.number_of_cpu_packages && !(number_of_cpu_packages == rhs.number_of_cpu_packages))
      return false;
    if (__isset.size_of_memory != rhs.__isset.size_of_memory)
      return false;
    else if (__isset.size_of_memory && !(size_of_memory == rhs.size_of_memory))
      return false;
    if (__isset.number_of_cpu_threads != rhs.__isset.number_of_cpu_threads)
      return false;
    else if (__isset.number_of_cpu_threads && !(number_of_cpu_threads == rhs.number_of_cpu_threads))
      return false;
    return true;
  }
  bool operator != (const virtual_host &rhs) const {
...
typedef struct _virtual_disk_info__isset {
  _virtual_disk_info__isset() : key(true), name(true), id(true), size_kb(true), size(true), controller_type(true), thin_provisioned(true) {}
  bool key :1;
  bool name :1;
  bool id :1;
  bool size_kb :1;
  bool size :1;
  bool controller_type :1;
  bool thin_provisioned :1;
...
class virtual_disk_info : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual_disk_info() : key(""), name(""), id(""), size_kb(0LL), size(0LL), controller_type((hv_controller_type::type)-1), thin_provisioned(false) {
    controller_type = (hv_controller_type::type)-1;
  ...
  int64_t size_kb;
  int64_t size;
  hv_controller_type::type controller_type;
  ...
  void __set_controller_type(const hv_controller_type::type val);

  void __set_thin_provisioned(const bool val);
  ...
  bool operator == (const virtual_disk_info & rhs) const
  {
    ...
    if (__isset.size != rhs.__isset.size)
      ...
      return false;
    if (__isset.controller_type != rhs.__isset.controller_type)
      return false;
    else if (__isset.controller_type && !(controller_type == rhs.controller_type))
      return false;
    if (__isset.thin_provisioned != rhs.__isset.thin_provisioned)
      return false;
    else if (__isset.thin_provisioned && !(thin_provisioned == rhs.thin_provisioned))
      return false;
    return true;
  }
  bool operator != (const virtual_disk_info &rhs) const {
...
class virtual_machine : public virtual ::apache::thrift::TBase {
 public:
  ...
  void __set_has_cdrom(const bool val);
  ...
  bool operator == (const virtual_machine & rhs) const
  {
    ...
    if (__isset.guest_ip != rhs.__isset.guest_ip)
      ...
      return false;
    if (__isset.has_cdrom != rhs.__isset.has_cdrom)
      return false;
    else if (__isset.has_cdrom && !(has_cdrom == rhs.has_cdrom))
      return false;
    return true;
  }
  bool operator != (const virtual_machine &rhs) const {
...
typedef struct _virtual_partition_info__isset {
  _virtual_partition_info__isset() : partition_number(true), offset(true), size(true) {}
  bool partition_number :1;
  bool offset :1;
  bool size :1;
} _virtual_partition_info__isset;

class virtual_partition_info : public virtual ::apache::thrift::TBase {
 public:

  virtual_partition_info(const virtual_partition_info&);
  virtual_partition_info& operator=(const virtual_partition_info&);
  virtual_partition_info() : partition_number(0), offset(0LL), size(0LL) {
  }

  virtual ~virtual_partition_info() throw();
  int32_t partition_number;
  int64_t offset;
  int64_t size;

  _virtual_partition_info__isset __isset;
  ...
  bool operator == (const virtual_partition_info & rhs) const
  {
    if (__isset.partition_number != rhs.__isset.partition_number)
      return false;
    else if (__isset.partition_number && !(partition_number == rhs.partition_number))
  ...
  bool operator < (const virtual_partition_info & ) const;
...
typedef struct _virtual_disk_info_ex__isset {
  _virtual_disk_info_ex__isset() : id(true), size(true), partition_style(true), guid(true), signature(true), is_system(true), partitions(false) {}
  bool id :1;
  bool size :1;
  bool partition_style :1;
  bool guid :1;
  ...
  bool is_system :1;
  bool partitions :1;
} _virtual_disk_info_ex__isset;

class virtual_disk_info_ex : public virtual ::apache::thrift::TBase {
 public:

  virtual_disk_info_ex(const virtual_disk_info_ex&);
  virtual_disk_info_ex& operator=(const virtual_disk_info_ex&);
  virtual_disk_info_ex() : id(""), size(0LL), partition_style((partition_style::type)0), guid(""), signature(0), is_system(false) {
    partition_style = (partition_style::type)0;

  }

  virtual ~virtual_disk_info_ex() throw();
  std::string id;
  int64_t size;
  partition_style::type partition_style;
  std::string guid;
  int32_t signature;
  bool is_system;
  std::set<virtual_partition_info>  partitions;

  _virtual_disk_info_ex__isset __isset;
  ...
  void __set_partitions(const std::set<virtual_partition_info> & val);

  bool operator == (const virtual_disk_info_ex & rhs) const
  {
    if (__isset.id != rhs.__isset.id)
      return false;
    else if (__isset.id && !(id == rhs.id))
  ...
  bool operator < (const virtual_disk_info_ex & ) const;
...
typedef struct _physical_create_packer_job_detail__isset {
  _physical_create_packer_job_detail__isset() : disks(false), snapshots(false), previous_journals(false), images(false), backup_size(false), backup_progress(false), backup_image_offset(false), cdr_journals(false), cdr_changed_ranges(false), completed_blocks(false), excluded_paths(false), resync_paths(false) {}
  bool disks :1;
  bool snapshots :1;
...
class physical_create_packer_job_detail : public virtual ::apache::thrift::TBase {
 public:
  ...
  std::set<std::string>  resync_paths;
  ...
  void __set_excluded_paths(const std::set<std::string> & val);

  void __set_resync_paths(const std::set<std::string> & val);
  ...
  bool operator == (const physical_create_packer_job_detail & rhs) const
  {
    ...
    if (__isset.completed_blocks != rhs.__isset.completed_blocks)
      ...
      return false;
    if (__isset.excluded_paths != rhs.__isset.excluded_paths)
      return false;
    else if (__isset.excluded_paths && !(excluded_paths == rhs.excluded_paths))
      return false;
    if (__isset.resync_paths != rhs.__isset.resync_paths)
      return false;
    else if (__isset.resync_paths && !(resync_paths == rhs.resync_paths))
      return false;
    return true;
  }
  bool operator != (const physical_create_packer_job_detail &rhs) const {
...
class create_packer_job_detail : public virtual ::apache::thrift::TBase {
 public:
  ...
  std::map<std::string, std::string>  checksum_target;
  ...
  void __set_checksum_target(const std::map<std::string, std::string> & val);
  ...
  bool operator == (const create_packer_job_detail & rhs) const
  {
    ...
    if (__isset.is_compressed_by_packer != rhs.__isset.is_compressed_by_packer)
      ...
      return false;
    if (__isset.checksum_target != rhs.__isset.checksum_target)
      return false;
    else if (__isset.checksum_target && !(checksum_target == rhs.checksum_target))
      return false;
    return true;
  }
  bool operator != (const create_packer_job_detail &rhs) const {
...
typedef struct _virtual_packer_job_detail__isset {
  _virtual_packer_job_detail__isset() : original_size(false), backup_size(false), backup_progress(false), backup_image_offset(false), change_ids(false), guest_os_type(true), completed_blocks(false), disk_infos(false) {}
...
class virtual_packer_job_detail : public virtual ::apache::thrift::TBase {
 public:
  ...
  hv_guest_os_type::type guest_os_type;
  std::map<std::string, std::vector<io_changed_range> >  completed_blocks;
  std::vector<virtual_disk_info_ex>  disk_infos;
  ...
  void __set_disk_infos(const std::vector<virtual_disk_info_ex> & val);
...
class replica_job_detail : public virtual ::apache::thrift::TBase {
 public:
  ...
  bool is_cdr;
  std::vector<virtual_disk_info_ex>  virtual_disk_infos;
  std::set<std::string>  excluded_paths;
  ...
  void __set_virtual_disk_infos(const std::vector<virtual_disk_info_ex> & val);
  ...
  bool operator == (const replica_job_detail & rhs) const
  {
    ...
    if (__isset.is_cdr != rhs.__isset.is_cdr)
      ...
      return false;
    if (__isset.virtual_disk_infos != rhs.__isset.virtual_disk_infos)
      return false;
    else if (__isset.virtual_disk_infos && !(virtual_disk_infos == rhs.virtual_disk_infos))
      return false;
    if (__isset.excluded_paths != rhs.__isset.excluded_paths)
      return false;
    else if (__isset.excluded_paths && !(excluded_paths == rhs.excluded_paths))
...
typedef struct _vmware_snapshot__isset {
  _vmware_snapshot__isset() : id(true), name(true), datetime(true) {}
  bool id :1;
  bool name :1;
  bool datetime :1;
} _vmware_snapshot__isset;

class vmware_snapshot : public virtual ::apache::thrift::TBase {
 public:

  vmware_snapshot(const vmware_snapshot&);
  vmware_snapshot& operator=(const vmware_snapshot&);
  vmware_snapshot() : id(""), name(""), datetime("") {
  }

  virtual ~vmware_snapshot() throw();
  std::string id;
  std::string name;
  std::string datetime;

  _vmware_snapshot__isset __isset;
  ...
  bool operator == (const vmware_snapshot & rhs) const
  {
    if (__isset.id != rhs.__isset.id)
      return false;
    else if (__isset.id && !(id == rhs.id))
  ...
  bool operator < (const vmware_snapshot & ) const;
...
typedef struct _take_snapshots_parameters__isset {
  _take_snapshots_parameters__isset() : disks(false), pre_script(false), post_script(false), excluded_paths(false) {}
  bool disks :1;
  bool pre_script :1;
  bool post_script :1;
  bool excluded_paths :1;
} _take_snapshots_parameters__isset;

class take_snapshots_parameters : public virtual ::apache::thrift::TBase {
 public:

  take_snapshots_parameters(const take_snapshots_parameters&);
  take_snapshots_parameters& operator=(const take_snapshots_parameters&);
  take_snapshots_parameters() : pre_script(), post_script() {
  }

  virtual ~take_snapshots_parameters() throw();
  std::set<std::string>  disks;
  std::string pre_script;
  std::string post_script;
  std::set<std::string>  excluded_paths;

  _take_snapshots_parameters__isset __isset;
  ...
  bool operator == (const take_snapshots_parameters & rhs) const
  {
    if (!(disks == rhs.disks))
      return false;
    ...
    if (!(post_script == rhs.post_script))
      return false;
    if (!(excluded_paths == rhs.excluded_paths))
      return false;
    return true;
  }
  bool operator != (const take_snapshots_parameters &rhs) const {
  ...
  bool operator < (const take_snapshots_parameters & ) const;
...
typedef struct _launcher_job_detail__isset {
  _launcher_job_detail__isset() : replica_id(true), id(true), state(true), created_time(true), updated_time(true), boot_disk(true), histories(false), is_error(true), is_windows_update(true), platform(true), architecture(true), size(true), progress(true), vhd_size(true), upload_id(true), host_name(true), vhd_upload_progress(false), virtual_machine_id(true) {}
  bool replica_id :1;
  bool id :1;
  bool state :1;
  bool created_time :1;
...
class launcher_job_detail : public virtual ::apache::thrift::TBase {
 public:
  ...
  launcher_job_detail() : replica_id(""), id(""), state((job_state::type)1), created_time(""), updated_time(""), boot_disk(""), is_error(false), is_windows_update(false), platform(""), architecture(""), size(0LL), progress(0LL), vhd_size(0LL), upload_id(""), host_name(""), virtual_machine_id("") {
    state = (job_state::type)1;
...
typedef struct _replica_job_create_detail__isset {
  ...
  bool is_compressed_by_packer :1;
  bool excluded_paths :1;
  bool previous_excluded_paths :1;
  bool checksum_target :1;
...
class replica_job_create_detail : public virtual ::apache::thrift::TBase {
 public:
  ...
  bool is_compressed_by_packer;
  std::set<std::string>  excluded_paths;
  std::set<std::string>  previous_excluded_paths;
  std::map<std::string, std::string>  checksum_target;
  ...
  void __set_previous_excluded_paths(const std::set<std::string> & val);
  ...
  bool operator == (const replica_job_create_detail & rhs) const
  {
    ...
    if (__isset.excluded_paths != rhs.__isset.excluded_paths)
      ...
      return false;
    if (__isset.previous_excluded_paths != rhs.__isset.previous_excluded_paths)
      return false;
    else if (__isset.previous_excluded_paths && !(previous_excluded_paths == rhs.previous_excluded_paths))
      return false;
    if (__isset.checksum_target != rhs.__isset.checksum_target)
      return false;
    else if (__isset.checksum_target && !(checksum_target == rhs.checksum_target))
...
typedef struct _vmware_connection_info__isset {
  _vmware_connection_info__isset() : host(true), username(true), password(true), esx(true), datastore(true), folder_path(true) {}
  bool host :1;
  bool username :1;
  bool password :1;
  bool esx :1;
  bool datastore :1;
  bool folder_path :1;
} _vmware_connection_info__isset;

class vmware_connection_info : public virtual ::apache::thrift::TBase {
 public:

  vmware_connection_info(const vmware_connection_info&);
  vmware_connection_info& operator=(const vmware_connection_info&);
  vmware_connection_info() : host(""), username(""), password(""), esx(""), datastore(""), folder_path("") {
  }

  virtual ~vmware_connection_info() throw();
  std::string host;
  std::string username;
  std::string password;
  std::string esx;
  ...
  _vmware_connection_info__isset __isset;
  ...
  void __set_esx(const std::string& val);

  void __set_datastore(const std::string& val);

  void __set_folder_path(const std::string& val);

  bool operator == (const vmware_connection_info & rhs) const
  {
    if (__isset.host != rhs.__isset.host)
      return false;
    else if (__isset.host && !(host == rhs.host))
    ...
    if (__isset.password != rhs.__isset.password)
      ...
      return false;
    if (__isset.esx != rhs.__isset.esx)
      return false;
    else if (__isset.esx && !(esx == rhs.esx))
      return false;
    if (__isset.datastore != rhs.__isset.datastore)
      return false;
    else if (__isset.datastore && !(datastore == rhs.datastore))
      return false;
    if (__isset.folder_path != rhs.__isset.folder_path)
      return false;
    else if (__isset.folder_path && !(folder_path == rhs.folder_path))
  ...
  bool operator < (const vmware_connection_info & ) const;
...
typedef struct _vmware_options__isset {
  _vmware_options__isset() : connection(false), virtual_machine_id(true), virtual_machine_snapshot(true), number_of_cpus(true), number_of_memory_in_mb(true), vm_name(false), network_connections(false), network_adapters(false), scsi_adapters(false), guest_id(false), firmware(true), install_vm_tools(true), mac_addresses(false) {}
  bool connection :1;
  bool virtual_machine_id :1;
  bool virtual_machine_snapshot :1;
  bool number_of_cpus :1;
  bool number_of_memory_in_mb :1;
  bool vm_name :1;
  bool network_connections :1;
  bool network_adapters :1;
  bool scsi_adapters :1;
  bool guest_id :1;
  bool firmware :1;
  bool install_vm_tools :1;
  bool mac_addresses :1;
} _vmware_options__isset;

class vmware_options : public virtual ::apache::thrift::TBase {
 public:

  vmware_options(const vmware_options&);
  vmware_options& operator=(const vmware_options&);
  vmware_options() : virtual_machine_id(""), virtual_machine_snapshot(""), number_of_cpus(1), number_of_memory_in_mb(1024), vm_name(), guest_id(), firmware((hv_vm_firmware::type)0), install_vm_tools(true) {
    firmware = (hv_vm_firmware::type)0;

  }

  virtual ~vmware_options() throw();
  vmware_connection_info connection;
  std::string virtual_machine_id;
  std::string virtual_machine_snapshot;
  int32_t number_of_cpus;
  int32_t number_of_memory_in_mb;
  std::string vm_name;
  std::vector<std::string>  network_connections;
  std::vector<std::string>  network_adapters;
  std::map<hv_controller_type::type, std::vector<std::string> >  scsi_adapters;
  std::string guest_id;
  hv_vm_firmware::type firmware;
  bool install_vm_tools;
  std::vector<std::string>  mac_addresses;

  _vmware_options__isset __isset;

  void __set_connection(const vmware_connection_info& val);

  void __set_virtual_machine_id(const std::string& val);

  void __set_virtual_machine_snapshot(const std::string& val);

  void __set_number_of_cpus(const int32_t val);

  void __set_number_of_memory_in_mb(const int32_t val);

  void __set_vm_name(const std::string& val);

  void __set_network_connections(const std::vector<std::string> & val);

  void __set_network_adapters(const std::vector<std::string> & val);

  void __set_scsi_adapters(const std::map<hv_controller_type::type, std::vector<std::string> > & val);

  void __set_guest_id(const std::string& val);

  void __set_firmware(const hv_vm_firmware::type val);

  void __set_install_vm_tools(const bool val);

  void __set_mac_addresses(const std::vector<std::string> & val);

  bool operator == (const vmware_options & rhs) const
  {
    if (__isset.connection != rhs.__isset.connection)
      return false;
    else if (__isset.connection && !(connection == rhs.connection))
      return false;
    if (__isset.virtual_machine_id != rhs.__isset.virtual_machine_id)
      return false;
    else if (__isset.virtual_machine_id && !(virtual_machine_id == rhs.virtual_machine_id))
      return false;
    if (__isset.virtual_machine_snapshot != rhs.__isset.virtual_machine_snapshot)
      return false;
    else if (__isset.virtual_machine_snapshot && !(virtual_machine_snapshot == rhs.virtual_machine_snapshot))
      return false;
    if (__isset.number_of_cpus != rhs.__isset.number_of_cpus)
      return false;
    else if (__isset.number_of_cpus && !(number_of_cpus == rhs.number_of_cpus))
      return false;
    if (__isset.number_of_memory_in_mb != rhs.__isset.number_of_memory_in_mb)
      return false;
    else if (__isset.number_of_memory_in_mb && !(number_of_memory_in_mb == rhs.number_of_memory_in_mb))
      return false;
    if (__isset.vm_name != rhs.__isset.vm_name)
      return false;
    else if (__isset.vm_name && !(vm_name == rhs.vm_name))
      return false;
    if (__isset.network_connections != rhs.__isset.network_connections)
      return false;
    else if (__isset.network_connections && !(network_connections == rhs.network_connections))
      return false;
    if (__isset.network_adapters != rhs.__isset.network_adapters)
      return false;
    else if (__isset.network_adapters && !(network_adapters == rhs.network_adapters))
      return false;
    if (__isset.scsi_adapters != rhs.__isset.scsi_adapters)
      return false;
    else if (__isset.scsi_adapters && !(scsi_adapters == rhs.scsi_adapters))
      return false;
    if (__isset.guest_id != rhs.__isset.guest_id)
      return false;
    else if (__isset.guest_id && !(guest_id == rhs.guest_id))
    ...
    if (__isset.firmware != rhs.__isset.firmware)
      ...
      return false;
    if (__isset.install_vm_tools != rhs.__isset.install_vm_tools)
      return false;
    else if (__isset.install_vm_tools && !(install_vm_tools == rhs.install_vm_tools))
      return false;
    if (__isset.mac_addresses != rhs.__isset.mac_addresses)
      return false;
    else if (__isset.mac_addresses && !(mac_addresses == rhs.mac_addresses))
      return false;
    return true;
  }
  bool operator != (const vmware_options &rhs) const {
  ...
  bool operator < (const vmware_options & ) const;
...
typedef struct _cascading__isset {
  _cascading__isset() : level(true), machine_id(true), connection_info(false), branches(false) {}
  bool level :1;
  bool machine_id :1;
  bool connection_info :1;
  bool branches :1;
} _cascading__isset;

class cascading : public virtual ::apache::thrift::TBase {
 public:

  cascading(const cascading&);
  cascading& operator=(const cascading&);
  cascading() : level(0), machine_id("") {
  }

  virtual ~cascading() throw();
  int32_t level;
  std::string machine_id;
  connection connection_info;
  std::map<std::string, cascading>  branches;

  _cascading__isset __isset;

  void __set_level(const int32_t val);

  void __set_machine_id(const std::string& val);

  void __set_connection_info(const connection& val);

  void __set_branches(const std::map<std::string, cascading> & val);
  ...
  bool operator == (const cascading & rhs) const
  {
    ...
    if (__isset.machine_id != rhs.__isset.machine_id)
      ...
      return false;
    if (__isset.connection_info != rhs.__isset.connection_info)
      return false;
    else if (__isset.connection_info && !(connection_info == rhs.connection_info))
      return false;
    if (__isset.branches != rhs.__isset.branches)
      return false;
    else if (__isset.branches && !(branches == rhs.branches))
      return false;
    return true;
  }
  bool operator != (const cascading &rhs) const {
  ...
  bool operator < (const cascading & ) const;
...
class loader_job_create_detail : public virtual ::apache::thrift::TBase {
 public:
  ...
  loader_job_create_detail() : replica_id(""), connection_id(), block_mode_enable(false), purge_data(true), remap(false), detect_type((disk_detect_type::type)0), worker_thread_number(0), host_name(""), export_disk_type((virtual_disk_type::type)0), export_path(""), keep_alive(true), time(""), is_continuous_data_replication(false), azure_storage_connection_string(""), thin_provisioned(true), is_paused(false), post_snapshot_script() {
  ...
  vmware_connection_info vmware_connection;
  bool thin_provisioned;
  bool is_paused;
  cascading cascadings;
  std::string post_snapshot_script;
  std::vector<std::string>  disks_order;
  ...
  void __set_vmware_connection(const vmware_connection_info& val);

  void __set_thin_provisioned(const bool val);

  void __set_is_paused(const bool val);

  void __set_cascadings(const cascading& val);

  void __set_post_snapshot_script(const std::string& val);

  void __set_disks_order(const std::vector<std::string> & val);
  ...
  bool operator == (const loader_job_create_detail & rhs) const
  {
    ...
    if (__isset.azure_storage_connection_string != rhs.__isset.azure_storage_connection_string)
      ...
      return false;
    if (__isset.vmware_connection != rhs.__isset.vmware_connection)
      return false;
    else if (__isset.vmware_connection && !(vmware_connection == rhs.vmware_connection))
      return false;
    if (__isset.thin_provisioned != rhs.__isset.thin_provisioned)
      return false;
    else if (__isset.thin_provisioned && !(thin_provisioned == rhs.thin_provisioned))
    ...
    if (__isset.is_paused != rhs.__isset.is_paused)
      ...
      return false;
    if (__isset.cascadings != rhs.__isset.cascadings)
      return false;
    else if (__isset.cascadings && !(cascadings == rhs.cascadings))
      return false;
    if (__isset.post_snapshot_script != rhs.__isset.post_snapshot_script)
      return false;
    else if (__isset.post_snapshot_script && !(post_snapshot_script == rhs.post_snapshot_script))
      return false;
    if (__isset.disks_order != rhs.__isset.disks_order)
      return false;
    else if (__isset.disks_order && !(disks_order == rhs.disks_order))
      return false;
    return true;
  }
  bool operator != (const loader_job_create_detail &rhs) const {
...
class launcher_job_create_detail : public virtual ::apache::thrift::TBase {
 public:
  ...
  vmware_options vmware;
  recovery_type::type mode;
  std::string azure_storage_connection_string;
  ...
  void __set_vmware(const vmware_options& val);

  void __set_mode(const recovery_type::type val);
  ...
  bool operator == (const launcher_job_create_detail & rhs) const
  {
    ...
    if (__isset.post_scripts != rhs.__isset.post_scripts)
      ...
      return false;
    if (__isset.vmware != rhs.__isset.vmware)
      return false;
    else if (__isset.vmware && !(vmware == rhs.vmware))
      return false;
    if (__isset.mode != rhs.__isset.mode)
      return false;
    else if (__isset.mode && !(mode == rhs.mode))
