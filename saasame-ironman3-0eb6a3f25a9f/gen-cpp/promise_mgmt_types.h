 ...
 *  @generated
 */
#ifndef promise_mgmt_TYPES_H
#define promise_mgmt_TYPES_H
...
struct error_codes {
  enum type {
    ...
    IRONMAN_E_CANNOT_BRING_DISK_ONLINE = 4103,
    IRONMAN_E_CANNOT_INITIALIZE_DISK = 4104,
    IRONMAN_E_CANNOT_CREATE_PARTITION = 4105,
    IRONMAN_E_CANNOT_FORMAT_PARTITION = 4106,
...
class physical_client_info {
 public:
  ...
  physical_client_info() : architecture(""), client_name(""), domain(""), hal(""), initiator_name(""), is_oem(false), logical_processors(0), manufacturer(""), os_name(""), os_type(0), os_system_info(), physical_memory(0LL), processors(0), role(0), system_model(""), system_root(""), workgroup("") {
  }
...
typedef struct _create_job_detail__isset {
  _create_job_detail__isset() : host(true), username(true), password(true), type(false), select_all(true), disks(false), virtual_machine_id(true), vdisks(false), output_folder(true), output_disk(true) {}
  bool host :1;
  bool username :1;
  bool password :1;
  bool type :1;
...
class create_job_detail {
 public:
  ...
  create_job_detail() : host(""), username(""), password(""), type((job_type::type)0), select_all(false), virtual_machine_id(""), output_folder(""), output_disk("") {
  }
  ...
  void __set_output_folder(const std::string& val);

  void __set_output_disk(const std::string& val);
  ...
  bool operator == (const create_job_detail & rhs) const
  {
    ...
    if (__isset.vdisks != rhs.__isset.vdisks)
      ...
      return false;
    if (__isset.output_folder != rhs.__isset.output_folder)
      return false;
    else if (__isset.output_folder && !(output_folder == rhs.output_folder))
      return false;
    if (__isset.output_disk != rhs.__isset.output_disk)
      return false;
    else if (__isset.output_disk && !(output_disk == rhs.output_disk))
      return false;
    return true;
  }
  bool operator != (const create_job_detail &rhs) const {
...
typedef struct _job_detail__isset {
  _job_detail__isset() : id(true), host(true), username(true), password(true), type(false), disks(false), virtual_machine_id(true), vdisks(false), output_folder(true), state(true), original_size(false), backup_progress(false), output_files(false), what(true), why(true), created_time(true), created_time_ll(true), output_disk(true), system_disk(true), histories(false) {}
  bool id :1;
  bool host :1;
  bool username :1;
  bool password :1;
...
class job_detail {
 public:
  ...
  job_detail() : id(""), host(""), username(""), password(""), type((job_type::type)0), virtual_machine_id(""), output_folder(""), state((job_state::type)1), what(0), why(""), created_time(""), created_time_ll(0LL), output_disk(""), system_disk("") {
    state = (job_state::type)1;
  ...
  void __set_system_disk(const std::string& val);
  ...
  bool operator == (const job_detail & rhs) const
  {
    ...
    if (__isset.output_disk != rhs.__isset.output_disk)
      ...
      return false;
    if (__isset.system_disk != rhs.__isset.system_disk)
      return false;
    else if (__isset.system_disk && !(system_disk == rhs.system_disk))
      return false;
