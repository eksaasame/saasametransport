...
class physical_packer_service_proxyIf : virtual public common_serviceIf {
 public:
  ...
  virtual void take_snapshots2_p(std::vector<snapshot> & _return, const std::string& session_id, const std::string& addr, const take_snapshots_parameters& parameters) = 0;
...
class physical_packer_service_proxyIfSingletonFactory : virtual public physical_packer_service_proxyIfFactory {
 public:
  physical_packer_service_proxyIfSingletonFactory(const ::apache::thrift::stdcxx::shared_ptr<physical_packer_service_proxyIf>& iface) : iface_(iface) {}
 ...
 protected:
  ::apache::thrift::stdcxx::shared_ptr<physical_packer_service_proxyIf> iface_;
};
...
typedef struct _physical_packer_service_proxy_take_snapshots2_p_args__isset {
  _physical_packer_service_proxy_take_snapshots2_p_args__isset() : session_id(false), addr(false), parameters(false) {}
  bool session_id :1;
  bool addr :1;
  bool parameters :1;
} _physical_packer_service_proxy_take_snapshots2_p_args__isset;

class physical_packer_service_proxy_take_snapshots2_p_args {
 public:

  physical_packer_service_proxy_take_snapshots2_p_args(const physical_packer_service_proxy_take_snapshots2_p_args&);
  physical_packer_service_proxy_take_snapshots2_p_args& operator=(const physical_packer_service_proxy_take_snapshots2_p_args&);
  physical_packer_service_proxy_take_snapshots2_p_args() : session_id(), addr() {
  }

  virtual ~physical_packer_service_proxy_take_snapshots2_p_args() throw();
  std::string session_id;
  std::string addr;
  take_snapshots_parameters parameters;

  _physical_packer_service_proxy_take_snapshots2_p_args__isset __isset;
  ...
  bool operator == (const physical_packer_service_proxy_take_snapshots2_p_args & rhs) const
  {
    if (!(session_id == rhs.session_id))
      return false;
    if (!(addr == rhs.addr))
  ...
  bool operator < (const physical_packer_service_proxy_take_snapshots2_p_args & ) const;
...
class physical_packer_service_proxy_take_snapshots2_p_pargs {
 public:


  virtual ~physical_packer_service_proxy_take_snapshots2_p_pargs() throw();
  const std::string* session_id;
  const std::string* addr;
...
typedef struct _physical_packer_service_proxy_take_snapshots2_p_result__isset {
  _physical_packer_service_proxy_take_snapshots2_p_result__isset() : success(false), ouch(false) {}
  bool success :1;
  bool ouch :1;
} _physical_packer_service_proxy_take_snapshots2_p_result__isset;

class physical_packer_service_proxy_take_snapshots2_p_result {
 public:

  physical_packer_service_proxy_take_snapshots2_p_result(const physical_packer_service_proxy_take_snapshots2_p_result&);
  physical_packer_service_proxy_take_snapshots2_p_result& operator=(const physical_packer_service_proxy_take_snapshots2_p_result&);
  physical_packer_service_proxy_take_snapshots2_p_result() {
  }

  virtual ~physical_packer_service_proxy_take_snapshots2_p_result() throw();
  std::vector<snapshot>  success;
  invalid_operation ouch;

  _physical_packer_service_proxy_take_snapshots2_p_result__isset __isset;

  void __set_success(const std::vector<snapshot> & val);

  void __set_ouch(const invalid_operation& val);

  bool operator == (const physical_packer_service_proxy_take_snapshots2_p_result & rhs) const
  {
    if (!(success == rhs.success))
      return false;
    if (!(ouch == rhs.ouch))
  ...
  bool operator < (const physical_packer_service_proxy_take_snapshots2_p_result & ) const;
...
typedef struct _physical_packer_service_proxy_take_snapshots2_p_presult__isset {
  _physical_packer_service_proxy_take_snapshots2_p_presult__isset() : success(false), ouch(false) {}
  bool success :1;
  bool ouch :1;
} _physical_packer_service_proxy_take_snapshots2_p_presult__isset;

class physical_packer_service_proxy_take_snapshots2_p_presult {
 public:


  virtual ~physical_packer_service_proxy_take_snapshots2_p_presult() throw();
  std::vector<snapshot> * success;
  invalid_operation ouch;

  _physical_packer_service_proxy_take_snapshots2_p_presult__isset __isset;
...
class physical_packer_service_proxyClient : virtual public physical_packer_service_proxyIf, public common_serviceClient {
 public:
  physical_packer_service_proxyClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) :
    common_serviceClient(prot, prot) {}
  physical_packer_service_proxyClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) :    common_serviceClient(iprot, oprot) {}
  ...
  void take_snapshots2_p(std::vector<snapshot> & _return, const std::string& session_id, const std::string& addr, const take_snapshots_parameters& parameters);
  void send_take_snapshots2_p(const std::string& session_id, const std::string& addr, const take_snapshots_parameters& parameters);
  void recv_take_snapshots2_p(std::vector<snapshot> & _return);
  void delete_snapshot_p(delete_snapshot_result& _return, const std::string& session_id, const std::string& addr, const std::string& snapshot_id);
...
class physical_packer_service_proxyProcessor : public common_serviceProcessor {
 ...
 private:
  ...
  void process_take_snapshots2_p(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext);
 ...
 public:
  physical_packer_service_proxyProcessor(::apache::thrift::stdcxx::shared_ptr<physical_packer_service_proxyIf> iface) :
    ...
    processMap_["take_snapshots2_p"] = &physical_packer_service_proxyProcessor::process_take_snapshots2_p;
...
class physical_packer_service_proxyProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  physical_packer_service_proxyProcessorFactory(const ::apache::thrift::stdcxx::shared_ptr< physical_packer_service_proxyIfFactory >& handlerFactory) :
      handlerFactory_(handlerFactory) {}

  ::apache::thrift::stdcxx::shared_ptr< ::apache::thrift::TProcessor > getProcessor(const ::apache::thrift::TConnectionInfo& connInfo);

 protected:
  ::apache::thrift::stdcxx::shared_ptr< physical_packer_service_proxyIfFactory > handlerFactory_;
};
...
class physical_packer_service_proxyMultiface : virtual public physical_packer_service_proxyIf, public common_serviceMultiface {
 public:
  physical_packer_service_proxyMultiface(std::vector<apache::thrift::stdcxx::shared_ptr<physical_packer_service_proxyIf> >& ifaces) : ifaces_(ifaces) {
    std::vector<apache::thrift::stdcxx::shared_ptr<physical_packer_service_proxyIf> >::iterator iter;
 ...
 protected:
  std::vector<apache::thrift::stdcxx::shared_ptr<physical_packer_service_proxyIf> > ifaces_;
  physical_packer_service_proxyMultiface() {}
  void add(::apache::thrift::stdcxx::shared_ptr<physical_packer_service_proxyIf> iface) {
 ...
 public:
  ...
  void take_snapshots2_p(std::vector<snapshot> & _return, const std::string& session_id, const std::string& addr, const take_snapshots_parameters& parameters) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->take_snapshots2_p(_return, session_id, addr, parameters);
    }
    ifaces_[i]->take_snapshots2_p(_return, session_id, addr, parameters);
    return;
  }
...
class physical_packer_service_proxyConcurrentClient : virtual public physical_packer_service_proxyIf, public common_serviceConcurrentClient {
 public:
  physical_packer_service_proxyConcurrentClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) :
    common_serviceConcurrentClient(prot, prot) {}
  physical_packer_service_proxyConcurrentClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) :    common_serviceConcurrentClient(iprot, oprot) {}
  apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> getInputProtocol() {
    return piprot_;
  }
  apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> getOutputProtocol() {
  ...
  void take_snapshots2_p(std::vector<snapshot> & _return, const std::string& session_id, const std::string& addr, const take_snapshots_parameters& parameters);
  int32_t send_take_snapshots2_p(const std::string& session_id, const std::string& addr, const take_snapshots_parameters& parameters);
  void recv_take_snapshots2_p(std::vector<snapshot> & _return, const int32_t seqid);
  void delete_snapshot_p(delete_snapshot_result& _return, const std::string& session_id, const std::string& addr, const std::string& snapshot_id);
...
class physical_packer_service_proxyCobClIf : virtual public common_serviceCobClIf {
 public:
  ...
  virtual void packer_ping_p(::apache::thrift::stdcxx::function<void(physical_packer_service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& addr) = 0;
  virtual void take_snapshots_p(::apache::thrift::stdcxx::function<void(physical_packer_service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& addr, const std::set<std::string> & disks) = 0;
  virtual void take_snapshots_ex_p(::apache::thrift::stdcxx::function<void(physical_packer_service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& addr, const std::set<std::string> & disks, const std::string& pre_script, const std::string& post_script) = 0;
  virtual void take_snapshots2_p(::apache::thrift::stdcxx::function<void(physical_packer_service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& addr, const take_snapshots_parameters& parameters) = 0;
  virtual void delete_snapshot_p(::apache::thrift::stdcxx::function<void(physical_packer_service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& addr, const std::string& snapshot_id) = 0;
  virtual void delete_snapshot_set_p(::apache::thrift::stdcxx::function<void(physical_packer_service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& addr, const std::string& snapshot_set_id) = 0;
  virtual void get_all_snapshots_p(::apache::thrift::stdcxx::function<void(physical_packer_service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& addr) = 0;
  virtual void create_packer_job_ex_p(::apache::thrift::stdcxx::function<void(physical_packer_service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& addr, const std::string& job_id, const create_packer_job_detail& create_job) = 0;
  virtual void get_packer_job_p(::apache::thrift::stdcxx::function<void(physical_packer_service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& addr, const std::string& job_id, const std::string& previous_updated_time) = 0;
  virtual void interrupt_packer_job_p(::apache::thrift::stdcxx::function<void(physical_packer_service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& addr, const std::string& job_id) = 0;
  virtual void resume_packer_job_p(::apache::thrift::stdcxx::function<void(physical_packer_service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& addr, const std::string& job_id) = 0;
  virtual void remove_packer_job_p(::apache::thrift::stdcxx::function<void(physical_packer_service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& addr, const std::string& job_id) = 0;
  virtual void running_packer_job_p(::apache::thrift::stdcxx::function<void(physical_packer_service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& addr, const std::string& job_id) = 0;
  virtual void enumerate_packer_disks_p(::apache::thrift::stdcxx::function<void(physical_packer_service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& addr, const enumerate_disk_filter_style::type filter) = 0;
  virtual void verify_packer_carrier_p(::apache::thrift::stdcxx::function<void(physical_packer_service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& addr, const std::string& carrier, const bool is_ssl) = 0;
  virtual void get_packer_host_detail_p(::apache::thrift::stdcxx::function<void(physical_packer_service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& addr, const machine_detail_filter::type filter) = 0;
};
...
class physical_packer_service_proxyCobSvIf : virtual public common_serviceCobSvIf {
 public:
  ...
  virtual void packer_ping_p(::apache::thrift::stdcxx::function<void(service_info const& _return)> cob, const std::string& session_id, const std::string& addr) = 0;
  virtual void take_snapshots_p(::apache::thrift::stdcxx::function<void(std::vector<snapshot>  const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& addr, const std::set<std::string> & disks) = 0;
  virtual void take_snapshots_ex_p(::apache::thrift::stdcxx::function<void(std::vector<snapshot>  const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& addr, const std::set<std::string> & disks, const std::string& pre_script, const std::string& post_script) = 0;
  virtual void take_snapshots2_p(::apache::thrift::stdcxx::function<void(std::vector<snapshot>  const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& addr, const take_snapshots_parameters& parameters) = 0;
  virtual void delete_snapshot_p(::apache::thrift::stdcxx::function<void(delete_snapshot_result const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& addr, const std::string& snapshot_id) = 0;
  virtual void delete_snapshot_set_p(::apache::thrift::stdcxx::function<void(delete_snapshot_result const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& addr, const std::string& snapshot_set_id) = 0;
  virtual void get_all_snapshots_p(::apache::thrift::stdcxx::function<void(std::map<std::string, std::vector<snapshot> >  const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& addr) = 0;
  virtual void create_packer_job_ex_p(::apache::thrift::stdcxx::function<void(packer_job_detail const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& addr, const std::string& job_id, const create_packer_job_detail& create_job) = 0;
  virtual void get_packer_job_p(::apache::thrift::stdcxx::function<void(packer_job_detail const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& addr, const std::string& job_id, const std::string& previous_updated_time) = 0;
  virtual void interrupt_packer_job_p(::apache::thrift::stdcxx::function<void(bool const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& addr, const std::string& job_id) = 0;
  virtual void resume_packer_job_p(::apache::thrift::stdcxx::function<void(bool const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& addr, const std::string& job_id) = 0;
  virtual void remove_packer_job_p(::apache::thrift::stdcxx::function<void(bool const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& addr, const std::string& job_id) = 0;
  virtual void running_packer_job_p(::apache::thrift::stdcxx::function<void(bool const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& addr, const std::string& job_id) = 0;
  virtual void enumerate_packer_disks_p(::apache::thrift::stdcxx::function<void(std::set<disk_info>  const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& addr, const enumerate_disk_filter_style::type filter) = 0;
  virtual void verify_packer_carrier_p(::apache::thrift::stdcxx::function<void(bool const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& addr, const std::string& carrier, const bool is_ssl) = 0;
  virtual void get_packer_host_detail_p(::apache::thrift::stdcxx::function<void(physical_machine_info const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& addr, const machine_detail_filter::type filter) = 0;
};
...
class physical_packer_service_proxyCobSvIfSingletonFactory : virtual public physical_packer_service_proxyCobSvIfFactory {
 public:
  physical_packer_service_proxyCobSvIfSingletonFactory(const ::apache::thrift::stdcxx::shared_ptr<physical_packer_service_proxyCobSvIf>& iface) : iface_(iface) {}
 ...
 protected:
  ::apache::thrift::stdcxx::shared_ptr<physical_packer_service_proxyCobSvIf> iface_;
};
...
class physical_packer_service_proxyCobSvNull : virtual public physical_packer_service_proxyCobSvIf , virtual public common_serviceCobSvNull {
 public:
  ...
  void packer_ping_p(::apache::thrift::stdcxx::function<void(service_info const& _return)> cob, const std::string& /* session_id */, const std::string& /* addr */) {
    service_info _return;
    return cob(_return);
  }
  void take_snapshots_p(::apache::thrift::stdcxx::function<void(std::vector<snapshot>  const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& /* session_id */, const std::string& /* addr */, const std::set<std::string> & /* disks */) {
    std::vector<snapshot>  _return;
    return cob(_return);
  }
  void take_snapshots_ex_p(::apache::thrift::stdcxx::function<void(std::vector<snapshot>  const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& /* session_id */, const std::string& /* addr */, const std::set<std::string> & /* disks */, const std::string& /* pre_script */, const std::string& /* post_script */) {
    std::vector<snapshot>  _return;
    return cob(_return);
  }
  void take_snapshots2_p(::apache::thrift::stdcxx::function<void(std::vector<snapshot>  const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& /* session_id */, const std::string& /* addr */, const take_snapshots_parameters& /* parameters */) {
    std::vector<snapshot>  _return;
    return cob(_return);
  }
  void delete_snapshot_p(::apache::thrift::stdcxx::function<void(delete_snapshot_result const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& /* session_id */, const std::string& /* addr */, const std::string& /* snapshot_id */) {
    delete_snapshot_result _return;
    return cob(_return);
  }
  void delete_snapshot_set_p(::apache::thrift::stdcxx::function<void(delete_snapshot_result const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& /* session_id */, const std::string& /* addr */, const std::string& /* snapshot_set_id */) {
    delete_snapshot_result _return;
    return cob(_return);
  }
  void get_all_snapshots_p(::apache::thrift::stdcxx::function<void(std::map<std::string, std::vector<snapshot> >  const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& /* session_id */, const std::string& /* addr */) {
    std::map<std::string, std::vector<snapshot> >  _return;
    return cob(_return);
  }
  void create_packer_job_ex_p(::apache::thrift::stdcxx::function<void(packer_job_detail const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& /* session_id */, const std::string& /* addr */, const std::string& /* job_id */, const create_packer_job_detail& /* create_job */) {
    packer_job_detail _return;
    return cob(_return);
  }
  void get_packer_job_p(::apache::thrift::stdcxx::function<void(packer_job_detail const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& /* session_id */, const std::string& /* addr */, const std::string& /* job_id */, const std::string& /* previous_updated_time */) {
    packer_job_detail _return;
    return cob(_return);
  }
  void interrupt_packer_job_p(::apache::thrift::stdcxx::function<void(bool const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& /* session_id */, const std::string& /* addr */, const std::string& /* job_id */) {
    bool _return = false;
    return cob(_return);
  }
  void resume_packer_job_p(::apache::thrift::stdcxx::function<void(bool const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& /* session_id */, const std::string& /* addr */, const std::string& /* job_id */) {
    bool _return = false;
    return cob(_return);
  }
  void remove_packer_job_p(::apache::thrift::stdcxx::function<void(bool const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& /* session_id */, const std::string& /* addr */, const std::string& /* job_id */) {
    bool _return = false;
    return cob(_return);
  }
  void running_packer_job_p(::apache::thrift::stdcxx::function<void(bool const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& /* session_id */, const std::string& /* addr */, const std::string& /* job_id */) {
    bool _return = false;
    return cob(_return);
  }
  void enumerate_packer_disks_p(::apache::thrift::stdcxx::function<void(std::set<disk_info>  const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& /* session_id */, const std::string& /* addr */, const enumerate_disk_filter_style::type /* filter */) {
    std::set<disk_info>  _return;
    return cob(_return);
  }
  void verify_packer_carrier_p(::apache::thrift::stdcxx::function<void(bool const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& /* session_id */, const std::string& /* addr */, const std::string& /* carrier */, const bool /* is_ssl */) {
    bool _return = false;
    return cob(_return);
  }
  void get_packer_host_detail_p(::apache::thrift::stdcxx::function<void(physical_machine_info const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& /* session_id */, const std::string& /* addr */, const machine_detail_filter::type /* filter */) {
...
class physical_packer_service_proxyCobClient : virtual public physical_packer_service_proxyCobClIf, public common_serviceCobClient {
 public:
  physical_packer_service_proxyCobClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::async::TAsyncChannel> channel, ::apache::thrift::protocol::TProtocolFactory* protocolFactory) :
  ...
  void packer_ping_p(::apache::thrift::stdcxx::function<void(physical_packer_service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& addr);
  void send_packer_ping_p(const std::string& session_id, const std::string& addr);
  void recv_packer_ping_p(service_info& _return);
  void take_snapshots_p(::apache::thrift::stdcxx::function<void(physical_packer_service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& addr, const std::set<std::string> & disks);
  void send_take_snapshots_p(const std::string& session_id, const std::string& addr, const std::set<std::string> & disks);
  void recv_take_snapshots_p(std::vector<snapshot> & _return);
  void take_snapshots_ex_p(::apache::thrift::stdcxx::function<void(physical_packer_service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& addr, const std::set<std::string> & disks, const std::string& pre_script, const std::string& post_script);
  void send_take_snapshots_ex_p(const std::string& session_id, const std::string& addr, const std::set<std::string> & disks, const std::string& pre_script, const std::string& post_script);
  void recv_take_snapshots_ex_p(std::vector<snapshot> & _return);
  void take_snapshots2_p(::apache::thrift::stdcxx::function<void(physical_packer_service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& addr, const take_snapshots_parameters& parameters);
  void send_take_snapshots2_p(const std::string& session_id, const std::string& addr, const take_snapshots_parameters& parameters);
  void recv_take_snapshots2_p(std::vector<snapshot> & _return);
  void delete_snapshot_p(::apache::thrift::stdcxx::function<void(physical_packer_service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& addr, const std::string& snapshot_id);
  void send_delete_snapshot_p(const std::string& session_id, const std::string& addr, const std::string& snapshot_id);
  void recv_delete_snapshot_p(delete_snapshot_result& _return);
  void delete_snapshot_set_p(::apache::thrift::stdcxx::function<void(physical_packer_service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& addr, const std::string& snapshot_set_id);
  void send_delete_snapshot_set_p(const std::string& session_id, const std::string& addr, const std::string& snapshot_set_id);
  void recv_delete_snapshot_set_p(delete_snapshot_result& _return);
  void get_all_snapshots_p(::apache::thrift::stdcxx::function<void(physical_packer_service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& addr);
  void send_get_all_snapshots_p(const std::string& session_id, const std::string& addr);
  void recv_get_all_snapshots_p(std::map<std::string, std::vector<snapshot> > & _return);
  void create_packer_job_ex_p(::apache::thrift::stdcxx::function<void(physical_packer_service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& addr, const std::string& job_id, const create_packer_job_detail& create_job);
  void send_create_packer_job_ex_p(const std::string& session_id, const std::string& addr, const std::string& job_id, const create_packer_job_detail& create_job);
  void recv_create_packer_job_ex_p(packer_job_detail& _return);
  void get_packer_job_p(::apache::thrift::stdcxx::function<void(physical_packer_service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& addr, const std::string& job_id, const std::string& previous_updated_time);
  void send_get_packer_job_p(const std::string& session_id, const std::string& addr, const std::string& job_id, const std::string& previous_updated_time);
  void recv_get_packer_job_p(packer_job_detail& _return);
  void interrupt_packer_job_p(::apache::thrift::stdcxx::function<void(physical_packer_service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& addr, const std::string& job_id);
  void send_interrupt_packer_job_p(const std::string& session_id, const std::string& addr, const std::string& job_id);
  bool recv_interrupt_packer_job_p();
  void resume_packer_job_p(::apache::thrift::stdcxx::function<void(physical_packer_service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& addr, const std::string& job_id);
  void send_resume_packer_job_p(const std::string& session_id, const std::string& addr, const std::string& job_id);
  bool recv_resume_packer_job_p();
  void remove_packer_job_p(::apache::thrift::stdcxx::function<void(physical_packer_service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& addr, const std::string& job_id);
  void send_remove_packer_job_p(const std::string& session_id, const std::string& addr, const std::string& job_id);
  bool recv_remove_packer_job_p();
  void running_packer_job_p(::apache::thrift::stdcxx::function<void(physical_packer_service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& addr, const std::string& job_id);
  void send_running_packer_job_p(const std::string& session_id, const std::string& addr, const std::string& job_id);
  bool recv_running_packer_job_p();
  void enumerate_packer_disks_p(::apache::thrift::stdcxx::function<void(physical_packer_service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& addr, const enumerate_disk_filter_style::type filter);
  void send_enumerate_packer_disks_p(const std::string& session_id, const std::string& addr, const enumerate_disk_filter_style::type filter);
  void recv_enumerate_packer_disks_p(std::set<disk_info> & _return);
  void verify_packer_carrier_p(::apache::thrift::stdcxx::function<void(physical_packer_service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& addr, const std::string& carrier, const bool is_ssl);
  void send_verify_packer_carrier_p(const std::string& session_id, const std::string& addr, const std::string& carrier, const bool is_ssl);
  bool recv_verify_packer_carrier_p();
  void get_packer_host_detail_p(::apache::thrift::stdcxx::function<void(physical_packer_service_proxyCobClient* client)> cob, const std::string& session_id, const std::string& addr, const machine_detail_filter::type filter);
  void send_get_packer_host_detail_p(const std::string& session_id, const std::string& addr, const machine_detail_filter::type filter);
  void recv_get_packer_host_detail_p(physical_machine_info& _return);
};
...
class physical_packer_service_proxyAsyncProcessor : public common_serviceAsyncProcessor {
 ...
 private:
  typedef  void (physical_packer_service_proxyAsyncProcessor::*ProcessFunction)(::apache::thrift::stdcxx::function<void(bool ok)>, int32_t, ::apache::thrift::protocol::TProtocol*, ::apache::thrift::protocol::TProtocol*);
  typedef std::map<std::string, ProcessFunction> ProcessMap;
  ProcessMap processMap_;
  void process_packer_ping_p(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_packer_ping_p(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const service_info& _return);
  void throw_packer_ping_p(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_take_snapshots_p(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_take_snapshots_p(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::vector<snapshot> & _return);
  void throw_take_snapshots_p(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_take_snapshots_ex_p(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_take_snapshots_ex_p(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::vector<snapshot> & _return);
  void throw_take_snapshots_ex_p(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_take_snapshots2_p(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_take_snapshots2_p(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::vector<snapshot> & _return);
  void throw_take_snapshots2_p(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_delete_snapshot_p(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_delete_snapshot_p(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const delete_snapshot_result& _return);
  void throw_delete_snapshot_p(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_delete_snapshot_set_p(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_delete_snapshot_set_p(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const delete_snapshot_result& _return);
  void throw_delete_snapshot_set_p(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_get_all_snapshots_p(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_get_all_snapshots_p(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::map<std::string, std::vector<snapshot> > & _return);
  void throw_get_all_snapshots_p(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_create_packer_job_ex_p(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_create_packer_job_ex_p(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const packer_job_detail& _return);
  void throw_create_packer_job_ex_p(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_get_packer_job_p(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_get_packer_job_p(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const packer_job_detail& _return);
  void throw_get_packer_job_p(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_interrupt_packer_job_p(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_interrupt_packer_job_p(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return);
  void throw_interrupt_packer_job_p(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_resume_packer_job_p(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_resume_packer_job_p(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return);
  void throw_resume_packer_job_p(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_remove_packer_job_p(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_remove_packer_job_p(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return);
  void throw_remove_packer_job_p(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_running_packer_job_p(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_running_packer_job_p(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return);
  void throw_running_packer_job_p(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_enumerate_packer_disks_p(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_enumerate_packer_disks_p(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::set<disk_info> & _return);
  void throw_enumerate_packer_disks_p(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_verify_packer_carrier_p(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_verify_packer_carrier_p(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return);
  void throw_verify_packer_carrier_p(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_get_packer_host_detail_p(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_get_packer_host_detail_p(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const physical_machine_info& _return);
  void throw_get_packer_host_detail_p(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
 public:
  physical_packer_service_proxyAsyncProcessor(::apache::thrift::stdcxx::shared_ptr<physical_packer_service_proxyCobSvIf> iface) :
    ...
    processMap_["take_snapshots2_p"] = &physical_packer_service_proxyAsyncProcessor::process_take_snapshots2_p;
...
class physical_packer_service_proxyAsyncProcessorFactory : public ::apache::thrift::async::TAsyncProcessorFactory {
 public:
  physical_packer_service_proxyAsyncProcessorFactory(const ::apache::thrift::stdcxx::shared_ptr< physical_packer_service_proxyCobSvIfFactory >& handlerFactory) :
      handlerFactory_(handlerFactory) {}
 ...
 protected:
  ::apache::thrift::stdcxx::shared_ptr< physical_packer_service_proxyCobSvIfFactory > handlerFactory_;
};
