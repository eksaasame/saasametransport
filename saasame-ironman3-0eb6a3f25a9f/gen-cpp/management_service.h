...
class management_serviceIfSingletonFactory : virtual public management_serviceIfFactory {
 public:
  management_serviceIfSingletonFactory(const ::apache::thrift::stdcxx::shared_ptr<management_serviceIf>& iface) : iface_(iface) {}
 ...
 protected:
  ::apache::thrift::stdcxx::shared_ptr<management_serviceIf> iface_;
};
...
class management_serviceClient : virtual public management_serviceIf {
 public:
  management_serviceClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  management_serviceClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
...
class management_serviceProcessor : public ::apache::thrift::TDispatchProcessor {
 ...
 public:
  management_serviceProcessor(::apache::thrift::stdcxx::shared_ptr<management_serviceIf> iface) :
    iface_(iface) {
...
class management_serviceProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  management_serviceProcessorFactory(const ::apache::thrift::stdcxx::shared_ptr< management_serviceIfFactory >& handlerFactory) :
      handlerFactory_(handlerFactory) {}

  ::apache::thrift::stdcxx::shared_ptr< ::apache::thrift::TProcessor > getProcessor(const ::apache::thrift::TConnectionInfo& connInfo);

 protected:
  ::apache::thrift::stdcxx::shared_ptr< management_serviceIfFactory > handlerFactory_;
};

class management_serviceMultiface : virtual public management_serviceIf {
 public:
  management_serviceMultiface(std::vector<apache::thrift::stdcxx::shared_ptr<management_serviceIf> >& ifaces) : ifaces_(ifaces) {
  }
  virtual ~management_serviceMultiface() {}
 protected:
  std::vector<apache::thrift::stdcxx::shared_ptr<management_serviceIf> > ifaces_;
  management_serviceMultiface() {}
  void add(::apache::thrift::stdcxx::shared_ptr<management_serviceIf> iface) {
...
class management_serviceConcurrentClient : virtual public management_serviceIf {
 public:
  management_serviceConcurrentClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  management_serviceConcurrentClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
    setProtocol(iprot,oprot);
  }
 private:
  void setProtocol(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
...
class management_serviceCobClIf {
 public:
  ...
  virtual void get_replica_job_create_detail(::apache::thrift::stdcxx::function<void(management_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id) = 0;
  virtual void update_replica_job_state(::apache::thrift::stdcxx::function<void(management_serviceCobClient* client)> cob, const std::string& session_id, const replica_job_detail& state) = 0;
  virtual void is_replica_job_alive(::apache::thrift::stdcxx::function<void(management_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id) = 0;
  virtual void get_loader_job_create_detail(::apache::thrift::stdcxx::function<void(management_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id) = 0;
  virtual void update_loader_job_state(::apache::thrift::stdcxx::function<void(management_serviceCobClient* client)> cob, const std::string& session_id, const loader_job_detail& state) = 0;
  virtual void take_snapshots(::apache::thrift::stdcxx::function<void(management_serviceCobClient* client)> cob, const std::string& session_id, const std::string& snapshot_id) = 0;
  virtual void check_snapshots(::apache::thrift::stdcxx::function<void(management_serviceCobClient* client)> cob, const std::string& session_id, const std::string& snapshots_id) = 0;
  virtual void get_launcher_job_create_detail(::apache::thrift::stdcxx::function<void(management_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id) = 0;
  virtual void update_launcher_job_state(::apache::thrift::stdcxx::function<void(management_serviceCobClient* client)> cob, const std::string& session_id, const launcher_job_detail& state) = 0;
  virtual void update_launcher_job_state_ex(::apache::thrift::stdcxx::function<void(management_serviceCobClient* client)> cob, const std::string& session_id, const launcher_job_detail& state) = 0;
  virtual void is_launcher_job_image_ready(::apache::thrift::stdcxx::function<void(management_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id) = 0;
  virtual void is_loader_job_devices_ready(::apache::thrift::stdcxx::function<void(management_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id) = 0;
  virtual void mount_loader_job_devices(::apache::thrift::stdcxx::function<void(management_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id) = 0;
  virtual void dismount_loader_job_devices(::apache::thrift::stdcxx::function<void(management_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id) = 0;
  virtual void discard_snapshots(::apache::thrift::stdcxx::function<void(management_serviceCobClient* client)> cob, const std::string& session_id, const std::string& snapshots_id) = 0;
  virtual void register_service(::apache::thrift::stdcxx::function<void(management_serviceCobClient* client)> cob, const std::string& session_id, const register_service_info& register_info, const physical_machine_info& machine_info) = 0;
  virtual void register_physical_packer(::apache::thrift::stdcxx::function<void(management_serviceCobClient* client)> cob, const std::string& session_id, const register_physical_packer_info& packer_info, const physical_machine_info& machine_info) = 0;
  virtual void check_running_task(::apache::thrift::stdcxx::function<void(management_serviceCobClient* client)> cob, const std::string& task_id, const std::string& parameters) = 0;
  virtual void ping(::apache::thrift::stdcxx::function<void(management_serviceCobClient* client)> cob) = 0;
};
...
class management_serviceCobSvIf {
 public:
  ...
  virtual void update_replica_job_state(::apache::thrift::stdcxx::function<void()> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const replica_job_detail& state) = 0;
  virtual void is_replica_job_alive(::apache::thrift::stdcxx::function<void(bool const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& job_id) = 0;
  ...
  virtual void update_loader_job_state(::apache::thrift::stdcxx::function<void()> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const loader_job_detail& state) = 0;
  virtual void take_snapshots(::apache::thrift::stdcxx::function<void(bool const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& snapshot_id) = 0;
  virtual void check_snapshots(::apache::thrift::stdcxx::function<void(bool const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& snapshots_id) = 0;
  ...
  virtual void update_launcher_job_state(::apache::thrift::stdcxx::function<void()> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const launcher_job_detail& state) = 0;
  virtual void update_launcher_job_state_ex(::apache::thrift::stdcxx::function<void()> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const launcher_job_detail& state) = 0;
  virtual void is_launcher_job_image_ready(::apache::thrift::stdcxx::function<void(bool const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& job_id) = 0;
  virtual void is_loader_job_devices_ready(::apache::thrift::stdcxx::function<void(bool const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& job_id) = 0;
  virtual void mount_loader_job_devices(::apache::thrift::stdcxx::function<void(bool const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& job_id) = 0;
  virtual void dismount_loader_job_devices(::apache::thrift::stdcxx::function<void(bool const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& job_id) = 0;
  virtual void discard_snapshots(::apache::thrift::stdcxx::function<void(bool const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& snapshots_id) = 0;
  virtual void register_service(::apache::thrift::stdcxx::function<void(register_return const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const register_service_info& register_info, const physical_machine_info& machine_info) = 0;
  virtual void register_physical_packer(::apache::thrift::stdcxx::function<void(register_return const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const register_physical_packer_info& packer_info, const physical_machine_info& machine_info) = 0;
  virtual void check_running_task(::apache::thrift::stdcxx::function<void(bool const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& task_id, const std::string& parameters) = 0;
...
class management_serviceCobSvIfSingletonFactory : virtual public management_serviceCobSvIfFactory {
 public:
  management_serviceCobSvIfSingletonFactory(const ::apache::thrift::stdcxx::shared_ptr<management_serviceCobSvIf>& iface) : iface_(iface) {}
 ...
 protected:
  ::apache::thrift::stdcxx::shared_ptr<management_serviceCobSvIf> iface_;
};
...
class management_serviceCobClient : virtual public management_serviceCobClIf {
 public:
  management_serviceCobClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::async::TAsyncChannel> channel, ::apache::thrift::protocol::TProtocolFactory* protocolFactory) :
    channel_(channel),
  ...
  void get_replica_job_create_detail(::apache::thrift::stdcxx::function<void(management_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id);
  void send_get_replica_job_create_detail(const std::string& session_id, const std::string& job_id);
  void recv_get_replica_job_create_detail(replica_job_create_detail& _return);
  void update_replica_job_state(::apache::thrift::stdcxx::function<void(management_serviceCobClient* client)> cob, const std::string& session_id, const replica_job_detail& state);
  void send_update_replica_job_state(const std::string& session_id, const replica_job_detail& state);
  void recv_update_replica_job_state();
  void is_replica_job_alive(::apache::thrift::stdcxx::function<void(management_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id);
  void send_is_replica_job_alive(const std::string& session_id, const std::string& job_id);
  bool recv_is_replica_job_alive();
  void get_loader_job_create_detail(::apache::thrift::stdcxx::function<void(management_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id);
  void send_get_loader_job_create_detail(const std::string& session_id, const std::string& job_id);
  void recv_get_loader_job_create_detail(loader_job_create_detail& _return);
  void update_loader_job_state(::apache::thrift::stdcxx::function<void(management_serviceCobClient* client)> cob, const std::string& session_id, const loader_job_detail& state);
  void send_update_loader_job_state(const std::string& session_id, const loader_job_detail& state);
  void recv_update_loader_job_state();
  void take_snapshots(::apache::thrift::stdcxx::function<void(management_serviceCobClient* client)> cob, const std::string& session_id, const std::string& snapshot_id);
  void send_take_snapshots(const std::string& session_id, const std::string& snapshot_id);
  bool recv_take_snapshots();
  void check_snapshots(::apache::thrift::stdcxx::function<void(management_serviceCobClient* client)> cob, const std::string& session_id, const std::string& snapshots_id);
  void send_check_snapshots(const std::string& session_id, const std::string& snapshots_id);
  bool recv_check_snapshots();
  void get_launcher_job_create_detail(::apache::thrift::stdcxx::function<void(management_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id);
  void send_get_launcher_job_create_detail(const std::string& session_id, const std::string& job_id);
  void recv_get_launcher_job_create_detail(launcher_job_create_detail& _return);
  void update_launcher_job_state(::apache::thrift::stdcxx::function<void(management_serviceCobClient* client)> cob, const std::string& session_id, const launcher_job_detail& state);
  void send_update_launcher_job_state(const std::string& session_id, const launcher_job_detail& state);
  void recv_update_launcher_job_state();
  void update_launcher_job_state_ex(::apache::thrift::stdcxx::function<void(management_serviceCobClient* client)> cob, const std::string& session_id, const launcher_job_detail& state);
  void send_update_launcher_job_state_ex(const std::string& session_id, const launcher_job_detail& state);
  void recv_update_launcher_job_state_ex();
  void is_launcher_job_image_ready(::apache::thrift::stdcxx::function<void(management_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id);
  void send_is_launcher_job_image_ready(const std::string& session_id, const std::string& job_id);
  bool recv_is_launcher_job_image_ready();
  void is_loader_job_devices_ready(::apache::thrift::stdcxx::function<void(management_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id);
  void send_is_loader_job_devices_ready(const std::string& session_id, const std::string& job_id);
  bool recv_is_loader_job_devices_ready();
  void mount_loader_job_devices(::apache::thrift::stdcxx::function<void(management_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id);
  void send_mount_loader_job_devices(const std::string& session_id, const std::string& job_id);
  bool recv_mount_loader_job_devices();
  void dismount_loader_job_devices(::apache::thrift::stdcxx::function<void(management_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id);
  void send_dismount_loader_job_devices(const std::string& session_id, const std::string& job_id);
  bool recv_dismount_loader_job_devices();
  void discard_snapshots(::apache::thrift::stdcxx::function<void(management_serviceCobClient* client)> cob, const std::string& session_id, const std::string& snapshots_id);
  void send_discard_snapshots(const std::string& session_id, const std::string& snapshots_id);
  bool recv_discard_snapshots();
  void register_service(::apache::thrift::stdcxx::function<void(management_serviceCobClient* client)> cob, const std::string& session_id, const register_service_info& register_info, const physical_machine_info& machine_info);
  void send_register_service(const std::string& session_id, const register_service_info& register_info, const physical_machine_info& machine_info);
  void recv_register_service(register_return& _return);
  void register_physical_packer(::apache::thrift::stdcxx::function<void(management_serviceCobClient* client)> cob, const std::string& session_id, const register_physical_packer_info& packer_info, const physical_machine_info& machine_info);
  void send_register_physical_packer(const std::string& session_id, const register_physical_packer_info& packer_info, const physical_machine_info& machine_info);
  void recv_register_physical_packer(register_return& _return);
  void check_running_task(::apache::thrift::stdcxx::function<void(management_serviceCobClient* client)> cob, const std::string& task_id, const std::string& parameters);
  void send_check_running_task(const std::string& task_id, const std::string& parameters);
  bool recv_check_running_task();
  void ping(::apache::thrift::stdcxx::function<void(management_serviceCobClient* client)> cob);
  void send_ping();
  void recv_ping(service_info& _return);
 protected:
...
class management_serviceAsyncProcessor : public ::apache::thrift::async::TAsyncDispatchProcessor {
 ...
 private:
  typedef  void (management_serviceAsyncProcessor::*ProcessFunction)(::apache::thrift::stdcxx::function<void(bool ok)>, int32_t, ::apache::thrift::protocol::TProtocol*, ::apache::thrift::protocol::TProtocol*);
  typedef std::map<std::string, ProcessFunction> ProcessMap;
  ProcessMap processMap_;
  ...
  void process_update_replica_job_state(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_update_replica_job_state(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx);
  void throw_update_replica_job_state(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_is_replica_job_alive(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_is_replica_job_alive(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return);
  void throw_is_replica_job_alive(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  ...
  void process_update_loader_job_state(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_update_loader_job_state(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx);
  void throw_update_loader_job_state(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  ...
  void return_take_snapshots(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return);
  ...
  void process_check_snapshots(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_check_snapshots(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return);
  void throw_check_snapshots(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  ...
  void process_update_launcher_job_state(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_update_launcher_job_state(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx);
  void throw_update_launcher_job_state(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_update_launcher_job_state_ex(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_update_launcher_job_state_ex(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx);
  void throw_update_launcher_job_state_ex(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_is_launcher_job_image_ready(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_is_launcher_job_image_ready(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return);
  void throw_is_launcher_job_image_ready(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_is_loader_job_devices_ready(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_is_loader_job_devices_ready(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return);
  void throw_is_loader_job_devices_ready(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_mount_loader_job_devices(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_mount_loader_job_devices(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return);
  void throw_mount_loader_job_devices(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_dismount_loader_job_devices(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_dismount_loader_job_devices(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return);
  void throw_dismount_loader_job_devices(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_discard_snapshots(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_discard_snapshots(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return);
  void throw_discard_snapshots(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_register_service(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_register_service(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const register_return& _return);
  void throw_register_service(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_register_physical_packer(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_register_physical_packer(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const register_return& _return);
  void throw_register_physical_packer(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_check_running_task(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_check_running_task(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return);
  void throw_check_running_task(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
 ...
 public:
  management_serviceAsyncProcessor(::apache::thrift::stdcxx::shared_ptr<management_serviceCobSvIf> iface) :
    iface_(iface) {
...
class management_serviceAsyncProcessorFactory : public ::apache::thrift::async::TAsyncProcessorFactory {
 public:
  management_serviceAsyncProcessorFactory(const ::apache::thrift::stdcxx::shared_ptr< management_serviceCobSvIfFactory >& handlerFactory) :
      handlerFactory_(handlerFactory) {}
 ...
 protected:
  ::apache::thrift::stdcxx::shared_ptr< management_serviceCobSvIfFactory > handlerFactory_;
};
