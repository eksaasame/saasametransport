...
::apache::thrift::stdcxx::shared_ptr< ::apache::thrift::TProcessor > management_serviceProcessorFactory::getProcessor(const ::apache::thrift::TConnectionInfo& connInfo) {
  ::apache::thrift::ReleaseHandler< management_serviceIfFactory > cleanup(handlerFactory_);
  ::apache::thrift::stdcxx::shared_ptr< management_serviceIf > handler(handlerFactory_->getHandler(connInfo), cleanup);
  ::apache::thrift::stdcxx::shared_ptr< ::apache::thrift::TProcessor > processor(new management_serviceProcessor(handler));
  return processor;
}
...
void management_serviceCobClient::get_replica_job_create_detail(::apache::thrift::stdcxx::function<void(management_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id)
{
  send_get_replica_job_create_detail(session_id, job_id);
...
void management_serviceCobClient::update_replica_job_state(::apache::thrift::stdcxx::function<void(management_serviceCobClient* client)> cob, const std::string& session_id, const replica_job_detail& state)
{
  send_update_replica_job_state(session_id, state);
  channel_->sendAndRecvMessage(::apache::thrift::stdcxx::bind(cob, this), otrans_.get(), itrans_.get());
}
...
void management_serviceCobClient::is_replica_job_alive(::apache::thrift::stdcxx::function<void(management_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id)
{
  send_is_replica_job_alive(session_id, job_id);
  channel_->sendAndRecvMessage(::apache::thrift::stdcxx::bind(cob, this), otrans_.get(), itrans_.get());
}
...
void management_serviceCobClient::get_loader_job_create_detail(::apache::thrift::stdcxx::function<void(management_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id)
{
  send_get_loader_job_create_detail(session_id, job_id);
  channel_->sendAndRecvMessage(::apache::thrift::stdcxx::bind(cob, this), otrans_.get(), itrans_.get());
}
...
void management_serviceCobClient::update_loader_job_state(::apache::thrift::stdcxx::function<void(management_serviceCobClient* client)> cob, const std::string& session_id, const loader_job_detail& state)
{
  send_update_loader_job_state(session_id, state);
  channel_->sendAndRecvMessage(::apache::thrift::stdcxx::bind(cob, this), otrans_.get(), itrans_.get());
}
...
void management_serviceCobClient::take_snapshots(::apache::thrift::stdcxx::function<void(management_serviceCobClient* client)> cob, const std::string& session_id, const std::string& snapshot_id)
{
  send_take_snapshots(session_id, snapshot_id);
  channel_->sendAndRecvMessage(::apache::thrift::stdcxx::bind(cob, this), otrans_.get(), itrans_.get());
}
...
void management_serviceCobClient::check_snapshots(::apache::thrift::stdcxx::function<void(management_serviceCobClient* client)> cob, const std::string& session_id, const std::string& snapshots_id)
{
  send_check_snapshots(session_id, snapshots_id);
  channel_->sendAndRecvMessage(::apache::thrift::stdcxx::bind(cob, this), otrans_.get(), itrans_.get());
}
...
void management_serviceCobClient::get_launcher_job_create_detail(::apache::thrift::stdcxx::function<void(management_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id)
{
  send_get_launcher_job_create_detail(session_id, job_id);
  channel_->sendAndRecvMessage(::apache::thrift::stdcxx::bind(cob, this), otrans_.get(), itrans_.get());
}
...
void management_serviceCobClient::update_launcher_job_state(::apache::thrift::stdcxx::function<void(management_serviceCobClient* client)> cob, const std::string& session_id, const launcher_job_detail& state)
{
  send_update_launcher_job_state(session_id, state);
  channel_->sendAndRecvMessage(::apache::thrift::stdcxx::bind(cob, this), otrans_.get(), itrans_.get());
}
...
void management_serviceCobClient::update_launcher_job_state_ex(::apache::thrift::stdcxx::function<void(management_serviceCobClient* client)> cob, const std::string& session_id, const launcher_job_detail& state)
{
  send_update_launcher_job_state_ex(session_id, state);
  channel_->sendAndRecvMessage(::apache::thrift::stdcxx::bind(cob, this), otrans_.get(), itrans_.get());
}
...
void management_serviceCobClient::is_launcher_job_image_ready(::apache::thrift::stdcxx::function<void(management_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id)
{
  send_is_launcher_job_image_ready(session_id, job_id);
  channel_->sendAndRecvMessage(::apache::thrift::stdcxx::bind(cob, this), otrans_.get(), itrans_.get());
}
...
void management_serviceCobClient::is_loader_job_devices_ready(::apache::thrift::stdcxx::function<void(management_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id)
{
  send_is_loader_job_devices_ready(session_id, job_id);
  channel_->sendAndRecvMessage(::apache::thrift::stdcxx::bind(cob, this), otrans_.get(), itrans_.get());
}
...
void management_serviceCobClient::mount_loader_job_devices(::apache::thrift::stdcxx::function<void(management_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id)
{
  send_mount_loader_job_devices(session_id, job_id);
  channel_->sendAndRecvMessage(::apache::thrift::stdcxx::bind(cob, this), otrans_.get(), itrans_.get());
}
...
void management_serviceCobClient::dismount_loader_job_devices(::apache::thrift::stdcxx::function<void(management_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id)
{
  send_dismount_loader_job_devices(session_id, job_id);
  channel_->sendAndRecvMessage(::apache::thrift::stdcxx::bind(cob, this), otrans_.get(), itrans_.get());
}
...
void management_serviceCobClient::discard_snapshots(::apache::thrift::stdcxx::function<void(management_serviceCobClient* client)> cob, const std::string& session_id, const std::string& snapshots_id)
{
  send_discard_snapshots(session_id, snapshots_id);
  channel_->sendAndRecvMessage(::apache::thrift::stdcxx::bind(cob, this), otrans_.get(), itrans_.get());
}
...
void management_serviceCobClient::register_service(::apache::thrift::stdcxx::function<void(management_serviceCobClient* client)> cob, const std::string& session_id, const register_service_info& register_info, const physical_machine_info& machine_info)
{
  send_register_service(session_id, register_info, machine_info);
  channel_->sendAndRecvMessage(::apache::thrift::stdcxx::bind(cob, this), otrans_.get(), itrans_.get());
}
...
void management_serviceCobClient::register_physical_packer(::apache::thrift::stdcxx::function<void(management_serviceCobClient* client)> cob, const std::string& session_id, const register_physical_packer_info& packer_info, const physical_machine_info& machine_info)
{
  send_register_physical_packer(session_id, packer_info, machine_info);
  channel_->sendAndRecvMessage(::apache::thrift::stdcxx::bind(cob, this), otrans_.get(), itrans_.get());
}
...
void management_serviceCobClient::check_running_task(::apache::thrift::stdcxx::function<void(management_serviceCobClient* client)> cob, const std::string& task_id, const std::string& parameters)
{
  send_check_running_task(task_id, parameters);
  channel_->sendAndRecvMessage(::apache::thrift::stdcxx::bind(cob, this), otrans_.get(), itrans_.get());
}
...
void management_serviceCobClient::ping(::apache::thrift::stdcxx::function<void(management_serviceCobClient* client)> cob)
{
  send_ping();
  channel_->sendAndRecvMessage(::apache::thrift::stdcxx::bind(cob, this), otrans_.get(), itrans_.get());
}
...
void management_serviceAsyncProcessor::dispatchCall(::apache::thrift::stdcxx::function<void(bool ok)> cob, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, const std::string& fname, int32_t seqid) {
  ProcessMap::iterator pfn;
  pfn = processMap_.find(fname);
  if (pfn == processMap_.end()) {
    iprot->skip(::apache::thrift::protocol::T_STRUCT);
...
void management_serviceAsyncProcessor::process_get_replica_job_create_detail(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  management_service_get_replica_job_create_detail_args args;
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
  ...
  freer.unregister();
  void (management_serviceAsyncProcessor::*return_fn)(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const replica_job_create_detail& _return) =
    &management_serviceAsyncProcessor::return_get_replica_job_create_detail;
  void (management_serviceAsyncProcessor::*throw_fn)(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw) =
...
void management_serviceAsyncProcessor::return_get_replica_job_create_detail(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const replica_job_create_detail& _return)
{
  management_service_get_replica_job_create_detail_presult result;
...
void management_serviceAsyncProcessor::throw_get_replica_job_create_detail(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw)
{
...
void management_serviceAsyncProcessor::process_update_replica_job_state(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  management_service_update_replica_job_state_args args;
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
  ...
  freer.unregister();
  void (management_serviceAsyncProcessor::*return_fn)(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx) =
...
void management_serviceAsyncProcessor::return_update_replica_job_state(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx)
{
  management_service_update_replica_job_state_presult result;
...
void management_serviceAsyncProcessor::throw_update_replica_job_state(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw)
{
...
void management_serviceAsyncProcessor::process_is_replica_job_alive(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  management_service_is_replica_job_alive_args args;
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
  ...
  freer.unregister();
  void (management_serviceAsyncProcessor::*return_fn)(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return) =
...
void management_serviceAsyncProcessor::return_is_replica_job_alive(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return)
{
  management_service_is_replica_job_alive_presult result;
...
void management_serviceAsyncProcessor::throw_is_replica_job_alive(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw)
{
...
void management_serviceAsyncProcessor::process_get_loader_job_create_detail(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  management_service_get_loader_job_create_detail_args args;
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
  ...
  freer.unregister();
  void (management_serviceAsyncProcessor::*return_fn)(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const loader_job_create_detail& _return) =
...
void management_serviceAsyncProcessor::return_get_loader_job_create_detail(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const loader_job_create_detail& _return)
{
  management_service_get_loader_job_create_detail_presult result;
...
void management_serviceAsyncProcessor::throw_get_loader_job_create_detail(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw)
{
...
void management_serviceAsyncProcessor::process_update_loader_job_state(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  management_service_update_loader_job_state_args args;
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
...
void management_serviceAsyncProcessor::return_update_loader_job_state(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx)
{
  management_service_update_loader_job_state_presult result;
...
void management_serviceAsyncProcessor::throw_update_loader_job_state(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw)
{
...
void management_serviceAsyncProcessor::process_take_snapshots(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  management_service_take_snapshots_args args;
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
...
void management_serviceAsyncProcessor::return_take_snapshots(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return)
{
  management_service_take_snapshots_presult result;
  result.success = const_cast<bool*>(&_return);
  result.__isset.success = true;
...
void management_serviceAsyncProcessor::throw_take_snapshots(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw)
{
...
void management_serviceAsyncProcessor::process_check_snapshots(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  management_service_check_snapshots_args args;
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
...
void management_serviceAsyncProcessor::return_check_snapshots(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return)
{
  management_service_check_snapshots_presult result;
  result.success = const_cast<bool*>(&_return);
  result.__isset.success = true;
...
void management_serviceAsyncProcessor::throw_check_snapshots(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw)
{
...
void management_serviceAsyncProcessor::process_get_launcher_job_create_detail(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  management_service_get_launcher_job_create_detail_args args;
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
  ...
  freer.unregister();
  void (management_serviceAsyncProcessor::*return_fn)(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const launcher_job_create_detail& _return) =
...
void management_serviceAsyncProcessor::return_get_launcher_job_create_detail(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const launcher_job_create_detail& _return)
{
  management_service_get_launcher_job_create_detail_presult result;
...
void management_serviceAsyncProcessor::throw_get_launcher_job_create_detail(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw)
{
...
void management_serviceAsyncProcessor::process_update_launcher_job_state(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  management_service_update_launcher_job_state_args args;
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
...
void management_serviceAsyncProcessor::return_update_launcher_job_state(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx)
{
  management_service_update_launcher_job_state_presult result;
...
void management_serviceAsyncProcessor::throw_update_launcher_job_state(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw)
{
...
void management_serviceAsyncProcessor::process_update_launcher_job_state_ex(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  management_service_update_launcher_job_state_ex_args args;
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
...
void management_serviceAsyncProcessor::return_update_launcher_job_state_ex(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx)
{
  management_service_update_launcher_job_state_ex_presult result;
...
void management_serviceAsyncProcessor::throw_update_launcher_job_state_ex(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw)
{
...
void management_serviceAsyncProcessor::process_is_launcher_job_image_ready(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  management_service_is_launcher_job_image_ready_args args;
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
...
void management_serviceAsyncProcessor::return_is_launcher_job_image_ready(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return)
{
  management_service_is_launcher_job_image_ready_presult result;
  result.success = const_cast<bool*>(&_return);
  result.__isset.success = true;
...
void management_serviceAsyncProcessor::throw_is_launcher_job_image_ready(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw)
{
...
void management_serviceAsyncProcessor::process_is_loader_job_devices_ready(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  management_service_is_loader_job_devices_ready_args args;
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
...
void management_serviceAsyncProcessor::return_is_loader_job_devices_ready(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return)
{
  management_service_is_loader_job_devices_ready_presult result;
  result.success = const_cast<bool*>(&_return);
  result.__isset.success = true;
...
void management_serviceAsyncProcessor::throw_is_loader_job_devices_ready(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw)
{
...
void management_serviceAsyncProcessor::process_mount_loader_job_devices(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  management_service_mount_loader_job_devices_args args;
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
...
void management_serviceAsyncProcessor::return_mount_loader_job_devices(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return)
{
  management_service_mount_loader_job_devices_presult result;
  result.success = const_cast<bool*>(&_return);
  result.__isset.success = true;
...
void management_serviceAsyncProcessor::throw_mount_loader_job_devices(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw)
{
...
void management_serviceAsyncProcessor::process_dismount_loader_job_devices(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  management_service_dismount_loader_job_devices_args args;
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
...
void management_serviceAsyncProcessor::return_dismount_loader_job_devices(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return)
{
  management_service_dismount_loader_job_devices_presult result;
  result.success = const_cast<bool*>(&_return);
  result.__isset.success = true;
...
void management_serviceAsyncProcessor::throw_dismount_loader_job_devices(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw)
{
...
void management_serviceAsyncProcessor::process_discard_snapshots(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  management_service_discard_snapshots_args args;
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
...
void management_serviceAsyncProcessor::return_discard_snapshots(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return)
{
  management_service_discard_snapshots_presult result;
  result.success = const_cast<bool*>(&_return);
  result.__isset.success = true;
...
void management_serviceAsyncProcessor::throw_discard_snapshots(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw)
{
...
void management_serviceAsyncProcessor::process_register_service(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  management_service_register_service_args args;
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
  ...
  freer.unregister();
  void (management_serviceAsyncProcessor::*return_fn)(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const register_return& _return) =
...
void management_serviceAsyncProcessor::return_register_service(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const register_return& _return)
{
  management_service_register_service_presult result;
...
void management_serviceAsyncProcessor::throw_register_service(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw)
{
...
void management_serviceAsyncProcessor::process_register_physical_packer(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  management_service_register_physical_packer_args args;
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
...
void management_serviceAsyncProcessor::return_register_physical_packer(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const register_return& _return)
{
  management_service_register_physical_packer_presult result;
  result.success = const_cast<register_return*>(&_return);
  result.__isset.success = true;
...
void management_serviceAsyncProcessor::throw_register_physical_packer(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw)
{
...
void management_serviceAsyncProcessor::process_check_running_task(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  management_service_check_running_task_args args;
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
...
void management_serviceAsyncProcessor::return_check_running_task(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return)
{
  management_service_check_running_task_presult result;
  result.success = const_cast<bool*>(&_return);
  result.__isset.success = true;
...
void management_serviceAsyncProcessor::throw_check_running_task(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw)
{
...
void management_serviceAsyncProcessor::process_ping(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  management_service_ping_args args;
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
  ...
  freer.unregister();
  void (management_serviceAsyncProcessor::*return_fn)(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const service_info& _return) =
    &management_serviceAsyncProcessor::return_ping;
  iface_->ping(
      ::apache::thrift::stdcxx::bind(return_fn, this, cob, seqid, oprot, ctx, ::apache::thrift::stdcxx::placeholders::_1));
}

void management_serviceAsyncProcessor::return_ping(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const service_info& _return)
{
  management_service_ping_presult result;
...
::apache::thrift::stdcxx::shared_ptr< ::apache::thrift::async::TAsyncProcessor > management_serviceAsyncProcessorFactory::getProcessor(const ::apache::thrift::TConnectionInfo& connInfo) {
  ::apache::thrift::ReleaseHandler< management_serviceCobSvIfFactory > cleanup(handlerFactory_);
  ::apache::thrift::stdcxx::shared_ptr< management_serviceCobSvIf > handler(handlerFactory_->getHandler(connInfo), cleanup);
  ::apache::thrift::stdcxx::shared_ptr< ::apache::thrift::async::TAsyncProcessor > processor(new management_serviceAsyncProcessor(handler));
  return processor;
}
