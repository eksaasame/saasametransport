...
class carrier_serviceIf : virtual public common_connection_serviceIf {
 public:
  ...
  virtual bool send_checksum_info(const std::string& session_id, const std::string& connection_id, const std::string& file_name, const std::string& data) = 0;
  virtual void receive_checksum_result(std::string& _return, const std::string& session_id, const std::string& connection_id, const std::string& file_name) = 0;
};
...
typedef struct _carrier_service_send_checksum_info_args__isset {
  _carrier_service_send_checksum_info_args__isset() : session_id(false), connection_id(false), file_name(false), data(false) {}
  bool session_id :1;
  bool connection_id :1;
  bool file_name :1;
  bool data :1;
} _carrier_service_send_checksum_info_args__isset;

class carrier_service_send_checksum_info_args {
 public:

  carrier_service_send_checksum_info_args(const carrier_service_send_checksum_info_args&);
  carrier_service_send_checksum_info_args& operator=(const carrier_service_send_checksum_info_args&);
  carrier_service_send_checksum_info_args() : session_id(), connection_id(), file_name(), data() {
  }

  virtual ~carrier_service_send_checksum_info_args() throw();
  std::string session_id;
  std::string connection_id;
  std::string file_name;
  std::string data;

  _carrier_service_send_checksum_info_args__isset __isset;
  ...
  bool operator == (const carrier_service_send_checksum_info_args & rhs) const
  {
    if (!(session_id == rhs.session_id))
      return false;
  ...
  bool operator < (const carrier_service_send_checksum_info_args & ) const;
...
class carrier_service_send_checksum_info_pargs {
 public:


  virtual ~carrier_service_send_checksum_info_pargs() throw();
  const std::string* session_id;
...
typedef struct _carrier_service_send_checksum_info_result__isset {
  _carrier_service_send_checksum_info_result__isset() : success(false), ouch(false) {}
  bool success :1;
  bool ouch :1;
} _carrier_service_send_checksum_info_result__isset;

class carrier_service_send_checksum_info_result {
 public:

  carrier_service_send_checksum_info_result(const carrier_service_send_checksum_info_result&);
  carrier_service_send_checksum_info_result& operator=(const carrier_service_send_checksum_info_result&);
  carrier_service_send_checksum_info_result() : success(0) {
  }

  virtual ~carrier_service_send_checksum_info_result() throw();
  bool success;
  invalid_operation ouch;

  _carrier_service_send_checksum_info_result__isset __isset;

  void __set_success(const bool val);

  void __set_ouch(const invalid_operation& val);

  bool operator == (const carrier_service_send_checksum_info_result & rhs) const
  {
    if (!(success == rhs.success))
      return false;
    if (!(ouch == rhs.ouch))
  ...
  bool operator < (const carrier_service_send_checksum_info_result & ) const;
...
typedef struct _carrier_service_send_checksum_info_presult__isset {
  _carrier_service_send_checksum_info_presult__isset() : success(false), ouch(false) {}
  bool success :1;
  bool ouch :1;
} _carrier_service_send_checksum_info_presult__isset;

class carrier_service_send_checksum_info_presult {
 public:


  virtual ~carrier_service_send_checksum_info_presult() throw();
  bool* success;
  invalid_operation ouch;

  _carrier_service_send_checksum_info_presult__isset __isset;
...
typedef struct _carrier_service_receive_checksum_result_args__isset {
  _carrier_service_receive_checksum_result_args__isset() : session_id(false), connection_id(false), file_name(false) {}
  bool session_id :1;
  bool connection_id :1;
  bool file_name :1;
} _carrier_service_receive_checksum_result_args__isset;

class carrier_service_receive_checksum_result_args {
 public:

  carrier_service_receive_checksum_result_args(const carrier_service_receive_checksum_result_args&);
  carrier_service_receive_checksum_result_args& operator=(const carrier_service_receive_checksum_result_args&);
  carrier_service_receive_checksum_result_args() : session_id(), connection_id(), file_name() {
  }

  virtual ~carrier_service_receive_checksum_result_args() throw();
  std::string session_id;
  std::string connection_id;
  std::string file_name;

  _carrier_service_receive_checksum_result_args__isset __isset;
  ...
  bool operator == (const carrier_service_receive_checksum_result_args & rhs) const
  {
    if (!(session_id == rhs.session_id))
      return false;
    if (!(connection_id == rhs.connection_id))
  ...
  bool operator < (const carrier_service_receive_checksum_result_args & ) const;
...
class carrier_service_receive_checksum_result_pargs {
 public:


  virtual ~carrier_service_receive_checksum_result_pargs() throw();
  const std::string* session_id;
  const std::string* connection_id;
  const std::string* file_name;
...
typedef struct _carrier_service_receive_checksum_result_result__isset {
  _carrier_service_receive_checksum_result_result__isset() : success(false), ouch(false) {}
  bool success :1;
  bool ouch :1;
} _carrier_service_receive_checksum_result_result__isset;

class carrier_service_receive_checksum_result_result {
 public:

  carrier_service_receive_checksum_result_result(const carrier_service_receive_checksum_result_result&);
  carrier_service_receive_checksum_result_result& operator=(const carrier_service_receive_checksum_result_result&);
  carrier_service_receive_checksum_result_result() : success() {
  }

  virtual ~carrier_service_receive_checksum_result_result() throw();
  std::string success;
  invalid_operation ouch;

  _carrier_service_receive_checksum_result_result__isset __isset;

  void __set_success(const std::string& val);

  void __set_ouch(const invalid_operation& val);

  bool operator == (const carrier_service_receive_checksum_result_result & rhs) const
  {
    if (!(success == rhs.success))
      return false;
    if (!(ouch == rhs.ouch))
  ...
  bool operator < (const carrier_service_receive_checksum_result_result & ) const;
...
typedef struct _carrier_service_receive_checksum_result_presult__isset {
  _carrier_service_receive_checksum_result_presult__isset() : success(false), ouch(false) {}
  bool success :1;
  bool ouch :1;
} _carrier_service_receive_checksum_result_presult__isset;

class carrier_service_receive_checksum_result_presult {
 public:


  virtual ~carrier_service_receive_checksum_result_presult() throw();
  std::string* success;
  invalid_operation ouch;

  _carrier_service_receive_checksum_result_presult__isset __isset;
...
class carrier_serviceClient : virtual public carrier_serviceIf, public common_connection_serviceClient {
 public:
  ...
  bool send_checksum_info(const std::string& session_id, const std::string& connection_id, const std::string& file_name, const std::string& data);
  void send_send_checksum_info(const std::string& session_id, const std::string& connection_id, const std::string& file_name, const std::string& data);
  bool recv_send_checksum_info();
  void receive_checksum_result(std::string& _return, const std::string& session_id, const std::string& connection_id, const std::string& file_name);
  void send_receive_checksum_result(const std::string& session_id, const std::string& connection_id, const std::string& file_name);
  void recv_receive_checksum_result(std::string& _return);
};
...
class carrier_serviceProcessor : public common_connection_serviceProcessor {
 ...
 private:
  ...
  void process_send_checksum_info(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext);
  void process_receive_checksum_result(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext);
 public:
  carrier_serviceProcessor(::apache::thrift::stdcxx::shared_ptr<carrier_serviceIf> iface) :
    ...
    processMap_["send_checksum_info"] = &carrier_serviceProcessor::process_send_checksum_info;
    processMap_["receive_checksum_result"] = &carrier_serviceProcessor::process_receive_checksum_result;
  }
...
class carrier_serviceMultiface : virtual public carrier_serviceIf, public common_connection_serviceMultiface {
 ...
 public:
  ...
  bool send_checksum_info(const std::string& session_id, const std::string& connection_id, const std::string& file_name, const std::string& data) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->send_checksum_info(session_id, connection_id, file_name, data);
    }
    return ifaces_[i]->send_checksum_info(session_id, connection_id, file_name, data);
  }
  ...
  void receive_checksum_result(std::string& _return, const std::string& session_id, const std::string& connection_id, const std::string& file_name) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->receive_checksum_result(_return, session_id, connection_id, file_name);
    }
    ifaces_[i]->receive_checksum_result(_return, session_id, connection_id, file_name);
    return;
  }
...
class carrier_serviceConcurrentClient : virtual public carrier_serviceIf, public common_connection_serviceConcurrentClient {
 public:
  ...
  bool send_checksum_info(const std::string& session_id, const std::string& connection_id, const std::string& file_name, const std::string& data);
  int32_t send_send_checksum_info(const std::string& session_id, const std::string& connection_id, const std::string& file_name, const std::string& data);
  bool recv_send_checksum_info(const int32_t seqid);
  void receive_checksum_result(std::string& _return, const std::string& session_id, const std::string& connection_id, const std::string& file_name);
  int32_t send_receive_checksum_result(const std::string& session_id, const std::string& connection_id, const std::string& file_name);
  void recv_receive_checksum_result(std::string& _return, const int32_t seqid);
};
...
class carrier_serviceCobClIf : virtual public common_connection_serviceCobClIf {
 public:
  ...
  virtual void send_checksum_info(::apache::thrift::stdcxx::function<void(carrier_serviceCobClient* client)> cob, const std::string& session_id, const std::string& connection_id, const std::string& file_name, const std::string& data) = 0;
  virtual void receive_checksum_result(::apache::thrift::stdcxx::function<void(carrier_serviceCobClient* client)> cob, const std::string& session_id, const std::string& connection_id, const std::string& file_name) = 0;
};
...
class carrier_serviceCobSvIf : virtual public common_connection_serviceCobSvIf {
 public:
  ...
  virtual void send_checksum_info(::apache::thrift::stdcxx::function<void(bool const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& connection_id, const std::string& file_name, const std::string& data) = 0;
  virtual void receive_checksum_result(::apache::thrift::stdcxx::function<void(std::string const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& connection_id, const std::string& file_name) = 0;
};
...
class carrier_serviceCobSvNull : virtual public carrier_serviceCobSvIf , virtual public common_connection_serviceCobSvNull {
 public:
  ...
  void send_checksum_info(::apache::thrift::stdcxx::function<void(bool const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& /* session_id */, const std::string& /* connection_id */, const std::string& /* file_name */, const std::string& /* data */) {
    bool _return = false;
    return cob(_return);
  }
  void receive_checksum_result(::apache::thrift::stdcxx::function<void(std::string const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& /* session_id */, const std::string& /* connection_id */, const std::string& /* file_name */) {
    std::string _return;
    return cob(_return);
  }
};
...
class carrier_serviceCobClient : virtual public carrier_serviceCobClIf, public common_connection_serviceCobClient {
 public:
  ...
  void send_is_image_replicated(const std::string& session_id, const std::set<std::string> & connection_ids, const std::string& image_name);
  bool recv_is_image_replicated();
  void send_checksum_info(::apache::thrift::stdcxx::function<void(carrier_serviceCobClient* client)> cob, const std::string& session_id, const std::string& connection_id, const std::string& file_name, const std::string& data);
  void send_send_checksum_info(const std::string& session_id, const std::string& connection_id, const std::string& file_name, const std::string& data);
  bool recv_send_checksum_info();
  void receive_checksum_result(::apache::thrift::stdcxx::function<void(carrier_serviceCobClient* client)> cob, const std::string& session_id, const std::string& connection_id, const std::string& file_name);
  void send_receive_checksum_result(const std::string& session_id, const std::string& connection_id, const std::string& file_name);
  void recv_receive_checksum_result(std::string& _return);
};
...
class carrier_serviceAsyncProcessor : public common_connection_serviceAsyncProcessor {
 ...
 private:
  ...
  void process_send_checksum_info(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_send_checksum_info(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return);
  void throw_send_checksum_info(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_receive_checksum_result(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_receive_checksum_result(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::string& _return);
  void throw_receive_checksum_result(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
 public:
  carrier_serviceAsyncProcessor(::apache::thrift::stdcxx::shared_ptr<carrier_serviceCobSvIf> iface) :
    ...
    processMap_["send_checksum_info"] = &carrier_serviceAsyncProcessor::process_send_checksum_info;
    processMap_["receive_checksum_result"] = &carrier_serviceAsyncProcessor::process_receive_checksum_result;
  }
