...
class virtual_packer_serviceIf : virtual public common_serviceIf {
 public:
  ...
  virtual void get_virtual_hosts(std::vector<virtual_host> & _return, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password) = 0;
  ...
  virtual bool power_off_virtual_machine(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id) = 0;
  virtual bool remove_virtual_machine(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id) = 0;
  virtual void get_virtual_machine_snapshots(std::vector<vmware_snapshot> & _return, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id) = 0;
  virtual bool remove_virtual_machine_snapshot(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id, const std::string& snapshot_id) = 0;
  virtual void get_datacenter_folder_list(std::vector<std::string> & _return, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& datacenter) = 0;
...
class virtual_packer_serviceIfSingletonFactory : virtual public virtual_packer_serviceIfFactory {
 public:
  virtual_packer_serviceIfSingletonFactory(const ::apache::thrift::stdcxx::shared_ptr<virtual_packer_serviceIf>& iface) : iface_(iface) {}
 ...
 protected:
  ::apache::thrift::stdcxx::shared_ptr<virtual_packer_serviceIf> iface_;
};
...
typedef struct _virtual_packer_service_get_virtual_hosts_args__isset {
  _virtual_packer_service_get_virtual_hosts_args__isset() : session_id(false), host(false), username(false), password(false) {}
  bool session_id :1;
  bool host :1;
  bool username :1;
  bool password :1;
} _virtual_packer_service_get_virtual_hosts_args__isset;

class virtual_packer_service_get_virtual_hosts_args {
 public:

  virtual_packer_service_get_virtual_hosts_args(const virtual_packer_service_get_virtual_hosts_args&);
  virtual_packer_service_get_virtual_hosts_args& operator=(const virtual_packer_service_get_virtual_hosts_args&);
  virtual_packer_service_get_virtual_hosts_args() : session_id(), host(), username(), password() {
  }

  virtual ~virtual_packer_service_get_virtual_hosts_args() throw();
  std::string session_id;
  std::string host;
  std::string username;
  std::string password;

  _virtual_packer_service_get_virtual_hosts_args__isset __isset;
  ...
  bool operator == (const virtual_packer_service_get_virtual_hosts_args & rhs) const
  {
    if (!(session_id == rhs.session_id))
      return false;
    if (!(host == rhs.host))
  ...
  bool operator < (const virtual_packer_service_get_virtual_hosts_args & ) const;
...
class virtual_packer_service_get_virtual_hosts_pargs {
 public:


  virtual ~virtual_packer_service_get_virtual_hosts_pargs() throw();
  const std::string* session_id;
  const std::string* host;
  const std::string* username;
  const std::string* password;
...
typedef struct _virtual_packer_service_get_virtual_hosts_result__isset {
  _virtual_packer_service_get_virtual_hosts_result__isset() : success(false), ouch(false) {}
  bool success :1;
  bool ouch :1;
} _virtual_packer_service_get_virtual_hosts_result__isset;

class virtual_packer_service_get_virtual_hosts_result {
 public:

  virtual_packer_service_get_virtual_hosts_result(const virtual_packer_service_get_virtual_hosts_result&);
  virtual_packer_service_get_virtual_hosts_result& operator=(const virtual_packer_service_get_virtual_hosts_result&);
  virtual_packer_service_get_virtual_hosts_result() {
  }

  virtual ~virtual_packer_service_get_virtual_hosts_result() throw();
  std::vector<virtual_host>  success;
  invalid_operation ouch;

  _virtual_packer_service_get_virtual_hosts_result__isset __isset;

  void __set_success(const std::vector<virtual_host> & val);

  void __set_ouch(const invalid_operation& val);

  bool operator == (const virtual_packer_service_get_virtual_hosts_result & rhs) const
  {
    if (!(success == rhs.success))
      return false;
    if (!(ouch == rhs.ouch))
  ...
  bool operator < (const virtual_packer_service_get_virtual_hosts_result & ) const;
...
typedef struct _virtual_packer_service_get_virtual_hosts_presult__isset {
  _virtual_packer_service_get_virtual_hosts_presult__isset() : success(false), ouch(false) {}
  bool success :1;
  bool ouch :1;
} _virtual_packer_service_get_virtual_hosts_presult__isset;

class virtual_packer_service_get_virtual_hosts_presult {
 public:


  virtual ~virtual_packer_service_get_virtual_hosts_presult() throw();
  std::vector<virtual_host> * success;
  invalid_operation ouch;

  _virtual_packer_service_get_virtual_hosts_presult__isset __isset;
...
typedef struct _virtual_packer_service_power_off_virtual_machine_args__isset {
  _virtual_packer_service_power_off_virtual_machine_args__isset() : session_id(false), host(false), username(false), password(false), machine_id(false) {}
  bool session_id :1;
  bool host :1;
  bool username :1;
  bool password :1;
  bool machine_id :1;
} _virtual_packer_service_power_off_virtual_machine_args__isset;

class virtual_packer_service_power_off_virtual_machine_args {
 public:

  virtual_packer_service_power_off_virtual_machine_args(const virtual_packer_service_power_off_virtual_machine_args&);
  virtual_packer_service_power_off_virtual_machine_args& operator=(const virtual_packer_service_power_off_virtual_machine_args&);
  virtual_packer_service_power_off_virtual_machine_args() : session_id(), host(), username(), password(), machine_id() {
  }

  virtual ~virtual_packer_service_power_off_virtual_machine_args() throw();
  std::string session_id;
  std::string host;
  std::string username;
  std::string password;
  ...
  _virtual_packer_service_power_off_virtual_machine_args__isset __isset;
  ...
  bool operator == (const virtual_packer_service_power_off_virtual_machine_args & rhs) const
  {
    if (!(session_id == rhs.session_id))
      return false;
    if (!(host == rhs.host))
  ...
  bool operator < (const virtual_packer_service_power_off_virtual_machine_args & ) const;
...
class virtual_packer_service_power_off_virtual_machine_pargs {
 public:


  virtual ~virtual_packer_service_power_off_virtual_machine_pargs() throw();
  const std::string* session_id;
  const std::string* host;
  const std::string* username;
  const std::string* password;
...
typedef struct _virtual_packer_service_power_off_virtual_machine_result__isset {
  _virtual_packer_service_power_off_virtual_machine_result__isset() : success(false), ouch(false) {}
  bool success :1;
  bool ouch :1;
} _virtual_packer_service_power_off_virtual_machine_result__isset;

class virtual_packer_service_power_off_virtual_machine_result {
 public:

  virtual_packer_service_power_off_virtual_machine_result(const virtual_packer_service_power_off_virtual_machine_result&);
  virtual_packer_service_power_off_virtual_machine_result& operator=(const virtual_packer_service_power_off_virtual_machine_result&);
  virtual_packer_service_power_off_virtual_machine_result() : success(0) {
  }

  virtual ~virtual_packer_service_power_off_virtual_machine_result() throw();
  bool success;
  invalid_operation ouch;

  _virtual_packer_service_power_off_virtual_machine_result__isset __isset;

  void __set_success(const bool val);

  void __set_ouch(const invalid_operation& val);

  bool operator == (const virtual_packer_service_power_off_virtual_machine_result & rhs) const
  {
    if (!(success == rhs.success))
      return false;
    if (!(ouch == rhs.ouch))
  ...
  bool operator < (const virtual_packer_service_power_off_virtual_machine_result & ) const;
...
typedef struct _virtual_packer_service_power_off_virtual_machine_presult__isset {
  _virtual_packer_service_power_off_virtual_machine_presult__isset() : success(false), ouch(false) {}
  bool success :1;
  bool ouch :1;
} _virtual_packer_service_power_off_virtual_machine_presult__isset;

class virtual_packer_service_power_off_virtual_machine_presult {
 public:


  virtual ~virtual_packer_service_power_off_virtual_machine_presult() throw();
  bool* success;
  invalid_operation ouch;

  _virtual_packer_service_power_off_virtual_machine_presult__isset __isset;
...
typedef struct _virtual_packer_service_remove_virtual_machine_args__isset {
  _virtual_packer_service_remove_virtual_machine_args__isset() : session_id(false), host(false), username(false), password(false), machine_id(false) {}
  bool session_id :1;
  bool host :1;
  bool username :1;
  bool password :1;
  bool machine_id :1;
} _virtual_packer_service_remove_virtual_machine_args__isset;

class virtual_packer_service_remove_virtual_machine_args {
 public:

  virtual_packer_service_remove_virtual_machine_args(const virtual_packer_service_remove_virtual_machine_args&);
  virtual_packer_service_remove_virtual_machine_args& operator=(const virtual_packer_service_remove_virtual_machine_args&);
  virtual_packer_service_remove_virtual_machine_args() : session_id(), host(), username(), password(), machine_id() {
  }

  virtual ~virtual_packer_service_remove_virtual_machine_args() throw();
  std::string session_id;
  std::string host;
  std::string username;
  std::string password;
  ...
  _virtual_packer_service_remove_virtual_machine_args__isset __isset;
  ...
  bool operator == (const virtual_packer_service_remove_virtual_machine_args & rhs) const
  {
    if (!(session_id == rhs.session_id))
      return false;
    if (!(host == rhs.host))
  ...
  bool operator < (const virtual_packer_service_remove_virtual_machine_args & ) const;
...
class virtual_packer_service_remove_virtual_machine_pargs {
 public:


  virtual ~virtual_packer_service_remove_virtual_machine_pargs() throw();
  const std::string* session_id;
  const std::string* host;
  const std::string* username;
  const std::string* password;
...
typedef struct _virtual_packer_service_remove_virtual_machine_result__isset {
  _virtual_packer_service_remove_virtual_machine_result__isset() : success(false), ouch(false) {}
  bool success :1;
  bool ouch :1;
} _virtual_packer_service_remove_virtual_machine_result__isset;

class virtual_packer_service_remove_virtual_machine_result {
 public:

  virtual_packer_service_remove_virtual_machine_result(const virtual_packer_service_remove_virtual_machine_result&);
  virtual_packer_service_remove_virtual_machine_result& operator=(const virtual_packer_service_remove_virtual_machine_result&);
  virtual_packer_service_remove_virtual_machine_result() : success(0) {
  }

  virtual ~virtual_packer_service_remove_virtual_machine_result() throw();
  bool success;
  invalid_operation ouch;

  _virtual_packer_service_remove_virtual_machine_result__isset __isset;

  void __set_success(const bool val);

  void __set_ouch(const invalid_operation& val);

  bool operator == (const virtual_packer_service_remove_virtual_machine_result & rhs) const
  {
    if (!(success == rhs.success))
      return false;
    if (!(ouch == rhs.ouch))
  ...
  bool operator < (const virtual_packer_service_remove_virtual_machine_result & ) const;
...
typedef struct _virtual_packer_service_remove_virtual_machine_presult__isset {
  _virtual_packer_service_remove_virtual_machine_presult__isset() : success(false), ouch(false) {}
  bool success :1;
  bool ouch :1;
} _virtual_packer_service_remove_virtual_machine_presult__isset;

class virtual_packer_service_remove_virtual_machine_presult {
 public:


  virtual ~virtual_packer_service_remove_virtual_machine_presult() throw();
  bool* success;
  invalid_operation ouch;

  _virtual_packer_service_remove_virtual_machine_presult__isset __isset;
...
typedef struct _virtual_packer_service_get_virtual_machine_snapshots_args__isset {
  _virtual_packer_service_get_virtual_machine_snapshots_args__isset() : session_id(false), host(false), username(false), password(false), machine_id(false) {}
  bool session_id :1;
  bool host :1;
  bool username :1;
  bool password :1;
  bool machine_id :1;
} _virtual_packer_service_get_virtual_machine_snapshots_args__isset;

class virtual_packer_service_get_virtual_machine_snapshots_args {
 public:

  virtual_packer_service_get_virtual_machine_snapshots_args(const virtual_packer_service_get_virtual_machine_snapshots_args&);
  virtual_packer_service_get_virtual_machine_snapshots_args& operator=(const virtual_packer_service_get_virtual_machine_snapshots_args&);
  virtual_packer_service_get_virtual_machine_snapshots_args() : session_id(), host(), username(), password(), machine_id() {
  }

  virtual ~virtual_packer_service_get_virtual_machine_snapshots_args() throw();
  std::string session_id;
  std::string host;
  std::string username;
  std::string password;
  ...
  _virtual_packer_service_get_virtual_machine_snapshots_args__isset __isset;
  ...
  bool operator == (const virtual_packer_service_get_virtual_machine_snapshots_args & rhs) const
  {
    if (!(session_id == rhs.session_id))
      return false;
    if (!(host == rhs.host))
  ...
  bool operator < (const virtual_packer_service_get_virtual_machine_snapshots_args & ) const;
...
class virtual_packer_service_get_virtual_machine_snapshots_pargs {
 public:


  virtual ~virtual_packer_service_get_virtual_machine_snapshots_pargs() throw();
  const std::string* session_id;
  const std::string* host;
  const std::string* username;
  const std::string* password;
...
typedef struct _virtual_packer_service_get_virtual_machine_snapshots_result__isset {
  _virtual_packer_service_get_virtual_machine_snapshots_result__isset() : success(false), ouch(false) {}
  bool success :1;
  bool ouch :1;
} _virtual_packer_service_get_virtual_machine_snapshots_result__isset;

class virtual_packer_service_get_virtual_machine_snapshots_result {
 public:

  virtual_packer_service_get_virtual_machine_snapshots_result(const virtual_packer_service_get_virtual_machine_snapshots_result&);
  virtual_packer_service_get_virtual_machine_snapshots_result& operator=(const virtual_packer_service_get_virtual_machine_snapshots_result&);
  virtual_packer_service_get_virtual_machine_snapshots_result() {
  }

  virtual ~virtual_packer_service_get_virtual_machine_snapshots_result() throw();
  std::vector<vmware_snapshot>  success;
  invalid_operation ouch;

  _virtual_packer_service_get_virtual_machine_snapshots_result__isset __isset;

  void __set_success(const std::vector<vmware_snapshot> & val);

  void __set_ouch(const invalid_operation& val);

  bool operator == (const virtual_packer_service_get_virtual_machine_snapshots_result & rhs) const
  {
    if (!(success == rhs.success))
      return false;
    if (!(ouch == rhs.ouch))
  ...
  bool operator < (const virtual_packer_service_get_virtual_machine_snapshots_result & ) const;
...
typedef struct _virtual_packer_service_get_virtual_machine_snapshots_presult__isset {
  _virtual_packer_service_get_virtual_machine_snapshots_presult__isset() : success(false), ouch(false) {}
  bool success :1;
  bool ouch :1;
} _virtual_packer_service_get_virtual_machine_snapshots_presult__isset;

class virtual_packer_service_get_virtual_machine_snapshots_presult {
 public:


  virtual ~virtual_packer_service_get_virtual_machine_snapshots_presult() throw();
  std::vector<vmware_snapshot> * success;
  invalid_operation ouch;

  _virtual_packer_service_get_virtual_machine_snapshots_presult__isset __isset;
...
typedef struct _virtual_packer_service_remove_virtual_machine_snapshot_args__isset {
  _virtual_packer_service_remove_virtual_machine_snapshot_args__isset() : session_id(false), host(false), username(false), password(false), machine_id(false), snapshot_id(false) {}
  bool session_id :1;
  bool host :1;
  bool username :1;
  bool password :1;
  bool machine_id :1;
  bool snapshot_id :1;
} _virtual_packer_service_remove_virtual_machine_snapshot_args__isset;

class virtual_packer_service_remove_virtual_machine_snapshot_args {
 public:

  virtual_packer_service_remove_virtual_machine_snapshot_args(const virtual_packer_service_remove_virtual_machine_snapshot_args&);
  virtual_packer_service_remove_virtual_machine_snapshot_args& operator=(const virtual_packer_service_remove_virtual_machine_snapshot_args&);
  virtual_packer_service_remove_virtual_machine_snapshot_args() : session_id(), host(), username(), password(), machine_id(), snapshot_id() {
  }

  virtual ~virtual_packer_service_remove_virtual_machine_snapshot_args() throw();
  std::string session_id;
  std::string host;
  std::string username;
  std::string password;
  ...
  _virtual_packer_service_remove_virtual_machine_snapshot_args__isset __isset;
  ...
  bool operator == (const virtual_packer_service_remove_virtual_machine_snapshot_args & rhs) const
  {
    if (!(session_id == rhs.session_id))
      return false;
    if (!(host == rhs.host))
  ...
  bool operator < (const virtual_packer_service_remove_virtual_machine_snapshot_args & ) const;
...
class virtual_packer_service_remove_virtual_machine_snapshot_pargs {
 public:


  virtual ~virtual_packer_service_remove_virtual_machine_snapshot_pargs() throw();
  const std::string* session_id;
  const std::string* host;
  const std::string* username;
  const std::string* password;
...
typedef struct _virtual_packer_service_remove_virtual_machine_snapshot_result__isset {
  _virtual_packer_service_remove_virtual_machine_snapshot_result__isset() : success(false), ouch(false) {}
  bool success :1;
  bool ouch :1;
} _virtual_packer_service_remove_virtual_machine_snapshot_result__isset;

class virtual_packer_service_remove_virtual_machine_snapshot_result {
 public:

  virtual_packer_service_remove_virtual_machine_snapshot_result(const virtual_packer_service_remove_virtual_machine_snapshot_result&);
  virtual_packer_service_remove_virtual_machine_snapshot_result& operator=(const virtual_packer_service_remove_virtual_machine_snapshot_result&);
  virtual_packer_service_remove_virtual_machine_snapshot_result() : success(0) {
  }

  virtual ~virtual_packer_service_remove_virtual_machine_snapshot_result() throw();
  bool success;
  invalid_operation ouch;

  _virtual_packer_service_remove_virtual_machine_snapshot_result__isset __isset;

  void __set_success(const bool val);

  void __set_ouch(const invalid_operation& val);

  bool operator == (const virtual_packer_service_remove_virtual_machine_snapshot_result & rhs) const
  {
    if (!(success == rhs.success))
      return false;
    if (!(ouch == rhs.ouch))
  ...
  bool operator < (const virtual_packer_service_remove_virtual_machine_snapshot_result & ) const;
...
typedef struct _virtual_packer_service_remove_virtual_machine_snapshot_presult__isset {
  _virtual_packer_service_remove_virtual_machine_snapshot_presult__isset() : success(false), ouch(false) {}
  bool success :1;
  bool ouch :1;
} _virtual_packer_service_remove_virtual_machine_snapshot_presult__isset;

class virtual_packer_service_remove_virtual_machine_snapshot_presult {
 public:


  virtual ~virtual_packer_service_remove_virtual_machine_snapshot_presult() throw();
  bool* success;
  invalid_operation ouch;

  _virtual_packer_service_remove_virtual_machine_snapshot_presult__isset __isset;
...
typedef struct _virtual_packer_service_get_datacenter_folder_list_args__isset {
  _virtual_packer_service_get_datacenter_folder_list_args__isset() : session_id(false), host(false), username(false), password(false), datacenter(false) {}
  bool session_id :1;
  bool host :1;
  bool username :1;
  bool password :1;
  bool datacenter :1;
} _virtual_packer_service_get_datacenter_folder_list_args__isset;

class virtual_packer_service_get_datacenter_folder_list_args {
 public:

  virtual_packer_service_get_datacenter_folder_list_args(const virtual_packer_service_get_datacenter_folder_list_args&);
  virtual_packer_service_get_datacenter_folder_list_args& operator=(const virtual_packer_service_get_datacenter_folder_list_args&);
  virtual_packer_service_get_datacenter_folder_list_args() : session_id(), host(), username(), password(), datacenter() {
  }

  virtual ~virtual_packer_service_get_datacenter_folder_list_args() throw();
  std::string session_id;
  std::string host;
  std::string username;
  std::string password;
  ...
  _virtual_packer_service_get_datacenter_folder_list_args__isset __isset;
  ...
  bool operator == (const virtual_packer_service_get_datacenter_folder_list_args & rhs) const
  {
    if (!(session_id == rhs.session_id))
      return false;
    if (!(host == rhs.host))
  ...
  bool operator < (const virtual_packer_service_get_datacenter_folder_list_args & ) const;
...
class virtual_packer_service_get_datacenter_folder_list_pargs {
 public:


  virtual ~virtual_packer_service_get_datacenter_folder_list_pargs() throw();
  const std::string* session_id;
  const std::string* host;
  const std::string* username;
  const std::string* password;
...
typedef struct _virtual_packer_service_get_datacenter_folder_list_result__isset {
  _virtual_packer_service_get_datacenter_folder_list_result__isset() : success(false), ouch(false) {}
  bool success :1;
  bool ouch :1;
} _virtual_packer_service_get_datacenter_folder_list_result__isset;

class virtual_packer_service_get_datacenter_folder_list_result {
 public:

  virtual_packer_service_get_datacenter_folder_list_result(const virtual_packer_service_get_datacenter_folder_list_result&);
  virtual_packer_service_get_datacenter_folder_list_result& operator=(const virtual_packer_service_get_datacenter_folder_list_result&);
  virtual_packer_service_get_datacenter_folder_list_result() {
  }

  virtual ~virtual_packer_service_get_datacenter_folder_list_result() throw();
  std::vector<std::string>  success;
  invalid_operation ouch;

  _virtual_packer_service_get_datacenter_folder_list_result__isset __isset;

  void __set_success(const std::vector<std::string> & val);

  void __set_ouch(const invalid_operation& val);

  bool operator == (const virtual_packer_service_get_datacenter_folder_list_result & rhs) const
  {
    if (!(success == rhs.success))
      return false;
    if (!(ouch == rhs.ouch))
  ...
  bool operator < (const virtual_packer_service_get_datacenter_folder_list_result & ) const;
...
typedef struct _virtual_packer_service_get_datacenter_folder_list_presult__isset {
  _virtual_packer_service_get_datacenter_folder_list_presult__isset() : success(false), ouch(false) {}
  bool success :1;
  bool ouch :1;
} _virtual_packer_service_get_datacenter_folder_list_presult__isset;

class virtual_packer_service_get_datacenter_folder_list_presult {
 public:


  virtual ~virtual_packer_service_get_datacenter_folder_list_presult() throw();
  std::vector<std::string> * success;
  invalid_operation ouch;

  _virtual_packer_service_get_datacenter_folder_list_presult__isset __isset;
...
class virtual_packer_serviceClient : virtual public virtual_packer_serviceIf, public common_serviceClient {
 public:
  virtual_packer_serviceClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) :
    common_serviceClient(prot, prot) {}
  virtual_packer_serviceClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) :    common_serviceClient(iprot, oprot) {}
  ...
  void get_virtual_hosts(std::vector<virtual_host> & _return, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password);
  void send_get_virtual_hosts(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password);
  void recv_get_virtual_hosts(std::vector<virtual_host> & _return);
  void get_virtual_machine_detail(virtual_machine& _return, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id);
  ...
  bool power_off_virtual_machine(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id);
  void send_power_off_virtual_machine(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id);
  bool recv_power_off_virtual_machine();
  bool remove_virtual_machine(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id);
  void send_remove_virtual_machine(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id);
  bool recv_remove_virtual_machine();
  void get_virtual_machine_snapshots(std::vector<vmware_snapshot> & _return, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id);
  void send_get_virtual_machine_snapshots(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id);
  void recv_get_virtual_machine_snapshots(std::vector<vmware_snapshot> & _return);
  bool remove_virtual_machine_snapshot(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id, const std::string& snapshot_id);
  void send_remove_virtual_machine_snapshot(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id, const std::string& snapshot_id);
  bool recv_remove_virtual_machine_snapshot();
  void get_datacenter_folder_list(std::vector<std::string> & _return, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& datacenter);
  void send_get_datacenter_folder_list(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& datacenter);
  void recv_get_datacenter_folder_list(std::vector<std::string> & _return);
  void create_job_ex(packer_job_detail& _return, const std::string& session_id, const std::string& job_id, const create_packer_job_detail& create_job);
...
class virtual_packer_serviceProcessor : public common_serviceProcessor {
 ...
 private:
  ...
  void process_get_virtual_hosts(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext);
  ...
  void process_power_off_virtual_machine(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext);
  void process_remove_virtual_machine(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext);
  void process_get_virtual_machine_snapshots(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext);
  void process_remove_virtual_machine_snapshot(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext);
  void process_get_datacenter_folder_list(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext);
 ...
 public:
  virtual_packer_serviceProcessor(::apache::thrift::stdcxx::shared_ptr<virtual_packer_serviceIf> iface) :
    ...
    processMap_["get_virtual_hosts"] = &virtual_packer_serviceProcessor::process_get_virtual_hosts;
    processMap_["get_virtual_machine_detail"] = &virtual_packer_serviceProcessor::process_get_virtual_machine_detail;
    processMap_["power_off_virtual_machine"] = &virtual_packer_serviceProcessor::process_power_off_virtual_machine;
    processMap_["remove_virtual_machine"] = &virtual_packer_serviceProcessor::process_remove_virtual_machine;
    processMap_["get_virtual_machine_snapshots"] = &virtual_packer_serviceProcessor::process_get_virtual_machine_snapshots;
    processMap_["remove_virtual_machine_snapshot"] = &virtual_packer_serviceProcessor::process_remove_virtual_machine_snapshot;
    processMap_["get_datacenter_folder_list"] = &virtual_packer_serviceProcessor::process_get_datacenter_folder_list;
...
class virtual_packer_serviceProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  virtual_packer_serviceProcessorFactory(const ::apache::thrift::stdcxx::shared_ptr< virtual_packer_serviceIfFactory >& handlerFactory) :
      handlerFactory_(handlerFactory) {}

  ::apache::thrift::stdcxx::shared_ptr< ::apache::thrift::TProcessor > getProcessor(const ::apache::thrift::TConnectionInfo& connInfo);

 protected:
  ::apache::thrift::stdcxx::shared_ptr< virtual_packer_serviceIfFactory > handlerFactory_;
};

class virtual_packer_serviceMultiface : virtual public virtual_packer_serviceIf, public common_serviceMultiface {
 public:
  virtual_packer_serviceMultiface(std::vector<apache::thrift::stdcxx::shared_ptr<virtual_packer_serviceIf> >& ifaces) : ifaces_(ifaces) {
    std::vector<apache::thrift::stdcxx::shared_ptr<virtual_packer_serviceIf> >::iterator iter;
 ...
 protected:
  std::vector<apache::thrift::stdcxx::shared_ptr<virtual_packer_serviceIf> > ifaces_;
  virtual_packer_serviceMultiface() {}
  void add(::apache::thrift::stdcxx::shared_ptr<virtual_packer_serviceIf> iface) {
 ...
 public:
  ...
  void get_virtual_hosts(std::vector<virtual_host> & _return, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->get_virtual_hosts(_return, session_id, host, username, password);
    }
    ifaces_[i]->get_virtual_hosts(_return, session_id, host, username, password);
    return;
  }
  ...
  bool power_off_virtual_machine(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->power_off_virtual_machine(session_id, host, username, password, machine_id);
    }
    return ifaces_[i]->power_off_virtual_machine(session_id, host, username, password, machine_id);
  }
  ...
  bool remove_virtual_machine(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->remove_virtual_machine(session_id, host, username, password, machine_id);
    }
    return ifaces_[i]->remove_virtual_machine(session_id, host, username, password, machine_id);
  }
  ...
  void get_virtual_machine_snapshots(std::vector<vmware_snapshot> & _return, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->get_virtual_machine_snapshots(_return, session_id, host, username, password, machine_id);
    }
    ifaces_[i]->get_virtual_machine_snapshots(_return, session_id, host, username, password, machine_id);
    return;
  }
  ...
  bool remove_virtual_machine_snapshot(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id, const std::string& snapshot_id) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->remove_virtual_machine_snapshot(session_id, host, username, password, machine_id, snapshot_id);
    }
    return ifaces_[i]->remove_virtual_machine_snapshot(session_id, host, username, password, machine_id, snapshot_id);
  }
  ...
  void get_datacenter_folder_list(std::vector<std::string> & _return, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& datacenter) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->get_datacenter_folder_list(_return, session_id, host, username, password, datacenter);
    }
    ifaces_[i]->get_datacenter_folder_list(_return, session_id, host, username, password, datacenter);
    return;
  }
...
class virtual_packer_serviceConcurrentClient : virtual public virtual_packer_serviceIf, public common_serviceConcurrentClient {
 public:
  virtual_packer_serviceConcurrentClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) :
    common_serviceConcurrentClient(prot, prot) {}
  virtual_packer_serviceConcurrentClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) :    common_serviceConcurrentClient(iprot, oprot) {}
  apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> getInputProtocol() {
    return piprot_;
  }
  apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> getOutputProtocol() {
  ...
  void get_virtual_hosts(std::vector<virtual_host> & _return, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password);
  int32_t send_get_virtual_hosts(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password);
  void recv_get_virtual_hosts(std::vector<virtual_host> & _return, const int32_t seqid);
  void get_virtual_machine_detail(virtual_machine& _return, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id);
  ...
  bool power_off_virtual_machine(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id);
  int32_t send_power_off_virtual_machine(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id);
  bool recv_power_off_virtual_machine(const int32_t seqid);
  bool remove_virtual_machine(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id);
  int32_t send_remove_virtual_machine(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id);
  bool recv_remove_virtual_machine(const int32_t seqid);
  void get_virtual_machine_snapshots(std::vector<vmware_snapshot> & _return, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id);
  int32_t send_get_virtual_machine_snapshots(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id);
  void recv_get_virtual_machine_snapshots(std::vector<vmware_snapshot> & _return, const int32_t seqid);
  bool remove_virtual_machine_snapshot(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id, const std::string& snapshot_id);
  int32_t send_remove_virtual_machine_snapshot(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id, const std::string& snapshot_id);
  bool recv_remove_virtual_machine_snapshot(const int32_t seqid);
  void get_datacenter_folder_list(std::vector<std::string> & _return, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& datacenter);
  int32_t send_get_datacenter_folder_list(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& datacenter);
  void recv_get_datacenter_folder_list(std::vector<std::string> & _return, const int32_t seqid);
  void create_job_ex(packer_job_detail& _return, const std::string& session_id, const std::string& job_id, const create_packer_job_detail& create_job);
...
class virtual_packer_serviceCobClIf : virtual public common_serviceCobClIf {
 public:
  ...
  virtual void get_virtual_host_info(::apache::thrift::stdcxx::function<void(virtual_packer_serviceCobClient* client)> cob, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password) = 0;
  virtual void get_virtual_hosts(::apache::thrift::stdcxx::function<void(virtual_packer_serviceCobClient* client)> cob, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password) = 0;
  virtual void get_virtual_machine_detail(::apache::thrift::stdcxx::function<void(virtual_packer_serviceCobClient* client)> cob, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id) = 0;
  virtual void power_off_virtual_machine(::apache::thrift::stdcxx::function<void(virtual_packer_serviceCobClient* client)> cob, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id) = 0;
  virtual void remove_virtual_machine(::apache::thrift::stdcxx::function<void(virtual_packer_serviceCobClient* client)> cob, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id) = 0;
  virtual void get_virtual_machine_snapshots(::apache::thrift::stdcxx::function<void(virtual_packer_serviceCobClient* client)> cob, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id) = 0;
  virtual void remove_virtual_machine_snapshot(::apache::thrift::stdcxx::function<void(virtual_packer_serviceCobClient* client)> cob, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id, const std::string& snapshot_id) = 0;
  virtual void get_datacenter_folder_list(::apache::thrift::stdcxx::function<void(virtual_packer_serviceCobClient* client)> cob, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& datacenter) = 0;
  virtual void create_job_ex(::apache::thrift::stdcxx::function<void(virtual_packer_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id, const create_packer_job_detail& create_job) = 0;
  virtual void create_job(::apache::thrift::stdcxx::function<void(virtual_packer_serviceCobClient* client)> cob, const std::string& session_id, const create_packer_job_detail& create_job) = 0;
  virtual void get_job(::apache::thrift::stdcxx::function<void(virtual_packer_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id, const std::string& previous_updated_time) = 0;
  virtual void interrupt_job(::apache::thrift::stdcxx::function<void(virtual_packer_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id) = 0;
  virtual void resume_job(::apache::thrift::stdcxx::function<void(virtual_packer_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id) = 0;
  virtual void remove_job(::apache::thrift::stdcxx::function<void(virtual_packer_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id) = 0;
  virtual void list_jobs(::apache::thrift::stdcxx::function<void(virtual_packer_serviceCobClient* client)> cob, const std::string& session_id) = 0;
  virtual void terminate(::apache::thrift::stdcxx::function<void(virtual_packer_serviceCobClient* client)> cob, const std::string& session_id) = 0;
  virtual void running_job(::apache::thrift::stdcxx::function<void(virtual_packer_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id) = 0;
};

class virtual_packer_serviceCobSvIf : virtual public common_serviceCobSvIf {
 public:
  virtual ~virtual_packer_serviceCobSvIf() {}
  virtual void get_virtual_host_info(::apache::thrift::stdcxx::function<void(virtual_host const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password) = 0;
  virtual void get_virtual_hosts(::apache::thrift::stdcxx::function<void(std::vector<virtual_host>  const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password) = 0;
  virtual void get_virtual_machine_detail(::apache::thrift::stdcxx::function<void(virtual_machine const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id) = 0;
  virtual void power_off_virtual_machine(::apache::thrift::stdcxx::function<void(bool const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id) = 0;
  virtual void remove_virtual_machine(::apache::thrift::stdcxx::function<void(bool const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id) = 0;
  virtual void get_virtual_machine_snapshots(::apache::thrift::stdcxx::function<void(std::vector<vmware_snapshot>  const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id) = 0;
  virtual void remove_virtual_machine_snapshot(::apache::thrift::stdcxx::function<void(bool const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id, const std::string& snapshot_id) = 0;
  virtual void get_datacenter_folder_list(::apache::thrift::stdcxx::function<void(std::vector<std::string>  const& _return)> cob, ::apache::thrift::stdcxx::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& datacenter) = 0;
...
class virtual_packer_serviceCobSvIfSingletonFactory : virtual public virtual_packer_serviceCobSvIfFactory {
 public:
  virtual_packer_serviceCobSvIfSingletonFactory(const ::apache::thrift::stdcxx::shared_ptr<virtual_packer_serviceCobSvIf>& iface) : iface_(iface) {}
 ...
 protected:
  ::apache::thrift::stdcxx::shared_ptr<virtual_packer_serviceCobSvIf> iface_;
};
...
class virtual_packer_serviceCobClient : virtual public virtual_packer_serviceCobClIf, public common_serviceCobClient {
 public:
  virtual_packer_serviceCobClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::async::TAsyncChannel> channel, ::apache::thrift::protocol::TProtocolFactory* protocolFactory) :
  ...
  void get_virtual_host_info(::apache::thrift::stdcxx::function<void(virtual_packer_serviceCobClient* client)> cob, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password);
  void send_get_virtual_host_info(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password);
  void recv_get_virtual_host_info(virtual_host& _return);
  void get_virtual_hosts(::apache::thrift::stdcxx::function<void(virtual_packer_serviceCobClient* client)> cob, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password);
  void send_get_virtual_hosts(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password);
  void recv_get_virtual_hosts(std::vector<virtual_host> & _return);
  void get_virtual_machine_detail(::apache::thrift::stdcxx::function<void(virtual_packer_serviceCobClient* client)> cob, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id);
  void send_get_virtual_machine_detail(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id);
  void recv_get_virtual_machine_detail(virtual_machine& _return);
  void power_off_virtual_machine(::apache::thrift::stdcxx::function<void(virtual_packer_serviceCobClient* client)> cob, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id);
  void send_power_off_virtual_machine(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id);
  bool recv_power_off_virtual_machine();
  void remove_virtual_machine(::apache::thrift::stdcxx::function<void(virtual_packer_serviceCobClient* client)> cob, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id);
  void send_remove_virtual_machine(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id);
  bool recv_remove_virtual_machine();
  void get_virtual_machine_snapshots(::apache::thrift::stdcxx::function<void(virtual_packer_serviceCobClient* client)> cob, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id);
  void send_get_virtual_machine_snapshots(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id);
  void recv_get_virtual_machine_snapshots(std::vector<vmware_snapshot> & _return);
  void remove_virtual_machine_snapshot(::apache::thrift::stdcxx::function<void(virtual_packer_serviceCobClient* client)> cob, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id, const std::string& snapshot_id);
  void send_remove_virtual_machine_snapshot(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& machine_id, const std::string& snapshot_id);
  bool recv_remove_virtual_machine_snapshot();
  void get_datacenter_folder_list(::apache::thrift::stdcxx::function<void(virtual_packer_serviceCobClient* client)> cob, const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& datacenter);
  void send_get_datacenter_folder_list(const std::string& session_id, const std::string& host, const std::string& username, const std::string& password, const std::string& datacenter);
  void recv_get_datacenter_folder_list(std::vector<std::string> & _return);
  void create_job_ex(::apache::thrift::stdcxx::function<void(virtual_packer_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id, const create_packer_job_detail& create_job);
  void send_create_job_ex(const std::string& session_id, const std::string& job_id, const create_packer_job_detail& create_job);
  void recv_create_job_ex(packer_job_detail& _return);
  void create_job(::apache::thrift::stdcxx::function<void(virtual_packer_serviceCobClient* client)> cob, const std::string& session_id, const create_packer_job_detail& create_job);
  void send_create_job(const std::string& session_id, const create_packer_job_detail& create_job);
  void recv_create_job(packer_job_detail& _return);
  void get_job(::apache::thrift::stdcxx::function<void(virtual_packer_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id, const std::string& previous_updated_time);
  void send_get_job(const std::string& session_id, const std::string& job_id, const std::string& previous_updated_time);
  void recv_get_job(packer_job_detail& _return);
  void interrupt_job(::apache::thrift::stdcxx::function<void(virtual_packer_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id);
  void send_interrupt_job(const std::string& session_id, const std::string& job_id);
  bool recv_interrupt_job();
  void resume_job(::apache::thrift::stdcxx::function<void(virtual_packer_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id);
  void send_resume_job(const std::string& session_id, const std::string& job_id);
  bool recv_resume_job();
  void remove_job(::apache::thrift::stdcxx::function<void(virtual_packer_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id);
  void send_remove_job(const std::string& session_id, const std::string& job_id);
  bool recv_remove_job();
  void list_jobs(::apache::thrift::stdcxx::function<void(virtual_packer_serviceCobClient* client)> cob, const std::string& session_id);
  void send_list_jobs(const std::string& session_id);
  void recv_list_jobs(std::vector<packer_job_detail> & _return);
  void terminate(::apache::thrift::stdcxx::function<void(virtual_packer_serviceCobClient* client)> cob, const std::string& session_id);
  void send_terminate(const std::string& session_id);
  void recv_terminate();
  void running_job(::apache::thrift::stdcxx::function<void(virtual_packer_serviceCobClient* client)> cob, const std::string& session_id, const std::string& job_id);
  void send_running_job(const std::string& session_id, const std::string& job_id);
  bool recv_running_job();
};
...
class virtual_packer_serviceAsyncProcessor : public common_serviceAsyncProcessor {
 ...
 private:
  typedef  void (virtual_packer_serviceAsyncProcessor::*ProcessFunction)(::apache::thrift::stdcxx::function<void(bool ok)>, int32_t, ::apache::thrift::protocol::TProtocol*, ::apache::thrift::protocol::TProtocol*);
  typedef std::map<std::string, ProcessFunction> ProcessMap;
  ProcessMap processMap_;
  void process_get_virtual_host_info(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_get_virtual_host_info(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const virtual_host& _return);
  void throw_get_virtual_host_info(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_get_virtual_hosts(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_get_virtual_hosts(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::vector<virtual_host> & _return);
  void throw_get_virtual_hosts(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_get_virtual_machine_detail(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_get_virtual_machine_detail(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const virtual_machine& _return);
  void throw_get_virtual_machine_detail(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_power_off_virtual_machine(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_power_off_virtual_machine(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return);
  void throw_power_off_virtual_machine(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_remove_virtual_machine(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_remove_virtual_machine(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return);
  void throw_remove_virtual_machine(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_get_virtual_machine_snapshots(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_get_virtual_machine_snapshots(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::vector<vmware_snapshot> & _return);
  void throw_get_virtual_machine_snapshots(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_remove_virtual_machine_snapshot(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_remove_virtual_machine_snapshot(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return);
  void throw_remove_virtual_machine_snapshot(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_get_datacenter_folder_list(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_get_datacenter_folder_list(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::vector<std::string> & _return);
  void throw_get_datacenter_folder_list(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
 ...
 public:
  virtual_packer_serviceAsyncProcessor(::apache::thrift::stdcxx::shared_ptr<virtual_packer_serviceCobSvIf> iface) :
    ...
    processMap_["get_virtual_hosts"] = &virtual_packer_serviceAsyncProcessor::process_get_virtual_hosts;
    processMap_["get_virtual_machine_detail"] = &virtual_packer_serviceAsyncProcessor::process_get_virtual_machine_detail;
    processMap_["power_off_virtual_machine"] = &virtual_packer_serviceAsyncProcessor::process_power_off_virtual_machine;
    processMap_["remove_virtual_machine"] = &virtual_packer_serviceAsyncProcessor::process_remove_virtual_machine;
    processMap_["get_virtual_machine_snapshots"] = &virtual_packer_serviceAsyncProcessor::process_get_virtual_machine_snapshots;
    processMap_["remove_virtual_machine_snapshot"] = &virtual_packer_serviceAsyncProcessor::process_remove_virtual_machine_snapshot;
    processMap_["get_datacenter_folder_list"] = &virtual_packer_serviceAsyncProcessor::process_get_datacenter_folder_list;
...
class virtual_packer_serviceAsyncProcessorFactory : public ::apache::thrift::async::TAsyncProcessorFactory {
 public:
  virtual_packer_serviceAsyncProcessorFactory(const ::apache::thrift::stdcxx::shared_ptr< virtual_packer_serviceCobSvIfFactory >& handlerFactory) :
      handlerFactory_(handlerFactory) {}
 ...
 protected:
  ::apache::thrift::stdcxx::shared_ptr< virtual_packer_serviceCobSvIfFactory > handlerFactory_;
};
