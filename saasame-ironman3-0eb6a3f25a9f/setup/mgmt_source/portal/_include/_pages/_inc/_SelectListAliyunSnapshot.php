			...
			success:function(jso)
			{
				...
				{					
					...
					$.each(jso, function(key,value)
					{
						...
						{
							$('#'+SelectKey+'').append(new Option(value['description']+' ('+'in progress '+value["progress"]+')', data, true, false));
							$("#"+SelectKey+" option[value='"+ data + "']").attr('disabled', true); 
						}
					});
