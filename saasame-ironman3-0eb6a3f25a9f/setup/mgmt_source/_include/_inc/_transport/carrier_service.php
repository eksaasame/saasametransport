...
class carrier_serviceClient extends \saasame\transport\common_connection_serviceClient implements \saasame\transport\carrier_serviceIf
{
    ...
    public function recv_create()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\saasame\transport\carrier_service_create_result',
    ...
    public function recv_create_ex()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\saasame\transport\carrier_service_create_ex_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function recv_open()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\saasame\transport\carrier_service_open_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function recv_read()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\saasame\transport\carrier_service_read_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function recv_write()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\saasame\transport\carrier_service_write_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function recv_write_ex()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\saasame\transport\carrier_service_write_ex_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function recv_close()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\saasame\transport\carrier_service_close_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function recv_remove_base_image()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\saasame\transport\carrier_service_remove_base_image_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function recv_remove_snapshot_image()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\saasame\transport\carrier_service_remove_snapshot_image_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function recv_verify_management()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\saasame\transport\carrier_service_verify_management_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function recv_set_buffer_size()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\saasame\transport\carrier_service_set_buffer_size_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function recv_is_buffer_free()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\saasame\transport\carrier_service_is_buffer_free_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function recv_is_image_replicated()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\saasame\transport\carrier_service_is_image_replicated_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
...
class carrier_service_create_ex_args
{
            ...
            switch ($fid) {
                ...
                case 2:
                    if ($ftype == TType::SET) {
                        ...
                        $_size1286 = 0;
                        $_etype1289 = 0;
                        $xfer += $input->readSetBegin($_etype1289, $_size1286);
                        for ($_i1290 = 0; $_i1290 < $_size1286; ++$_i1290) {
                            $elem1291 = null;
                            $xfer += $input->readString($elem1291);
                            $this->connection_ids[$elem1291] = true;
                        }
    ...
    public function write($output)
    {
        ...
        if ($this->connection_ids !== null) {
            ...
            foreach ($this->connection_ids as $iter1292 => $iter1293) {
...
class carrier_service_open_args
{
            ...
            switch ($fid) {
                ...
                case 2:
                    if ($ftype == TType::SET) {
                        ...
                        $_size1294 = 0;
                        $_etype1297 = 0;
                        $xfer += $input->readSetBegin($_etype1297, $_size1294);
                        for ($_i1298 = 0; $_i1298 < $_size1294; ++$_i1298) {
                            $elem1299 = null;
                            $xfer += $input->readString($elem1299);
                            $this->connection_ids[$elem1299] = true;
                        }
                        $xfer += $input->readSetEnd();
                    } else {
                        $xfer += $input->skip($ftype);
    ...
    public function write($output)
    {
        ...
        if ($this->connection_ids !== null) {
            ...
            $xfer += $output->writeFieldBegin('connection_ids', TType::SET, 2);
            $output->writeSetBegin(TType::STRING, count($this->connection_ids));
            foreach ($this->connection_ids as $iter1300 => $iter1301) {
...
class carrier_service_remove_base_image_args
{
            ...
            switch ($fid) {
                ...
                case 2:
                    if ($ftype == TType::SET) {
                        ...
                        $_size1302 = 0;
                        $_etype1305 = 0;
                        $xfer += $input->readSetBegin($_etype1305, $_size1302);
                        for ($_i1306 = 0; $_i1306 < $_size1302; ++$_i1306) {
                            $elem1307 = null;
                            $xfer += $input->readString($elem1307);
                            $this->base_images[$elem1307] = true;
                        }
                        $xfer += $input->readSetEnd();
                    } else {
                        $xfer += $input->skip($ftype);
    ...
    public function write($output)
    {
        ...
        if ($this->base_images !== null) {
            ...
            foreach ($this->base_images as $iter1308 => $iter1309) {
...
class carrier_service_remove_snapshot_image_args
{
                ...
                case 2:
                    if ($ftype == TType::MAP) {
                        ...
                        for ($_i1314 = 0; $_i1314 < $_size1310; ++$_i1314) {
                            $key1315 = '';
                            $val1316 = new \saasame\transport\image_map_info();
                            $xfer += $input->readString($key1315);
                            $val1316 = new \saasame\transport\image_map_info();
                            $xfer += $val1316->read($input);
                            $this->images[$key1315] = $val1316;
                        }
    ...
    public function write($output)
    {
        ...
        if ($this->images !== null) {
            ...
            foreach ($this->images as $kiter1317 => $viter1318) {
                $xfer += $output->writeString($kiter1317);
                $xfer += $viter1318->write($output);
            }
            $output->writeMapEnd();
            $xfer += $output->writeFieldEnd();
        }
...
class carrier_service_is_image_replicated_args
{
                ...
                case 2:
                    if ($ftype == TType::SET) {
                        ...
                        for ($_i1323 = 0; $_i1323 < $_size1319; ++$_i1323) {
                            ...
                            $this->connection_ids[$elem1324] = true;
                        }
                        $xfer += $input->readSetEnd();
                    } else {
                        $xfer += $input->skip($ftype);
    ...
    public function write($output)
    {
        ...
        if ($this->connection_ids !== null) {
            ...
            $xfer += $output->writeFieldBegin('connection_ids', TType::SET, 2);
            $output->writeSetBegin(TType::STRING, count($this->connection_ids));
            foreach ($this->connection_ids as $iter1325 => $iter1326) {
...
class carrier_serviceProcessor extends \saasame\transport\common_connection_serviceProcessor
{
    ...
    protected function process_create($seqid, $input, $output)
    {
        ...
        if ($bin_accel) {
            $args = thrift_protocol_read_binary_after_message_begin(
                $input,
                '\saasame\transport\carrier_service_create_args',
                $input->isStrictRead()
            );
        } else {
            $args = new \saasame\transport\carrier_service_create_args();
    ...
    protected function process_create_ex($seqid, $input, $output)
    {
        ...
        if ($bin_accel) {
            $args = thrift_protocol_read_binary_after_message_begin(
                $input,
                '\saasame\transport\carrier_service_create_ex_args',
                $input->isStrictRead()
            );
        } else {
            $args = new \saasame\transport\carrier_service_create_ex_args();
    ...
    protected function process_open($seqid, $input, $output)
    {
        ...
        if ($bin_accel) {
            $args = thrift_protocol_read_binary_after_message_begin(
                $input,
                '\saasame\transport\carrier_service_open_args',
                $input->isStrictRead()
            );
        } else {
            $args = new \saasame\transport\carrier_service_open_args();
    ...
    protected function process_read($seqid, $input, $output)
    {
        ...
        if ($bin_accel) {
            $args = thrift_protocol_read_binary_after_message_begin(
                $input,
                '\saasame\transport\carrier_service_read_args',
                $input->isStrictRead()
            );
        } else {
            $args = new \saasame\transport\carrier_service_read_args();
    ...
    protected function process_write($seqid, $input, $output)
    {
        ...
        if ($bin_accel) {
            $args = thrift_protocol_read_binary_after_message_begin(
                $input,
                '\saasame\transport\carrier_service_write_args',
                $input->isStrictRead()
            );
        } else {
            $args = new \saasame\transport\carrier_service_write_args();
    ...
    protected function process_write_ex($seqid, $input, $output)
    {
        ...
        if ($bin_accel) {
            $args = thrift_protocol_read_binary_after_message_begin(
                $input,
                '\saasame\transport\carrier_service_write_ex_args',
                $input->isStrictRead()
            );
        } else {
            $args = new \saasame\transport\carrier_service_write_ex_args();
    ...
    protected function process_close($seqid, $input, $output)
    {
        ...
        if ($bin_accel) {
            $args = thrift_protocol_read_binary_after_message_begin(
                $input,
                '\saasame\transport\carrier_service_close_args',
                $input->isStrictRead()
            );
        } else {
            $args = new \saasame\transport\carrier_service_close_args();
    ...
    protected function process_remove_base_image($seqid, $input, $output)
    {
        ...
        if ($bin_accel) {
            $args = thrift_protocol_read_binary_after_message_begin(
                $input,
                '\saasame\transport\carrier_service_remove_base_image_args',
                $input->isStrictRead()
            );
        } else {
            $args = new \saasame\transport\carrier_service_remove_base_image_args();
    ...
    protected function process_remove_snapshot_image($seqid, $input, $output)
    {
        ...
        if ($bin_accel) {
            $args = thrift_protocol_read_binary_after_message_begin(
                $input,
                '\saasame\transport\carrier_service_remove_snapshot_image_args',
                $input->isStrictRead()
            );
        } else {
            $args = new \saasame\transport\carrier_service_remove_snapshot_image_args();
    ...
    protected function process_verify_management($seqid, $input, $output)
    {
        ...
        if ($bin_accel) {
            $args = thrift_protocol_read_binary_after_message_begin(
                $input,
                '\saasame\transport\carrier_service_verify_management_args',
                $input->isStrictRead()
            );
        } else {
            $args = new \saasame\transport\carrier_service_verify_management_args();
    ...
    protected function process_set_buffer_size($seqid, $input, $output)
    {
        ...
        if ($bin_accel) {
            $args = thrift_protocol_read_binary_after_message_begin(
                $input,
                '\saasame\transport\carrier_service_set_buffer_size_args',
                $input->isStrictRead()
            );
        } else {
            $args = new \saasame\transport\carrier_service_set_buffer_size_args();
    ...
    protected function process_is_buffer_free($seqid, $input, $output)
    {
        ...
        if ($bin_accel) {
            $args = thrift_protocol_read_binary_after_message_begin(
                $input,
                '\saasame\transport\carrier_service_is_buffer_free_args',
                $input->isStrictRead()
            );
        } else {
            $args = new \saasame\transport\carrier_service_is_buffer_free_args();
    ...
    protected function process_is_image_replicated($seqid, $input, $output)
    {
        ...
        if ($bin_accel) {
            $args = thrift_protocol_read_binary_after_message_begin(
                $input,
                '\saasame\transport\carrier_service_is_image_replicated_args',
                $input->isStrictRead()
            );
        } else {
            $args = new \saasame\transport\carrier_service_is_image_replicated_args();
