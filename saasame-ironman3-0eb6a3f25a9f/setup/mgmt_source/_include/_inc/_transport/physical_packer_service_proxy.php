...
interface physical_packer_service_proxyIf extends \saasame\transport\common_serviceIf
{
     ...
     * @param string $session_id
     * @param string $addr
     * @param \saasame\transport\take_snapshots_parameters $parameters
     * @return \saasame\transport\snapshot[]
     * @throws \saasame\transport\invalid_operation
     */
    public function take_snapshots2_p($session_id, $addr, \saasame\transport\TakeSnapshotsParameters $parameters);
    /**
     * @param string $session_id
     * @param string $addr
...
class physical_packer_service_proxyClient extends \saasame\transport\common_serviceClient implements \saasame\transport\physical_packer_service_proxyIf
{
    ...
    public function recv_packer_ping_p()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\saasame\transport\physical_packer_service_proxy_packer_ping_p_result',
    ...
    public function recv_take_snapshots_p()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\saasame\transport\physical_packer_service_proxy_take_snapshots_p_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function recv_take_snapshots_ex_p()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\saasame\transport\physical_packer_service_proxy_take_snapshots_ex_p_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function take_snapshots2_p($session_id, $addr, \saasame\transport\TakeSnapshotsParameters $parameters)
    {
        $this->send_take_snapshots2_p($session_id, $addr, $parameters);
        return $this->recv_take_snapshots2_p();
    }

    public function send_take_snapshots2_p($session_id, $addr, \saasame\transport\TakeSnapshotsParameters $parameters)
    {
        $args = new \saasame\transport\physical_packer_service_proxy_take_snapshots2_p_args();
        $args->session_id = $session_id;
        $args->addr = $addr;
        ...
        if ($bin_accel) {
            ...
            $this->output_->writeMessageBegin('take_snapshots2_p', TMessageType::CALL, $this->seqid_);
            $args->write($this->output_);
            $this->output_->writeMessageEnd();
            $this->output_->getTransport()->flush();
        }
    ...
    public function recv_take_snapshots2_p()
    {
        $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\saasame\transport\physical_packer_service_proxy_take_snapshots2_p_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
            ...
            $result = new \saasame\transport\physical_packer_service_proxy_take_snapshots2_p_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
        ...
        throw new \Exception("take_snapshots2_p failed: unknown result");
    }
    ...
    public function recv_delete_snapshot_p()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\saasame\transport\physical_packer_service_proxy_delete_snapshot_p_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function recv_delete_snapshot_set_p()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\saasame\transport\physical_packer_service_proxy_delete_snapshot_set_p_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function recv_get_all_snapshots_p()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\saasame\transport\physical_packer_service_proxy_get_all_snapshots_p_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function recv_create_packer_job_ex_p()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\saasame\transport\physical_packer_service_proxy_create_packer_job_ex_p_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function recv_get_packer_job_p()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\saasame\transport\physical_packer_service_proxy_get_packer_job_p_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function recv_interrupt_packer_job_p()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\saasame\transport\physical_packer_service_proxy_interrupt_packer_job_p_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function recv_resume_packer_job_p()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\saasame\transport\physical_packer_service_proxy_resume_packer_job_p_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function recv_remove_packer_job_p()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\saasame\transport\physical_packer_service_proxy_remove_packer_job_p_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function recv_running_packer_job_p()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\saasame\transport\physical_packer_service_proxy_running_packer_job_p_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function recv_enumerate_packer_disks_p()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\saasame\transport\physical_packer_service_proxy_enumerate_packer_disks_p_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function recv_verify_packer_carrier_p()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\saasame\transport\physical_packer_service_proxy_verify_packer_carrier_p_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function recv_get_packer_host_detail_p()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\saasame\transport\physical_packer_service_proxy_get_packer_host_detail_p_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
...
class physical_packer_service_proxy_take_snapshots_p_args
{
            ...
            switch ($fid) {
                ...
                case 3:
                    if ($ftype == TType::SET) {
                        ...
                        $_size1350 = 0;
                        $_etype1353 = 0;
                        $xfer += $input->readSetBegin($_etype1353, $_size1350);
                        for ($_i1354 = 0; $_i1354 < $_size1350; ++$_i1354) {
                            $elem1355 = null;
                            $xfer += $input->readString($elem1355);
                            $this->disks[$elem1355] = true;
                        }
    ...
    public function write($output)
    {
        ...
        if ($this->disks !== null) {
            ...
            foreach ($this->disks as $iter1356 => $iter1357) {
                ...
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i1362 = 0; $_i1362 < $_size1358; ++$_i1362) {
                            $elem1363 = null;
                            $elem1363 = new \saasame\transport\snapshot();
...
class physical_packer_service_proxy_take_snapshots_ex_p_args
{
            ...
            switch ($fid) {
                ...
                case 3:
                    if ($ftype == TType::SET) {
                        ...
                        $_size1365 = 0;
                        $_etype1368 = 0;
                        $xfer += $input->readSetBegin($_etype1368, $_size1365);
                        for ($_i1369 = 0; $_i1369 < $_size1365; ++$_i1369) {
                            $elem1370 = null;
                            $xfer += $input->readString($elem1370);
                            $this->disks[$elem1370] = true;
                        }
                        $xfer += $input->readSetEnd();
                    } else {
                        $xfer += $input->skip($ftype);
    ...
    public function write($output)
    {
        ...
        if ($this->disks !== null) {
            ...
            $xfer += $output->writeFieldBegin('disks', TType::SET, 3);
            $output->writeSetBegin(TType::STRING, count($this->disks));
            foreach ($this->disks as $iter1371 => $iter1372) {
                ...
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i1377 = 0; $_i1377 < $_size1373; ++$_i1377) {
                            $elem1378 = null;
                            $elem1378 = new \saasame\transport\snapshot();
...
class physical_packer_service_proxy_take_snapshots2_p_args
{
    ...
    static public $_TSPEC = array(
        ...
        3 => array(
            ...
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\saasame\transport\take_snapshots_parameters',
        ),
    );
    ...
    public $addr = null;
    /**
     * @var \saasame\transport\take_snapshots_parameters
     */
    ...
    public function getName()
    {
        return 'physical_packer_service_proxy_take_snapshots2_p_args';
    }
    ...
    public function read($input)
    {
        ...
        while (true) {
            ...
            switch ($fid) {
                ...
                case 3:
                    if ($ftype == TType::STRUCT) {
                        $this->parameters = new \saasame\transport\take_snapshots_parameters();
    ...
    {
        $xfer = 0;
        $xfer += $output->writeStructBegin('physical_packer_service_proxy_take_snapshots2_p_args');
        if ($this->session_id !== null) {
            $xfer += $output->writeFieldBegin('session_id', TType::STRING, 1);
            $xfer += $output->writeString($this->session_id);
            $xfer += $output->writeFieldEnd();
...
class physical_packer_service_proxy_take_snapshots2_p_result
{
    ...
    public function getName()
    {
        return 'physical_packer_service_proxy_take_snapshots2_p_result';
    }
                ...
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i1384 = 0; $_i1384 < $_size1380; ++$_i1384) {
                            $elem1385 = null;
                            $elem1385 = new \saasame\transport\snapshot();
    ...
    {
        $xfer = 0;
        $xfer += $output->writeStructBegin('physical_packer_service_proxy_take_snapshots2_p_result');
        if ($this->success !== null) {
            if (!is_array($this->success)) {
                throw new TProtocolException('Bad type in structure.', TProtocolException::INVALID_DATA);
            }
...
class physical_packer_service_proxy_get_all_snapshots_p_result
{
                    ...
                    if ($ftype == TType::MAP) {
                        ...
                        for ($_i1391 = 0; $_i1391 < $_size1387; ++$_i1391) {
                            ...
                            for ($_i1398 = 0; $_i1398 < $_size1394; ++$_i1398) {
                                $elem1399 = null;
                                $elem1399 = new \saasame\transport\snapshot();
                                $xfer += $elem1399->read($input);
                                $val1393 []= $elem1399;
                            }
                            $xfer += $input->readListEnd();
                            $this->success[$key1392] = $val1393;
                        }
    ...
    public function write($output)
    {
        ...
        if ($this->success !== null) {
            ...
            foreach ($this->success as $kiter1400 => $viter1401) {
                $xfer += $output->writeString($kiter1400);
                $output->writeListBegin(TType::STRUCT, count($viter1401));
                foreach ($viter1401 as $iter1402) {
...
class physical_packer_service_proxy_enumerate_packer_disks_p_result
{
            ...
            switch ($fid) {
                case 0:
                    if ($ftype == TType::SET) {
                        ...
                        $_size1403 = 0;
                        $_etype1406 = 0;
                        $xfer += $input->readSetBegin($_etype1406, $_size1403);
                        for ($_i1407 = 0; $_i1407 < $_size1403; ++$_i1407) {
                            $elem1408 = null;
                            $elem1408 = new \saasame\transport\disk_info();
    ...
    public function write($output)
    {
        ...
        if ($this->success !== null) {
            ...
            foreach ($this->success as $iter1409 => $iter1410) {
...
class physical_packer_service_proxyProcessor extends \saasame\transport\common_serviceProcessor
{
    ...
    protected function process_packer_ping_p($seqid, $input, $output)
    {
        ...
        if ($bin_accel) {
            $args = thrift_protocol_read_binary_after_message_begin(
                $input,
                '\saasame\transport\physical_packer_service_proxy_packer_ping_p_args',
                $input->isStrictRead()
            );
        } else {
            $args = new \saasame\transport\physical_packer_service_proxy_packer_ping_p_args();
    ...
    protected function process_take_snapshots_p($seqid, $input, $output)
    {
        ...
        if ($bin_accel) {
            $args = thrift_protocol_read_binary_after_message_begin(
                $input,
                '\saasame\transport\physical_packer_service_proxy_take_snapshots_p_args',
                $input->isStrictRead()
            );
        } else {
            $args = new \saasame\transport\physical_packer_service_proxy_take_snapshots_p_args();
    ...
    protected function process_take_snapshots_ex_p($seqid, $input, $output)
    {
        ...
        if ($bin_accel) {
            $args = thrift_protocol_read_binary_after_message_begin(
                $input,
                '\saasame\transport\physical_packer_service_proxy_take_snapshots_ex_p_args',
                $input->isStrictRead()
            );
        } else {
            $args = new \saasame\transport\physical_packer_service_proxy_take_snapshots_ex_p_args();
    ...
    protected function process_take_snapshots2_p($seqid, $input, $output)
    {
        $bin_accel = ($input instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary_after_message_begin');
        if ($bin_accel) {
            $args = thrift_protocol_read_binary_after_message_begin(
                $input,
                '\saasame\transport\physical_packer_service_proxy_take_snapshots2_p_args',
                $input->isStrictRead()
            );
        } else {
            $args = new \saasame\transport\physical_packer_service_proxy_take_snapshots2_p_args();
        ...
        $result = new \saasame\transport\physical_packer_service_proxy_take_snapshots2_p_result();
        try {
            $result->success = $this->handler_->take_snapshots2_p($args->session_id, $args->addr, $args->parameters);
        } catch (\saasame\transport\invalid_operation $ouch) {
            $result->ouch = $ouch;
        }
        $bin_accel = ($output instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            ...
            $output->writeMessageBegin('take_snapshots2_p', TMessageType::REPLY, $seqid);
            $result->write($output);
            $output->writeMessageEnd();
            $output->getTransport()->flush();
        }
    ...
    protected function process_delete_snapshot_p($seqid, $input, $output)
    {
        ...
        if ($bin_accel) {
            $args = thrift_protocol_read_binary_after_message_begin(
                $input,
                '\saasame\transport\physical_packer_service_proxy_delete_snapshot_p_args',
                $input->isStrictRead()
            );
        } else {
            $args = new \saasame\transport\physical_packer_service_proxy_delete_snapshot_p_args();
    ...
    protected function process_delete_snapshot_set_p($seqid, $input, $output)
    {
        ...
        if ($bin_accel) {
            $args = thrift_protocol_read_binary_after_message_begin(
                $input,
                '\saasame\transport\physical_packer_service_proxy_delete_snapshot_set_p_args',
                $input->isStrictRead()
            );
        } else {
            $args = new \saasame\transport\physical_packer_service_proxy_delete_snapshot_set_p_args();
    ...
    protected function process_get_all_snapshots_p($seqid, $input, $output)
    {
        ...
        if ($bin_accel) {
            $args = thrift_protocol_read_binary_after_message_begin(
                $input,
                '\saasame\transport\physical_packer_service_proxy_get_all_snapshots_p_args',
                $input->isStrictRead()
            );
        } else {
            $args = new \saasame\transport\physical_packer_service_proxy_get_all_snapshots_p_args();
    ...
    protected function process_create_packer_job_ex_p($seqid, $input, $output)
    {
        ...
        if ($bin_accel) {
            $args = thrift_protocol_read_binary_after_message_begin(
                $input,
                '\saasame\transport\physical_packer_service_proxy_create_packer_job_ex_p_args',
                $input->isStrictRead()
            );
        } else {
            $args = new \saasame\transport\physical_packer_service_proxy_create_packer_job_ex_p_args();
    ...
    protected function process_get_packer_job_p($seqid, $input, $output)
    {
        ...
        if ($bin_accel) {
            $args = thrift_protocol_read_binary_after_message_begin(
                $input,
                '\saasame\transport\physical_packer_service_proxy_get_packer_job_p_args',
                $input->isStrictRead()
            );
        } else {
            $args = new \saasame\transport\physical_packer_service_proxy_get_packer_job_p_args();
    ...
    protected function process_interrupt_packer_job_p($seqid, $input, $output)
    {
        ...
        if ($bin_accel) {
            $args = thrift_protocol_read_binary_after_message_begin(
                $input,
                '\saasame\transport\physical_packer_service_proxy_interrupt_packer_job_p_args',
                $input->isStrictRead()
            );
        } else {
            $args = new \saasame\transport\physical_packer_service_proxy_interrupt_packer_job_p_args();
    ...
    protected function process_resume_packer_job_p($seqid, $input, $output)
    {
        ...
        if ($bin_accel) {
            $args = thrift_protocol_read_binary_after_message_begin(
                $input,
                '\saasame\transport\physical_packer_service_proxy_resume_packer_job_p_args',
                $input->isStrictRead()
            );
        } else {
            $args = new \saasame\transport\physical_packer_service_proxy_resume_packer_job_p_args();
    ...
    protected function process_remove_packer_job_p($seqid, $input, $output)
    {
        ...
        if ($bin_accel) {
            $args = thrift_protocol_read_binary_after_message_begin(
                $input,
                '\saasame\transport\physical_packer_service_proxy_remove_packer_job_p_args',
                $input->isStrictRead()
            );
        } else {
            $args = new \saasame\transport\physical_packer_service_proxy_remove_packer_job_p_args();
    ...
    protected function process_running_packer_job_p($seqid, $input, $output)
    {
        ...
        if ($bin_accel) {
            $args = thrift_protocol_read_binary_after_message_begin(
                $input,
                '\saasame\transport\physical_packer_service_proxy_running_packer_job_p_args',
                $input->isStrictRead()
            );
        } else {
            $args = new \saasame\transport\physical_packer_service_proxy_running_packer_job_p_args();
    ...
    protected function process_enumerate_packer_disks_p($seqid, $input, $output)
    {
        ...
        if ($bin_accel) {
            $args = thrift_protocol_read_binary_after_message_begin(
                $input,
                '\saasame\transport\physical_packer_service_proxy_enumerate_packer_disks_p_args',
                $input->isStrictRead()
            );
        } else {
            $args = new \saasame\transport\physical_packer_service_proxy_enumerate_packer_disks_p_args();
    ...
    protected function process_verify_packer_carrier_p($seqid, $input, $output)
    {
        ...
        if ($bin_accel) {
            $args = thrift_protocol_read_binary_after_message_begin(
                $input,
                '\saasame\transport\physical_packer_service_proxy_verify_packer_carrier_p_args',
                $input->isStrictRead()
            );
        } else {
            $args = new \saasame\transport\physical_packer_service_proxy_verify_packer_carrier_p_args();
    ...
    protected function process_get_packer_host_detail_p($seqid, $input, $output)
    {
        ...
        if ($bin_accel) {
            $args = thrift_protocol_read_binary_after_message_begin(
                $input,
                '\saasame\transport\physical_packer_service_proxy_get_packer_host_detail_p_args',
                $input->isStrictRead()
            );
        } else {
            $args = new \saasame\transport\physical_packer_service_proxy_get_packer_host_detail_p_args();
