...
<script>
	...
	var NextPage = "RecoverVMWareSummary";
	...
	<div id='wrapper_block_wizard'>	
		<div class="page">
			...
			<div id='form_block_wizard'>
				...
				<div class="float_row" >
					<label for='comment' style="width:33%"><?php echo _("VM Name"); ?></label>
					<label for='comment' style="width:33%"><?php echo _("OS"); ?></label>
					<label for='comment' style="width:8%"><i class="fa fa-retweet" aria-hidden="true"></i> <?php echo _("Conversion"); ?></label>
					<label for='comment' style="width:9%"><i class="fa fa-retweet" aria-hidden="true"></i> <?php echo _("VMware Tools"); ?></label>
					<div class='form-group form-inline'>
						...
						<input id="CONVERT" data-toggle="toggle" data-width="8%" data-style="slow" type="checkbox" checked>
						<input id="VM_TOOL" data-toggle="toggle" data-width="8%" data-style="slow" type="checkbox" checked>
					</div>
				</div>
