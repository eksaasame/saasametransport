					...
					$.each(jso.servers, function(key,value)
					{
						...
						(
							'<tr>\
								 ...
								 <td width="240px">'+fixed_addr+'</td>\
								 <td width="240px">'+floating_addr+'</td>\
								 <td width="138px">'+value.flavor.id+'</td>\
								 <td width="138px">'+value['OS-EXT-AZ:availability_zone']+'</td>\
	...
	function SelectedInstance(){
		$.ajax({
			...
			success:function(jso)
			{
				if (jso.code == true)
				{
					window.location.href = "VerifyCtyunTransportServices";					
				}
				else
				{
			...
			<div id='form_block_wizard'>
				<table id="InstanceTable">
					...
					<tr>
						...
						<th width="240px"><?php echo _("IP"); ?></th>
						<th width="240px"><?php echo _("Floating IP"); ?></th>
						<th width="138px"><?php echo _("Instance Type"); ?></th>
						<th width="138px"><?php echo _("Availability Zone"); ?></th>
