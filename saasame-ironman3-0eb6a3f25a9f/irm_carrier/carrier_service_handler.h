...
public:
	...
	virtual bool send_checksum_info(const std::string& session_id, const std::string& connection_id, const std::string& file_name, const std::string& data);
	virtual void receive_checksum_result(std::string& _return, const std::string& session_id, const std::string& connection_id, const std::string& file_name);
...
private:
    ...
    bool is_image_uploaded(std::string parent, std::string connection_id);
