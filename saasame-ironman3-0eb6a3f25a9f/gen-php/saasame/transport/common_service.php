...
class common_serviceClient implements \saasame\transport\common_serviceIf {
  ...
  public function recv_ping()
  {
    ...
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\saasame\transport\common_service_ping_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
  ...
  public function send_get_host_detail($session_id, $filter)
  {
    ...
    if ($bin_accel)
    {
      thrift_protocol_write_binary($this->output_, 'get_host_detail', TMessageType::CALL, $args, $this->seqid_, $this->output_->isStrictWrite());
    }
    else
    {
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\saasame\transport\common_service_get_host_detail_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\saasame\transport\common_service_get_service_list_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
  ...
  public function send_enumerate_disks($filter)
  {
    ...
    if ($bin_accel)
    {
      thrift_protocol_write_binary($this->output_, 'enumerate_disks', TMessageType::CALL, $args, $this->seqid_, $this->output_->isStrictWrite());
    }
    else
    {
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\saasame\transport\common_service_enumerate_disks_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
  ...
  public function send_verify_carrier($carrier, $is_ssl)
  {
    ...
    if ($bin_accel)
    {
      thrift_protocol_write_binary($this->output_, 'verify_carrier', TMessageType::CALL, $args, $this->seqid_, $this->output_->isStrictWrite());
    }
    else
    {
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\saasame\transport\common_service_verify_carrier_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
  ...
  public function send_take_xray()
  {
    ...
    if ($bin_accel)
    {
      thrift_protocol_write_binary($this->output_, 'take_xray', TMessageType::CALL, $args, $this->seqid_, $this->output_->isStrictWrite());
    }
    else
    {
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\saasame\transport\common_service_take_xray_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
  ...
  public function send_take_xrays()
  {
    ...
    if ($bin_accel)
    {
      thrift_protocol_write_binary($this->output_, 'take_xrays', TMessageType::CALL, $args, $this->seqid_, $this->output_->isStrictWrite());
    }
    else
    {
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\saasame\transport\common_service_take_xrays_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
  ...
  public function send_create_mutex($session, $timeout)
  {
    ...
    if ($bin_accel)
    {
      thrift_protocol_write_binary($this->output_, 'create_mutex', TMessageType::CALL, $args, $this->seqid_, $this->output_->isStrictWrite());
    }
    else
    {
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\saasame\transport\common_service_create_mutex_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
  ...
  public function send_delete_mutex($session)
  {
    ...
    if ($bin_accel)
    {
      thrift_protocol_write_binary($this->output_, 'delete_mutex', TMessageType::CALL, $args, $this->seqid_, $this->output_->isStrictWrite());
    }
    else
    {
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\saasame\transport\common_service_delete_mutex_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::SET) {
            ...
            {
              $elem1103 = null;
              $elem1103 = new \saasame\transport\service_info();
  ...
  public function write($output) {
    ...
    if ($this->success !== null) {
      ...
      $xfer += $output->writeFieldBegin('success', TType::SET, 0);
      {
        ...
        {
          foreach ($this->success as $iter1104 => $iter1105)
          {
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::SET) {
            ...
            $_size1106 = 0;
            $_etype1109 = 0;
            $xfer += $input->readSetBegin($_etype1109, $_size1106);
            for ($_i1110 = 0; $_i1110 < $_size1106; ++$_i1110)
            {
              $elem1111 = null;
              $elem1111 = new \saasame\transport\disk_info();
  ...
  public function write($output) {
    ...
    if ($this->success !== null) {
      ...
      $xfer += $output->writeFieldBegin('success', TType::SET, 0);
      {
        $output->writeSetBegin(TType::STRUCT, count($this->success));
        {
          foreach ($this->success as $iter1112 => $iter1113)
          {
...
class common_serviceProcessor {
  ...
  protected function process_ping($seqid, $input, $output) {
    ...
    if ($bin_accel)
    {
      $args = thrift_protocol_read_binary_after_message_begin($input, '\saasame\transport\common_service_ping_args', $input->isStrictRead());
    }
    else
    {
      $args = new \saasame\transport\common_service_ping_args();
  ...
  protected function process_get_host_detail($seqid, $input, $output) {
    ...
    if ($bin_accel)
    {
      $args = thrift_protocol_read_binary_after_message_begin($input, '\saasame\transport\common_service_get_host_detail_args', $input->isStrictRead());
    }
    else
    {
      $args = new \saasame\transport\common_service_get_host_detail_args();
    ...
    if ($bin_accel)
    {
      thrift_protocol_write_binary($output, 'get_host_detail', TMessageType::REPLY, $result, $seqid, $output->isStrictWrite());
    }
    else
    {
  ...
  protected function process_get_service_list($seqid, $input, $output) {
    ...
    if ($bin_accel)
    {
      $args = thrift_protocol_read_binary_after_message_begin($input, '\saasame\transport\common_service_get_service_list_args', $input->isStrictRead());
    }
    else
    {
      $args = new \saasame\transport\common_service_get_service_list_args();
    ...
    if ($bin_accel)
    {
      thrift_protocol_write_binary($output, 'get_service_list', TMessageType::REPLY, $result, $seqid, $output->isStrictWrite());
    }
    else
    {
  ...
  protected function process_enumerate_disks($seqid, $input, $output) {
    ...
    if ($bin_accel)
    {
      $args = thrift_protocol_read_binary_after_message_begin($input, '\saasame\transport\common_service_enumerate_disks_args', $input->isStrictRead());
    }
    else
    {
      $args = new \saasame\transport\common_service_enumerate_disks_args();
    ...
    if ($bin_accel)
    {
      thrift_protocol_write_binary($output, 'enumerate_disks', TMessageType::REPLY, $result, $seqid, $output->isStrictWrite());
    }
    else
    {
  ...
  protected function process_verify_carrier($seqid, $input, $output) {
    ...
    if ($bin_accel)
    {
      $args = thrift_protocol_read_binary_after_message_begin($input, '\saasame\transport\common_service_verify_carrier_args', $input->isStrictRead());
    }
    else
    {
      $args = new \saasame\transport\common_service_verify_carrier_args();
    ...
    if ($bin_accel)
    {
      thrift_protocol_write_binary($output, 'verify_carrier', TMessageType::REPLY, $result, $seqid, $output->isStrictWrite());
    }
    else
    {
  ...
  protected function process_take_xray($seqid, $input, $output) {
    ...
    if ($bin_accel)
    {
      $args = thrift_protocol_read_binary_after_message_begin($input, '\saasame\transport\common_service_take_xray_args', $input->isStrictRead());
    }
    else
    {
      $args = new \saasame\transport\common_service_take_xray_args();
    ...
    if ($bin_accel)
    {
      thrift_protocol_write_binary($output, 'take_xray', TMessageType::REPLY, $result, $seqid, $output->isStrictWrite());
    }
    else
    {
  ...
  protected function process_take_xrays($seqid, $input, $output) {
    ...
    if ($bin_accel)
    {
      $args = thrift_protocol_read_binary_after_message_begin($input, '\saasame\transport\common_service_take_xrays_args', $input->isStrictRead());
    }
    else
    {
      $args = new \saasame\transport\common_service_take_xrays_args();
    ...
    if ($bin_accel)
    {
      thrift_protocol_write_binary($output, 'take_xrays', TMessageType::REPLY, $result, $seqid, $output->isStrictWrite());
    }
    else
    {
  ...
  protected function process_create_mutex($seqid, $input, $output) {
    ...
    if ($bin_accel)
    {
      $args = thrift_protocol_read_binary_after_message_begin($input, '\saasame\transport\common_service_create_mutex_args', $input->isStrictRead());
    }
    else
    {
      $args = new \saasame\transport\common_service_create_mutex_args();
    ...
    if ($bin_accel)
    {
      thrift_protocol_write_binary($output, 'create_mutex', TMessageType::REPLY, $result, $seqid, $output->isStrictWrite());
    }
    else
    {
  ...
  protected function process_delete_mutex($seqid, $input, $output) {
    ...
    if ($bin_accel)
    {
      $args = thrift_protocol_read_binary_after_message_begin($input, '\saasame\transport\common_service_delete_mutex_args', $input->isStrictRead());
    }
    else
    {
      $args = new \saasame\transport\common_service_delete_mutex_args();
    ...
    if ($bin_accel)
    {
      thrift_protocol_write_binary($output, 'delete_mutex', TMessageType::REPLY, $result, $seqid, $output->isStrictWrite());
    }
    else
    {
