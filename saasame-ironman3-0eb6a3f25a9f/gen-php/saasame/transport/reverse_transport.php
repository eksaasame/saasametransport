...
class reverse_transportClient implements \saasame\transport\reverse_transportIf {
  ...
  public function recv_ping()
  {
    ...
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\saasame\transport\reverse_transport_ping_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\saasame\transport\reverse_transport_generate_session_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\saasame\transport\reverse_transport_receive_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
  ...
  public function send_response($session, $addr, \saasame\transport\transport_message $response)
  {
    ...
    if ($bin_accel)
    {
      thrift_protocol_write_binary($this->output_, 'response', TMessageType::CALL, $args, $this->seqid_, $this->output_->isStrictWrite());
    }
    else
    {
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\saasame\transport\reverse_transport_response_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
...
class reverse_transportProcessor {
  ...
  protected function process_ping($seqid, $input, $output) {
    ...
    if ($bin_accel)
    {
      $args = thrift_protocol_read_binary_after_message_begin($input, '\saasame\transport\reverse_transport_ping_args', $input->isStrictRead());
    }
    else
    {
      $args = new \saasame\transport\reverse_transport_ping_args();
  ...
  protected function process_generate_session($seqid, $input, $output) {
    ...
    if ($bin_accel)
    {
      $args = thrift_protocol_read_binary_after_message_begin($input, '\saasame\transport\reverse_transport_generate_session_args', $input->isStrictRead());
    }
    else
    {
      $args = new \saasame\transport\reverse_transport_generate_session_args();
  ...
  protected function process_receive($seqid, $input, $output) {
    ...
    if ($bin_accel)
    {
      $args = thrift_protocol_read_binary_after_message_begin($input, '\saasame\transport\reverse_transport_receive_args', $input->isStrictRead());
    }
    else
    {
      $args = new \saasame\transport\reverse_transport_receive_args();
    ...
    if ($bin_accel)
    {
      thrift_protocol_write_binary($output, 'receive', TMessageType::REPLY, $result, $seqid, $output->isStrictWrite());
    }
    else
    {
  ...
  protected function process_response($seqid, $input, $output) {
    ...
    if ($bin_accel)
    {
      $args = thrift_protocol_read_binary_after_message_begin($input, '\saasame\transport\reverse_transport_response_args', $input->isStrictRead());
    }
    else
    {
      $args = new \saasame\transport\reverse_transport_response_args();
    ...
    if ($bin_accel)
    {
      thrift_protocol_write_binary($output, 'response', TMessageType::REPLY, $result, $seqid, $output->isStrictWrite());
    }
    else
    {
