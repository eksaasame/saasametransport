...
class common_connection_serviceClient extends \saasame\transport\common_serviceClient implements \saasame\transport\common_connection_serviceIf {
  ...
  public function send_test_connection($session_id, \saasame\transport\connection $conn)
  {
    ...
    if ($bin_accel)
    {
      thrift_protocol_write_binary($this->output_, 'test_connection', TMessageType::CALL, $args, $this->seqid_, $this->output_->isStrictWrite());
    }
    else
    {
  ...
  public function recv_test_connection()
  {
    ...
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\saasame\transport\common_connection_service_test_connection_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
  ...
  public function send_add_connection($session_id, \saasame\transport\connection $conn)
  {
    ...
    if ($bin_accel)
    {
      thrift_protocol_write_binary($this->output_, 'add_connection', TMessageType::CALL, $args, $this->seqid_, $this->output_->isStrictWrite());
    }
    else
    {
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\saasame\transport\common_connection_service_add_connection_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
  ...
  public function send_remove_connection($session_id, $connection_id)
  {
    ...
    if ($bin_accel)
    {
      thrift_protocol_write_binary($this->output_, 'remove_connection', TMessageType::CALL, $args, $this->seqid_, $this->output_->isStrictWrite());
    }
    else
    {
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\saasame\transport\common_connection_service_remove_connection_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
  ...
  public function send_modify_connection($session_id, \saasame\transport\connection $conn)
  {
    ...
    if ($bin_accel)
    {
      thrift_protocol_write_binary($this->output_, 'modify_connection', TMessageType::CALL, $args, $this->seqid_, $this->output_->isStrictWrite());
    }
    else
    {
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\saasame\transport\common_connection_service_modify_connection_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
  ...
  public function send_enumerate_connections($session_id)
  {
    ...
    if ($bin_accel)
    {
      thrift_protocol_write_binary($this->output_, 'enumerate_connections', TMessageType::CALL, $args, $this->seqid_, $this->output_->isStrictWrite());
    }
    else
    {
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\saasame\transport\common_connection_service_enumerate_connections_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
  ...
  public function send_get_connection($session_id, $connection_id)
  {
    ...
    if ($bin_accel)
    {
      thrift_protocol_write_binary($this->output_, 'get_connection', TMessageType::CALL, $args, $this->seqid_, $this->output_->isStrictWrite());
    }
    else
    {
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\saasame\transport\common_connection_service_get_connection_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
  ...
  public function send_get_available_bytes($session_id, $connection_id)
  {
    ...
    if ($bin_accel)
    {
      thrift_protocol_write_binary($this->output_, 'get_available_bytes', TMessageType::CALL, $args, $this->seqid_, $this->output_->isStrictWrite());
    }
    else
    {
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\saasame\transport\common_connection_service_get_available_bytes_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::LST) {
            ...
            {
              $elem1207 = null;
              $elem1207 = new \saasame\transport\connection();
              $xfer += $elem1207->read($input);
              $this->success []= $elem1207;
            }
  ...
  public function write($output) {
    ...
    if ($this->success !== null) {
      ...
      $xfer += $output->writeFieldBegin('success', TType::LST, 0);
      {
        ...
        {
          foreach ($this->success as $iter1208)
          {
...
class common_connection_serviceProcessor extends \saasame\transport\common_serviceProcessor {
  ...
  protected function process_test_connection($seqid, $input, $output) {
    ...
    if ($bin_accel)
    {
      $args = thrift_protocol_read_binary_after_message_begin($input, '\saasame\transport\common_connection_service_test_connection_args', $input->isStrictRead());
    }
    else
    {
      $args = new \saasame\transport\common_connection_service_test_connection_args();
    ...
    if ($bin_accel)
    {
      thrift_protocol_write_binary($output, 'test_connection', TMessageType::REPLY, $result, $seqid, $output->isStrictWrite());
    }
    else
    {
  ...
  protected function process_add_connection($seqid, $input, $output) {
    ...
    if ($bin_accel)
    {
      $args = thrift_protocol_read_binary_after_message_begin($input, '\saasame\transport\common_connection_service_add_connection_args', $input->isStrictRead());
    }
    else
    {
      $args = new \saasame\transport\common_connection_service_add_connection_args();
    ...
    if ($bin_accel)
    {
      thrift_protocol_write_binary($output, 'add_connection', TMessageType::REPLY, $result, $seqid, $output->isStrictWrite());
    }
    else
    {
  ...
  protected function process_remove_connection($seqid, $input, $output) {
    ...
    if ($bin_accel)
    {
      $args = thrift_protocol_read_binary_after_message_begin($input, '\saasame\transport\common_connection_service_remove_connection_args', $input->isStrictRead());
    }
    else
    {
      $args = new \saasame\transport\common_connection_service_remove_connection_args();
    ...
    if ($bin_accel)
    {
      thrift_protocol_write_binary($output, 'remove_connection', TMessageType::REPLY, $result, $seqid, $output->isStrictWrite());
    }
    else
    {
  ...
  protected function process_modify_connection($seqid, $input, $output) {
    ...
    if ($bin_accel)
    {
      $args = thrift_protocol_read_binary_after_message_begin($input, '\saasame\transport\common_connection_service_modify_connection_args', $input->isStrictRead());
    }
    else
    {
      $args = new \saasame\transport\common_connection_service_modify_connection_args();
    ...
    if ($bin_accel)
    {
      thrift_protocol_write_binary($output, 'modify_connection', TMessageType::REPLY, $result, $seqid, $output->isStrictWrite());
    }
    else
    {
  ...
  protected function process_enumerate_connections($seqid, $input, $output) {
    ...
    if ($bin_accel)
    {
      $args = thrift_protocol_read_binary_after_message_begin($input, '\saasame\transport\common_connection_service_enumerate_connections_args', $input->isStrictRead());
    }
    else
    {
      $args = new \saasame\transport\common_connection_service_enumerate_connections_args();
    ...
    if ($bin_accel)
    {
      thrift_protocol_write_binary($output, 'enumerate_connections', TMessageType::REPLY, $result, $seqid, $output->isStrictWrite());
    }
    else
    {
  ...
  protected function process_get_connection($seqid, $input, $output) {
    ...
    if ($bin_accel)
    {
      $args = thrift_protocol_read_binary_after_message_begin($input, '\saasame\transport\common_connection_service_get_connection_args', $input->isStrictRead());
    }
    else
    {
      $args = new \saasame\transport\common_connection_service_get_connection_args();
    ...
    if ($bin_accel)
    {
      thrift_protocol_write_binary($output, 'get_connection', TMessageType::REPLY, $result, $seqid, $output->isStrictWrite());
    }
    else
    {
  ...
  protected function process_get_available_bytes($seqid, $input, $output) {
    ...
    if ($bin_accel)
    {
      $args = thrift_protocol_read_binary_after_message_begin($input, '\saasame\transport\common_connection_service_get_available_bytes_args', $input->isStrictRead());
    }
    else
    {
      $args = new \saasame\transport\common_connection_service_get_available_bytes_args();
    ...
    if ($bin_accel)
    {
      thrift_protocol_write_binary($output, 'get_available_bytes', TMessageType::REPLY, $result, $seqid, $output->isStrictWrite());
    }
    else
    {
