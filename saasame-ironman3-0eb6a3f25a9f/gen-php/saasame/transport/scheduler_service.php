      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::LST) {
            ...
            {
              $elem1119 = null;
              $elem1119 = new \saasame\transport\replica_job_detail();
              $xfer += $elem1119->read($input);
              $this->success []= $elem1119;
            }
  ...
  public function write($output) {
    ...
    if ($this->success !== null) {
      ...
      $xfer += $output->writeFieldBegin('success', TType::LST, 0);
      {
        ...
        {
          foreach ($this->success as $iter1120)
          {
...
class scheduler_serviceProcessor extends \saasame\transport\common_serviceProcessor {
  ...
  protected function process_get_physical_machine_detail($seqid, $input, $output) {
    ...
    if ($bin_accel)
    {
      $args = thrift_protocol_read_binary_after_message_begin($input, '\saasame\transport\scheduler_service_get_physical_machine_detail_args', $input->isStrictRead());
    }
    else
    {
      $args = new \saasame\transport\scheduler_service_get_physical_machine_detail_args();
  ...
  protected function process_get_physical_machine_detail2($seqid, $input, $output) {
    ...
    if ($bin_accel)
    {
      $args = thrift_protocol_read_binary_after_message_begin($input, '\saasame\transport\scheduler_service_get_physical_machine_detail2_args', $input->isStrictRead());
    }
    else
    {
      $args = new \saasame\transport\scheduler_service_get_physical_machine_detail2_args();
  ...
  protected function process_get_virtual_host_info($seqid, $input, $output) {
    ...
    if ($bin_accel)
    {
      $args = thrift_protocol_read_binary_after_message_begin($input, '\saasame\transport\scheduler_service_get_virtual_host_info_args', $input->isStrictRead());
    }
    else
    {
      $args = new \saasame\transport\scheduler_service_get_virtual_host_info_args();
  ...
  protected function process_get_virtual_machine_detail($seqid, $input, $output) {
    ...
    if ($bin_accel)
    {
      $args = thrift_protocol_read_binary_after_message_begin($input, '\saasame\transport\scheduler_service_get_virtual_machine_detail_args', $input->isStrictRead());
    }
    else
    {
      $args = new \saasame\transport\scheduler_service_get_virtual_machine_detail_args();
  ...
  protected function process_create_job_ex($seqid, $input, $output) {
    ...
    if ($bin_accel)
    {
      $args = thrift_protocol_read_binary_after_message_begin($input, '\saasame\transport\scheduler_service_create_job_ex_args', $input->isStrictRead());
    }
    else
    {
      $args = new \saasame\transport\scheduler_service_create_job_ex_args();
  ...
  protected function process_create_job($seqid, $input, $output) {
    ...
    if ($bin_accel)
    {
      $args = thrift_protocol_read_binary_after_message_begin($input, '\saasame\transport\scheduler_service_create_job_args', $input->isStrictRead());
    }
    else
    {
      $args = new \saasame\transport\scheduler_service_create_job_args();
  ...
  protected function process_get_job($seqid, $input, $output) {
    ...
    if ($bin_accel)
    {
      $args = thrift_protocol_read_binary_after_message_begin($input, '\saasame\transport\scheduler_service_get_job_args', $input->isStrictRead());
    }
    else
    {
      $args = new \saasame\transport\scheduler_service_get_job_args();
  ...
  protected function process_interrupt_job($seqid, $input, $output) {
    ...
    if ($bin_accel)
    {
      $args = thrift_protocol_read_binary_after_message_begin($input, '\saasame\transport\scheduler_service_interrupt_job_args', $input->isStrictRead());
    }
    else
    {
      $args = new \saasame\transport\scheduler_service_interrupt_job_args();
  ...
  protected function process_resume_job($seqid, $input, $output) {
    ...
    if ($bin_accel)
    {
      $args = thrift_protocol_read_binary_after_message_begin($input, '\saasame\transport\scheduler_service_resume_job_args', $input->isStrictRead());
    }
    else
    {
      $args = new \saasame\transport\scheduler_service_resume_job_args();
  ...
  protected function process_remove_job($seqid, $input, $output) {
    ...
    if ($bin_accel)
    {
      $args = thrift_protocol_read_binary_after_message_begin($input, '\saasame\transport\scheduler_service_remove_job_args', $input->isStrictRead());
    }
    else
    {
      $args = new \saasame\transport\scheduler_service_remove_job_args();
  ...
  protected function process_list_jobs($seqid, $input, $output) {
    ...
    if ($bin_accel)
    {
      $args = thrift_protocol_read_binary_after_message_begin($input, '\saasame\transport\scheduler_service_list_jobs_args', $input->isStrictRead());
    }
    else
    {
      $args = new \saasame\transport\scheduler_service_list_jobs_args();
  ...
  protected function process_update_job($seqid, $input, $output) {
    ...
    if ($bin_accel)
    {
      $args = thrift_protocol_read_binary_after_message_begin($input, '\saasame\transport\scheduler_service_update_job_args', $input->isStrictRead());
    }
    else
    {
      $args = new \saasame\transport\scheduler_service_update_job_args();
  ...
  protected function process_terminate($seqid, $input, $output) {
    ...
    if ($bin_accel)
    {
      $args = thrift_protocol_read_binary_after_message_begin($input, '\saasame\transport\scheduler_service_terminate_args', $input->isStrictRead());
    }
    else
    {
      $args = new \saasame\transport\scheduler_service_terminate_args();
  ...
  protected function process_running_job($seqid, $input, $output) {
    ...
    if ($bin_accel)
    {
      $args = thrift_protocol_read_binary_after_message_begin($input, '\saasame\transport\scheduler_service_running_job_args', $input->isStrictRead());
    }
    else
    {
      $args = new \saasame\transport\scheduler_service_running_job_args();
  ...
  protected function process_verify_management($seqid, $input, $output) {
    ...
    if ($bin_accel)
    {
      $args = thrift_protocol_read_binary_after_message_begin($input, '\saasame\transport\scheduler_service_verify_management_args', $input->isStrictRead());
    }
    else
    {
      $args = new \saasame\transport\scheduler_service_verify_management_args();
  ...
  protected function process_verify_packer_to_carrier($seqid, $input, $output) {
    ...
    if ($bin_accel)
    {
      $args = thrift_protocol_read_binary_after_message_begin($input, '\saasame\transport\scheduler_service_verify_packer_to_carrier_args', $input->isStrictRead());
    }
    else
    {
      $args = new \saasame\transport\scheduler_service_verify_packer_to_carrier_args();
  ...
  protected function process_take_packer_xray($seqid, $input, $output) {
    ...
    if ($bin_accel)
    {
      $args = thrift_protocol_read_binary_after_message_begin($input, '\saasame\transport\scheduler_service_take_packer_xray_args', $input->isStrictRead());
    }
    else
    {
      $args = new \saasame\transport\scheduler_service_take_packer_xray_args();
  ...
  protected function process_get_packer_service_info($seqid, $input, $output) {
    ...
    if ($bin_accel)
    {
      $args = thrift_protocol_read_binary_after_message_begin($input, '\saasame\transport\scheduler_service_get_packer_service_info_args', $input->isStrictRead());
    }
    else
    {
      $args = new \saasame\transport\scheduler_service_get_packer_service_info_args();
