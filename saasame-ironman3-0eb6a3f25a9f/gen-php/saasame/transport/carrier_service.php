...
interface carrier_serviceIf extends \saasame\transport\common_connection_serviceIf {
   ...
   */
  public function create($session_id, \saasame\transport\create_image_info $image);
  /**
   * @param string $session_id
...
class carrier_serviceClient extends \saasame\transport\common_connection_serviceClient implements \saasame\transport\carrier_serviceIf {
  ...
  public function send_create($session_id, \saasame\transport\create_image_info $image)
  {
      ...
      switch ($fid)
      {
        ...
        case 2:
          if ($ftype == TType::SET) {
            ...
            $_size1209 = 0;
            $_etype1212 = 0;
            $xfer += $input->readSetBegin($_etype1212, $_size1209);
            for ($_i1213 = 0; $_i1213 < $_size1209; ++$_i1213)
            {
              $elem1214 = null;
              $xfer += $input->readString($elem1214);
              $this->connection_ids[$elem1214] = true;
            }
  ...
  public function write($output) {
    ...
    if ($this->connection_ids !== null) {
      ...
      $xfer += $output->writeFieldBegin('connection_ids', TType::SET, 2);
      {
        ...
        {
          foreach ($this->connection_ids as $iter1215 => $iter1216)
          {
      ...
      switch ($fid)
      {
        ...
        case 2:
          if ($ftype == TType::SET) {
            ...
            $_size1217 = 0;
            $_etype1220 = 0;
            $xfer += $input->readSetBegin($_etype1220, $_size1217);
            for ($_i1221 = 0; $_i1221 < $_size1217; ++$_i1221)
            {
              $elem1222 = null;
              $xfer += $input->readString($elem1222);
              $this->connection_ids[$elem1222] = true;
            }
            $xfer += $input->readSetEnd();
          } else {
            $xfer += $input->skip($ftype);
  ...
  public function write($output) {
    ...
    if ($this->connection_ids !== null) {
      ...
      $xfer += $output->writeFieldBegin('connection_ids', TType::SET, 2);
      {
        $output->writeSetBegin(TType::STRING, count($this->connection_ids));
        {
          foreach ($this->connection_ids as $iter1223 => $iter1224)
          {
      ...
      switch ($fid)
      {
        ...
        case 2:
          if ($ftype == TType::SET) {
            ...
            $_size1225 = 0;
            $_etype1228 = 0;
            $xfer += $input->readSetBegin($_etype1228, $_size1225);
            for ($_i1229 = 0; $_i1229 < $_size1225; ++$_i1229)
            {
              $elem1230 = null;
              $xfer += $input->readString($elem1230);
              $this->base_images[$elem1230] = true;
            }
            $xfer += $input->readSetEnd();
          } else {
            $xfer += $input->skip($ftype);
  ...
  public function write($output) {
    ...
    if ($this->base_images !== null) {
      ...
      $xfer += $output->writeFieldBegin('base_images', TType::SET, 2);
      {
        ...
        {
          foreach ($this->base_images as $iter1231 => $iter1232)
          {
      ...
      switch ($fid)
      {
        ...
        case 2:
          if ($ftype == TType::MAP) {
            ...
            $_ktype1234 = 0;
            $_vtype1235 = 0;
            $xfer += $input->readMapBegin($_ktype1234, $_vtype1235, $_size1233);
            for ($_i1237 = 0; $_i1237 < $_size1233; ++$_i1237)
            {
              $key1238 = '';
              $val1239 = new \saasame\transport\image_map_info();
              $xfer += $input->readString($key1238);
              $val1239 = new \saasame\transport\image_map_info();
              $xfer += $val1239->read($input);
              $this->images[$key1238] = $val1239;
            }
  ...
  public function write($output) {
    ...
    if ($this->images !== null) {
      ...
      $xfer += $output->writeFieldBegin('images', TType::MAP, 2);
      {
        ...
        {
          foreach ($this->images as $kiter1240 => $viter1241)
          {
            $xfer += $output->writeString($kiter1240);
            $xfer += $viter1241->write($output);
          }
        }
        $output->writeMapEnd();
      }
      ...
      switch ($fid)
      {
        ...
        case 2:
          if ($ftype == TType::SET) {
            ...
            $_size1242 = 0;
            $_etype1245 = 0;
            $xfer += $input->readSetBegin($_etype1245, $_size1242);
            for ($_i1246 = 0; $_i1246 < $_size1242; ++$_i1246)
            {
              $elem1247 = null;
              $xfer += $input->readString($elem1247);
              $this->connection_ids[$elem1247] = true;
            }
            $xfer += $input->readSetEnd();
          } else {
            $xfer += $input->skip($ftype);
  ...
  public function write($output) {
    ...
    if ($this->connection_ids !== null) {
      ...
      $xfer += $output->writeFieldBegin('connection_ids', TType::SET, 2);
      {
        $output->writeSetBegin(TType::STRING, count($this->connection_ids));
        {
          foreach ($this->connection_ids as $iter1248 => $iter1249)
          {
...
class carrier_serviceProcessor extends \saasame\transport\common_connection_serviceProcessor {
  ...
  protected function process_create($seqid, $input, $output) {
    ...
    if ($bin_accel)
    {
      $args = thrift_protocol_read_binary_after_message_begin($input, '\saasame\transport\carrier_service_create_args', $input->isStrictRead());
    }
    else
    {
      $args = new \saasame\transport\carrier_service_create_args();
  ...
  protected function process_create_ex($seqid, $input, $output) {
    ...
    if ($bin_accel)
    {
      $args = thrift_protocol_read_binary_after_message_begin($input, '\saasame\transport\carrier_service_create_ex_args', $input->isStrictRead());
    }
    else
    {
      $args = new \saasame\transport\carrier_service_create_ex_args();
  ...
  protected function process_open($seqid, $input, $output) {
    ...
    if ($bin_accel)
    {
      $args = thrift_protocol_read_binary_after_message_begin($input, '\saasame\transport\carrier_service_open_args', $input->isStrictRead());
    }
    else
    {
      $args = new \saasame\transport\carrier_service_open_args();
  ...
  protected function process_read($seqid, $input, $output) {
    ...
    if ($bin_accel)
    {
      $args = thrift_protocol_read_binary_after_message_begin($input, '\saasame\transport\carrier_service_read_args', $input->isStrictRead());
    }
    else
    {
      $args = new \saasame\transport\carrier_service_read_args();
  ...
  protected function process_write($seqid, $input, $output) {
    ...
    if ($bin_accel)
    {
      $args = thrift_protocol_read_binary_after_message_begin($input, '\saasame\transport\carrier_service_write_args', $input->isStrictRead());
    }
    else
    {
      $args = new \saasame\transport\carrier_service_write_args();
  ...
  protected function process_write_ex($seqid, $input, $output) {
    ...
    if ($bin_accel)
    {
      $args = thrift_protocol_read_binary_after_message_begin($input, '\saasame\transport\carrier_service_write_ex_args', $input->isStrictRead());
    }
    else
    {
      $args = new \saasame\transport\carrier_service_write_ex_args();
  ...
  protected function process_close($seqid, $input, $output) {
    ...
    if ($bin_accel)
    {
      $args = thrift_protocol_read_binary_after_message_begin($input, '\saasame\transport\carrier_service_close_args', $input->isStrictRead());
    }
    else
    {
      $args = new \saasame\transport\carrier_service_close_args();
  ...
  protected function process_remove_base_image($seqid, $input, $output) {
    ...
    if ($bin_accel)
    {
      $args = thrift_protocol_read_binary_after_message_begin($input, '\saasame\transport\carrier_service_remove_base_image_args', $input->isStrictRead());
    }
    else
    {
      $args = new \saasame\transport\carrier_service_remove_base_image_args();
  ...
  protected function process_remove_snapshot_image($seqid, $input, $output) {
    ...
    if ($bin_accel)
    {
      $args = thrift_protocol_read_binary_after_message_begin($input, '\saasame\transport\carrier_service_remove_snapshot_image_args', $input->isStrictRead());
    }
    else
    {
      $args = new \saasame\transport\carrier_service_remove_snapshot_image_args();
  ...
  protected function process_verify_management($seqid, $input, $output) {
    ...
    if ($bin_accel)
    {
      $args = thrift_protocol_read_binary_after_message_begin($input, '\saasame\transport\carrier_service_verify_management_args', $input->isStrictRead());
    }
    else
    {
      $args = new \saasame\transport\carrier_service_verify_management_args();
  ...
  protected function process_set_buffer_size($seqid, $input, $output) {
    ...
    if ($bin_accel)
    {
      $args = thrift_protocol_read_binary_after_message_begin($input, '\saasame\transport\carrier_service_set_buffer_size_args', $input->isStrictRead());
    }
    else
    {
      $args = new \saasame\transport\carrier_service_set_buffer_size_args();
  ...
  protected function process_is_buffer_free($seqid, $input, $output) {
    ...
    if ($bin_accel)
    {
      $args = thrift_protocol_read_binary_after_message_begin($input, '\saasame\transport\carrier_service_is_buffer_free_args', $input->isStrictRead());
    }
    else
    {
      $args = new \saasame\transport\carrier_service_is_buffer_free_args();
  ...
  protected function process_is_image_replicated($seqid, $input, $output) {
    ...
    if ($bin_accel)
    {
      $args = thrift_protocol_read_binary_after_message_begin($input, '\saasame\transport\carrier_service_is_image_replicated_args', $input->isStrictRead());
    }
    else
    {
      $args = new \saasame\transport\carrier_service_is_image_replicated_args();
