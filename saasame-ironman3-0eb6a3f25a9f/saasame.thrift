...
struct virtual_host{
    ...
    27: optional i16                   number_of_cpu_threads          =  0
}
...
struct create_packer_job_detail{
    ...
    17: optional map<string,string>                    checksum_target           // <connection_id, machine_id>
}
...
service carrier_service extends common_connection_service
{
    ...
    bool   send_checksum_info( 1: string session_id, 2: string connection_id, 3: string file_name, 4: binary data) throws (1:invalid_operation ouch);
    binary receive_checksum_result( 1: string session_id, 2: string connection_id, 3: string file_name) throws (1:invalid_operation ouch);
}
...
struct replica_job_create_detail{
   ...
   37: optional map<string,string>                  checksum_target           // <connection_id, machine_id>
}
...
struct loader_job_create_detail{
   ...
   23: optional string                            post_snapshot_script
   24: optional list<string>                      disks_order
}
...
struct launcher_job_create_detail{
   ...
   27: optional string                        azure_storage_connection_string         = ""
}
