...
For Each objFile in colFiles
	...
	strText = Replace(strText, "CreateImageInfo", "create_image_info")
	strText = Replace(strText, "Connection", "connection")
	strText = Replace(strText, "RunningTask", "running_task")
